...
name|lambdaExpression0
parameter_list|,
name|LambdaExpression
name|lambdaExpression1
parameter_list|)
block|{
throw|throw
name|Extensions
...
throw|;
block|}
comment|/** Creates a MethodCallExpression that represents a call to a      * static (Shared in Visual Basic) method. */
specifier|public
specifier|static
name|MethodCallExpression
name|call
...
throw|;
block|}
comment|/** Creates a MethodCallExpression that represents a call to a      * static (Shared in Visual Basic) method that takes one      * argument. */
specifier|public
specifier|static
name|MethodCallExpression
name|call
...
throw|;
block|}
comment|/** Creates a MethodCallExpression that represents a call to a      * static (Shared in Visual Basic) method that has arguments. */
specifier|public
specifier|static
name|MethodCallExpression
name|call
...
literal|null
argument_list|,
comment|// (Class<F>) (Class) function.getClass(),
literal|null
argument_list|)
return|;
...
throw|;
block|}
comment|/** Creates a MemberExpression that represents accessing either a      * field or a property. */
specifier|public
specifier|static
name|MemberExpression
