...
block|}
block|}
comment|/**      * Finds a constructor of a given class that accepts a given set of      * arguments. Includes in its search methods with wider argument types.      *      *      * @param clazz Class against which method is invoked      * @param argumentTypes Types of arguments      * @return A method with the given name that matches the arguments given      *      * @throws RuntimeException if method not found      */
specifier|public
specifier|static
name|Constructor
...
name|RuntimeException
argument_list|(
literal|"while resolving static constructor in class "
operator|+
name|clazz
argument_list|)
throw|;
