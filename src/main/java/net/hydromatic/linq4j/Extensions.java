...
throw|;
block|}
comment|/** Casts the elements of an Enumerable to the      * specified type. */
specifier|public
specifier|static
parameter_list|<
name|TResult
...
return|;
block|}
comment|/**      * Adapter that converts an iterator into an enumerator.      *      * @param iterator Iterator      * @param<T> Element type      * @return enumerator      */
specifier|public
specifier|static
parameter_list|<
name|T
...
argument_list|()
decl_stmt|;
comment|/**      * Adapter that converts an iterable into an enumerable.      *      * @param iterable Iterable      * @param<T> Element type      * @return enumerable      */
specifier|public
specifier|static
parameter_list|<
name|T
