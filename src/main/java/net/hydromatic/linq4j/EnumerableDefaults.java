...
return|;
block|}
comment|/** Symmetric join algorithm that builds both sides into a look. Powerful    * enough to evaluate full outer join but less efficient than {@link #join_}.    * Not currently used. */
specifier|private
specifier|static
parameter_list|<
name|TSource
