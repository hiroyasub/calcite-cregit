...
throw|;
block|}
comment|/**      * Executes a queryable, and returns an enumerator over the      * rows that it yields.      *      * @param queryable Queryable      * @param<T> Element type      * @return Enumerator over rows      */
specifier|protected
specifier|abstract
parameter_list|<
name|T
