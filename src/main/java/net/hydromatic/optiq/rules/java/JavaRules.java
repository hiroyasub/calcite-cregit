...
name|JavaRules
block|{
comment|/**      * Convention that presents query results as an      * {@link net.hydromatic.linq4j.Enumerable}.      */
specifier|public
specifier|static
specifier|final
name|Convention
...
return|;
block|}
comment|/** Converts 'x' to 'Integer.valueOf(x)' if x is of type {@code int}. */
specifier|static
name|Expression
name|box
parameter_list|(
...
block|}
block|}
comment|/** Implementation of {@link net.hydromatic.optiq.rules.java.EnumerableRel.PhysType}. */
specifier|public
specifier|static
class|class
name|PhysTypeImpl
