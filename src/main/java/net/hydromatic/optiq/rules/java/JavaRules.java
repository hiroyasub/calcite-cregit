...
comment|//     new HashMap<Integer, List<Employee>>();
...
name|remark
argument_list|(
literal|"remove asList after upgrade linq4j"
argument_list|)
expr_stmt|;
specifier|final
name|Expression
...
argument_list|)
expr_stmt|;
comment|// TODO: loop to compute the aggs
name|Bug
operator|.
name|remark
argument_list|(
literal|"use increment after linq4j upgrade"
argument_list|)
expr_stmt|;
name|builder4
operator|.
...
block|}
block|}
comment|// Appends variable to builder if expression is not null.
specifier|private
specifier|static
name|Expression
name|ainn
...
name|remark
argument_list|(
literal|"move to linq4j BlockBuilder"
argument_list|)
expr_stmt|;
if|if
condition|(
