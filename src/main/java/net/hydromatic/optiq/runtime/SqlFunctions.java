...
return|;
block|}
comment|/** SQL == operator to int values; left side may be null. */
specifier|public
specifier|static
name|Boolean
name|eq
...
return|;
block|}
comment|/** SQL == operator to short values; left side may be null. */
specifier|public
specifier|static
name|Boolean
name|eq
...
return|;
block|}
comment|/** SQL&le; operator to int values; left side may be null. */
specifier|public
specifier|static
name|Boolean
name|le
...
return|;
block|}
comment|/** SQL&ge; operator to int values; left side may be null. */
specifier|public
specifier|static
name|Boolean
name|ge
