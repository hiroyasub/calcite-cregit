...
return|;
block|}
comment|/**      * Creates a Template with the given pattern and uses it      * to format the given arguments. This is equivalent to      *<blockquote>      *<code>new {@link #Template(String) Template}(pattern).{@link #format}(args)</code>      *</blockquote>      *      * @exception IllegalArgumentException if the pattern is invalid,      *            or if an argument in the<code>arguments</code> array      *            is not of the type expected by the format element(s)      *            that use it.      */
specifier|public
specifier|static
name|String
name|formatByName
