...
begin_comment
comment|/**  * Miscellaneous utility functions.  *  * @author jhyde  * @version $Id$  */
end_comment
...
expr_stmt|;
block|}
comment|/**      * Prints a flat array of objects as [e1,e2,...]      */
specifier|public
specifier|static
name|String
name|flatArrayToString
parameter_list|(
name|Object
index|[]
name|a
