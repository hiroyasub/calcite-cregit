...
begin_comment
comment|/**  * A<code>Graph</code> is a collection of directed arcs between nodes, and  * supports various graph-theoretic operations.  *  * @author jhyde  * @version $Id$  * @since May 6, 2003  */
end_comment
...
return|;
block|}
comment|/**      * Returns the shortest path between two points, null if there is no path.      *      * @param from      * @param to      *      * @return A list of arcs, null if there is no path.      */
specifier|public
name|Arc
argument_list|<
name|T
