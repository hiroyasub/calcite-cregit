...
return|;
block|}
comment|/**      * Looks up a class by name. This is like Class.forName, except that it      * handles primitive type names.      *      * @param name fully-qualified name of class to look up      *      * @return class      */
specifier|public
specifier|static
name|Class
argument_list|<
