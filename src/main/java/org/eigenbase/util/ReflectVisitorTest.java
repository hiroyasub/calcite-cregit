...
begin_comment
comment|/**  * ReflectVisitorTest tests {@link ReflectUtil#invokeVisitor} and {@link  * ReflectiveVisitor} and provides a contrived example of how to use them.  *  * @author John V. Sichi  * @version $Id$  */
end_comment
