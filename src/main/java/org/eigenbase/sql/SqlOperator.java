...
return|;
block|}
comment|/**      * Returns a string describing the expected operand types of a call, e.g.      * "SUBSTRING(VARCHAR, INTEGER, INTEGER)" where the name (SUBSTRING in this      * example) can be replaced by a specifed name.      */
specifier|public
name|String
name|getAllowedSignatures
parameter_list|(
