...
name|getLogger
argument_list|(
literal|"org.eigenbase.sql.pretty.SqlPrettyWriter"
argument_list|)
argument_list|)
decl_stmt|;
...
block|{
comment|// Print space in chunks of 8 to amortize cost of calls to print.
specifier|final
name|int
name|rem
init|=
