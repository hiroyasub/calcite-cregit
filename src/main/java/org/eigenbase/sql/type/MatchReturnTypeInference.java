...
comment|/**      * Returns the type at element start (zero based).      *      * @see #MatchReturnTypeInference(int, SqlTypeName[])      */
specifier|public
name|MatchReturnTypeInference
parameter_list|(
name|int
...
expr_stmt|;
block|}
comment|/**      * Returns the first type matching any type in typeNames at or after      * position start (zero based)      *      * @pre start>=0      * @pre null!=typeNames      * @pre typeNames.length>0      */
specifier|public
name|MatchReturnTypeInference
parameter_list|(
name|int
