...
return|;
block|}
comment|/**      * Receives notification about a rule match. At the time that this method is      * called, {@link RelOptRuleCall#rels call.rels} holds the set of relational      * expressions which match the operands to the rule;<code>      * call.rels[0]</code> is the root expression.      *      *<p>Typically a rule would check that the nodes are valid matches, creates      * a new expression, then calls back {@link RelOptRuleCall#transformTo} to      * register the expression.</p>      *      * @param call Rule call      *      * @see #matches(RelOptRuleCall)      * @pre matches(call)      */
specifier|public
specifier|abstract
name|void
name|onMatch
...
return|;
block|}
comment|/**      * Converts a relation expression to a give set of traits, if it does not      * already have those traits. If the conversion is not possible, returns      * null.      *      * @param rel Relexp to convert      * @param toTraits desired traits      *      * @return a relational expression with the desired traits, or null if no      * conversion is possible      *      * @post return == null || return.getTraits().matches(toTraits)      */
specifier|public
specifier|static
name|RelNode
name|convert
...
return|;
block|}
comment|/**      * Creates a new RelTraitSet based on the given traits and converts the      * relational expression to that trait set. Clones<code>baseTraits</code>      * and merges<code>newTraits</code> with the cloned set, then converts rel      * to that set. Normally, during a rule call, baseTraits are the traits of      * the rel's parent and newTraits are the traits that the rule wishes to      * guarantee.      *      * @param baseTraits base traits for converted rel      * @param newTraits altered traits      * @param rel the rel to convert      *      * @return converted rel or null if conversion could not be made      */
specifier|public
specifier|static
name|RelNode
...
return|;
block|}
comment|/**      * Creates a new RelTraitSet based on the given traits and converts the      * relational expression to that trait set. Clones<code>baseTraits</code>      * and merges<code>newTrait</code> with the cloned set, then converts rel      * to that set. Normally, during a rule call, baseTraits are the traits of      * the rel's parent and newTrait is the trait that the rule wishes to      * guarantee.      *      * @param baseTraits base traits for converted rel      * @param newTrait altered trait      * @param rel the rel to convert      *      * @return converted rel or null if conversion could not be made      */
specifier|public
specifier|static
name|RelNode
name|mergeTraitsAndConvert
...
return|;
block|}
comment|/**      * Converts a list of relational expressions.      *      * @param trait Trait to apply to each relational expression      * @param rels Relational expressions      * @return List of converted relational expressions, or null if any could      *   not be converted      */
specifier|public
specifier|static
name|List
argument_list|<
