...
return|;
block|}
comment|/**      * Returns a list of the types of the fields in a given struct type. The      * list is immutable.      *      * @param type Struct type      *      * @return List of field types      *      * @see #getFieldNameList(RelDataType)      */
specifier|public
specifier|static
name|List
argument_list|<
...
block|}
block|}
comment|/**      * Returns condition decomposed by AND.      *      *<p>For example, {@code conjunctions(TRUE)} returns the empty list.</p>      */
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/** Combines a collection of predicates using AND. Returns TRUE if the      * collection is empty. */
specifier|public
specifier|static
name|RexNode
