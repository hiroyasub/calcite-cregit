...
block|{
block|}
comment|/** Initializes, setting the {@link #decl} and {@link #args} fields. */
specifier|public
name|void
name|init
parameter_list|(
...
return|;
block|}
comment|/**      * Implements a physical query plan.      *      * @param rowType original rowtype returned by query validator      * @param rootRel root of the relational expression.      * @param sqlKind SqlKind of the original statement.      * @return an executable plan, a {@link PreparedExecution}.      */
specifier|protected
