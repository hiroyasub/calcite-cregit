...
begin_comment
comment|/**  *<code>OJPreparingStmt</code> is an abstract base for classes which implement  * the process of preparing and executing SQL expressions by generating OpenJava  * code.  */
end_comment
