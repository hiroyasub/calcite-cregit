...
begin_comment
comment|/**  * Concrete child class of {@link SqlValidatorTestCase}, containing lots of unit  * tests.  *  *<p>If you want to run these same tests in a different environment, create a  * derived class whose {@link #getTester} returns a different implementation of  * {@link org.eigenbase.test.SqlValidatorTestCase.Tester}.  *  * @author Wael Chatila  * @version $Id$  * @since Jan 14, 2004  */
end_comment
