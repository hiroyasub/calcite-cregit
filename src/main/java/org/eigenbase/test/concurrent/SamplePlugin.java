...
begin_comment
comment|/**  * Sample mtsql plugin. To use add at start of script  * "@plugin org.eigenbase.test.concurrent.SamplePlugin".  After doing a prepare  * you can then do "@describeResultSet" to show columns returned by query.  *  * @author jhahn   * @version $Id$  */
end_comment
