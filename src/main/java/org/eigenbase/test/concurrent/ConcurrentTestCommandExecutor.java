...
begin_comment
comment|/**  * ConcurrentTestCommandExecutor is a thread that executes a sequence of  * {@link ConcurrentTestCommand commands} on a JDBC connection.  *  * @author Stephan Zuercher  * @version $Id$  */
end_comment
