...
begin_comment
comment|/**  * DiffTestCase is an abstract base for JUnit tests which produce multi-line  * output to be verified by diffing against a pre-existing reference file.  *  * @author John V. Sichi  * @version $Id$  */
end_comment
