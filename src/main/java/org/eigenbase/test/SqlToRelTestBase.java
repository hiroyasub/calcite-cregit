...
name|Tester
block|{
comment|/**          * Converts a SQL string to a {@link RelNode} tree.          *          * @param sql SQL statement          *          * @return Relational expression, never null          *          * @pre sql != null          * @post return != null          */
name|RelNode
...
parameter_list|)
function_decl|;
comment|/**          * Factory method for a {@link SqlValidatorCatalogReader}.          */
name|SqlValidatorCatalogReader
...
block|}
block|}
comment|/**      * Mock implementation of {@link RelOptConnection}, contains a {@link      * MockRelOptSchema}.      */
specifier|private
specifier|static
class|class
name|MockRelOptConnection
implements|implements
name|RelOptConnection
block|{
specifier|private
...
block|}
block|}
comment|/**      * Default implementation of {@link Tester}, using mock classes {@link      * MockRelOptSchema}, {@link MockRelOptConnection} and {@link      * MockRelOptPlanner}.      */
specifier|public
specifier|static
class|class
name|TesterImpl
...
argument_list|)
expr_stmt|;
comment|// Check that every node is valid.
