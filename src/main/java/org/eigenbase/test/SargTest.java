...
begin_comment
comment|/**  * SargTest tests the {@link org.eigenbase.sarg} class library.  *  *<p>NOTE jvs 17-Jan-2006: This class lives in org.eigenbase.test rather than  * org.eigenbase.sarg by design: we want to make sure we're only testing via the  * public interface.  *  * @author John V. Sichi  * @version $Id$  */
end_comment
