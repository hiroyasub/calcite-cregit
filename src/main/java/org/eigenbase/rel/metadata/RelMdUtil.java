...
specifier|final
name|SqlFunction
name|artificialSelectivityFunc
init|=
operator|new
name|SqlFunction
argument_list|(
...
block|}
block|}
comment|/**      * Forms two bitmaps by splitting the columns in a bitmap according to      * whether or not the column references the child input or is an expression      *      * @param projExprs      * @param groupKey bitmap whose columns will be split      * @param baseCols bitmap representing columns from the child input      * @param projCols bitmap representing non-child columns      */
specifier|public
specifier|static
name|void
name|splitCols
