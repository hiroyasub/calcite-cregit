...
return|;
block|}
comment|/**      * Returns whether an integer array has the same content as an integer list.      */
specifier|private
specifier|static
name|boolean
name|equals
