...
name|Partition
block|{
comment|/**      * Array of {@link org.eigenbase.rel.WindowRelBase.RexWinAggCall} objects, each of which is a call to a      * {@link org.eigenbase.sql.SqlAggFunction}.      */
specifier|public
specifier|final
name|List
argument_list|<
...
parameter_list|)
block|{
comment|// Convert operands to inputRefs -- they will refer to the output
comment|// fields of a lower program.
specifier|final
name|List
argument_list|<
name|RexNode
