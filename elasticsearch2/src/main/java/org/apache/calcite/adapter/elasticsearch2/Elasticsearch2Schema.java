...
name|client
decl_stmt|;
comment|/**    * Creates an Elasticsearch2 schema.    *    * @param coordinates Map of Elasticsearch node locations (host, port)    * @param userConfig Map of user-specified configurations    * @param indexName Elasticsearch database name, e.g. "usa".    */
name|Elasticsearch2Schema
parameter_list|(
name|Map
argument_list|<
...
argument_list|(
literal|"Cannot connect to any elasticsearch node: "
operator|+
name|transportNodes
argument_list|)
throw|;
...
begin_comment
comment|// End Elasticsearch2Schema.java
end_comment
