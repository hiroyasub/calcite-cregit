...
expr_stmt|;
block|}
comment|/**    * Having separate class to expose (protected) constructor which allows to install    * different plugins. In our case it is {@code GroovyPlugin} for scripted fields like    * {@code loc[0]} or {@code loc[1]['foo']}.    */
specifier|private
specifier|static
class|class
name|LocalNode
