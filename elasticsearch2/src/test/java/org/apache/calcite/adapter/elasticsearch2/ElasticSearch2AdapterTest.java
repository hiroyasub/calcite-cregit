...
operator|+
literal|"where \"state\" = 'CA' and \"id\">= '70000'\n"
operator|+
...
literal|"    ElasticsearchProject(city=[CAST(ITEM($0, 'city')):VARCHAR(20) CHARACTER SET \"ISO-8859-1\" COLLATE \"ISO-8859-1$en_US$primary\"], longitude=[CAST(ITEM(ITEM($0, 'loc'), 0)):FLOAT], latitude=[CAST(ITEM(ITEM($0, 'loc'), 1)):FLOAT], pop=[CAST(ITEM($0, 'pop')):INTEGER], state=[CAST(ITEM($0, 'state')):VARCHAR(2) CHARACTER SET \"ISO-8859-1\" COLLATE \"ISO-8859-1$en_US$primary\"], id=[CAST(ITEM($0, 'id')):VARCHAR(5) CHARACTER SET \"ISO-8859-1\" COLLATE \"ISO-8859-1$en_US$primary\"])\n"
operator|+
literal|"      ElasticsearchFilter(condition=[AND(=(CAST(ITEM($0, 'state')):VARCHAR(2) CHARACTER SET \"ISO-8859-1\" COLLATE \"ISO-8859-1$en_US$primary\", 'CA'),>=(CAST(ITEM($0, 'id')):VARCHAR(5) CHARACTER SET \"ISO-8859-1\" COLLATE \"ISO-8859-1$en_US$primary\", '70000'))])\n"
operator|+
literal|"        ElasticsearchTableScan(table=[[elastic, zips]])"
decl_stmt|;
name|calciteAssert
...
operator|+
literal|"{\"range\":{\"id\":{\"gte\":\"70000\"}}}]}}}}"
argument_list|,
literal|"\"script_fields\": {\"longitude\":{\"script\":\"_source.loc[0]\"}, "
operator|+
literal|"\"latitude\":{\"script\":\"_source.loc[1]\"}, "
operator|+
literal|"\"city\":{\"script\": \"_source.city\"}, "
operator|+
literal|"\"pop\":{\"script\": \"_source.pop\"}, "
operator|+
literal|"\"state\":{\"script\": \"_source.state\"}, "
operator|+
literal|"\"id\":{\"script\": \"_source.id\"}}"
argument_list|,
literal|"\"sort\": [ {\"state\": \"asc\"}, {\"id\": \"asc\"}]"
argument_list|)
argument_list|)
...
literal|"\"city\":{\"script\": \"_source.city\"}, "
operator|+
literal|"\"pop\":{\"script\": \"_source.pop\"}, \"state\":{\"script\": \"_source.state\"}, "
operator|+
literal|"\"id\":{\"script\": \"_source.id\"}}"
argument_list|)
argument_list|)
