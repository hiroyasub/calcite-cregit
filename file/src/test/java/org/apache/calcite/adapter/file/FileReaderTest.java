...
name|resource
argument_list|(
literal|"tableNoTheadTbody.html"
argument_list|)
decl_stmt|;
name|FileReader
name|t
...
name|sql
init|=
literal|"select a.EMPNO,a.NAME,a.CITY,b.DEPTNO "
operator|+
literal|"from FILES.EMPS a, FILES.DEPTS b where a.DEPTNO = b.DEPTNO"
decl_stmt|;
specifier|final
name|ResultSet
name|rs
