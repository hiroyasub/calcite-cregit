...
return|;
block|}
comment|/**    * When trying to cast/convert a {@code Type} to another {@code Type},    * it is necessary to pre-check whether the cast operation is needed.    * We summarize general exceptions, including:    *    *<ol>    *<li>target Type {@code toType} equals with original Type {@code fromType}</li>    *<li>target Type can be assignable from original Type</li>    *<li>target Type is an instance of {@code RecordType},    *   since the mapping Java Class might not generated yet</li>    *</ol>    *    * @param fromType original type    * @param toType   target type    * @return Whether a cast operation is needed    */
specifier|public
specifier|static
name|boolean
name|needTypeCast
