...
name|max
decl_stmt|;
comment|/** The size of a value of this type, in bits. Null if not applicable for this    * type. */
specifier|public
specifier|final
name|int
name|size
...
expr_stmt|;
block|}
comment|/**    * Returns the Primitive object for a given primitive class.    *    *<p>For example,<code>of(long.class)</code> returns {@link #LONG}.    * Returns {@code null} when applied to a boxing or other class; for example    *<code>of(Long.class)</code> and<code>of(String.class)</code> return    * {@code null}.    */
specifier|public
specifier|static
annotation|@
name|Nullable
...
return|;
block|}
comment|/**    * Returns the Primitive object for a given primitive or boxing class.    *    *<p>For example,<code>ofBoxOr(Long.class)</code> and    *<code>ofBoxOr(long.class)</code> both return {@link #LONG}.    */
specifier|public
specifier|static
annotation|@
name|Nullable
...
block|}
block|}
comment|/** Returns whether this Primitive is a numeric type. */
specifier|public
name|boolean
name|isNumeric
parameter_list|()
block|{
comment|// Per Java: Boolean and Character do not extend Number
switch|switch
condition|(
name|this
condition|)
...
block|}
block|}
comment|/** Returns whether this Primitive is a fixed-point numeric type. */
specifier|public
name|boolean
name|isFixedNumeric
parameter_list|()
...
block|}
block|}
comment|/**    * Converts an array to a string.    *    * @param array Array of this primitive type    *    * @return String representation of array    */
specifier|public
name|String
name|arrayToString
parameter_list|(
...
block|}
block|}
comment|/**    * Sorts an array of this primitive type.    *    * @param array Array of this primitive type    */
specifier|public
name|void
name|sortArray
parameter_list|(
...
name|BOOLEAN
case|:
comment|// there is no Arrays.sort(boolean[])
specifier|final
name|boolean
index|[]
name|booleans
...
block|}
block|}
comment|/**    * Sorts a specified range of an array of this primitive type.    *    * @param array Array of this primitive type    * @param fromIndex the index of the first element, inclusive, to be sorted    * @param toIndex the index of the last element, exclusive, to be sorted    */
specifier|public
name|void
name|sortArray
parameter_list|(
...
name|BOOLEAN
case|:
comment|// there is no Arrays.sort(boolean[], int, int)
name|sortBooleanArray
argument_list|(
operator|(
name|boolean
...
parameter_list|)
block|{
comment|// The sorted array will be like [false, false, ..., false, true, ... true].
comment|// Every time we see a "false", the transition point moves up one.
name|int
name|midIndex
init|=
name|fromIndex
