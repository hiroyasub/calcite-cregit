...
parameter_list|)
function_decl|;
comment|/**    * For each row of the current enumerable returns the correlated rows    * from the {@code inner} enumerable (nested loops join).    *    * @deprecated Use {@link #correlateJoin(JoinType, Function1, Function2)}    *    * @param joinType inner, left, semi or anti join type    * @param inner generator of inner enumerable    * @param resultSelector selector of the result. For semi/anti join    *                       inner argument is always null.    */
annotation|@
name|Deprecated
...
parameter_list|)
block|{
comment|// temporary default implementation for backwards compatibility
switch|switch
condition|(
name|joinType
condition|)
