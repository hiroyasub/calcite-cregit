...
expr_stmt|;
block|}
comment|/**    * Obtains a proxy pointing to an existing Region on the server    *    * @param clientCache {@link ClientCache} instance to interact with the Geode server    * @param regionName  Name of the region to create proxy for.    * @return Returns a Region proxy to a remote (on the Server) regions.    */
specifier|public
specifier|static
specifier|synchronized
name|Region
