...
name|current
decl_stmt|;
comment|/**    * Creates an Elasticsearch5Enumerator.    *    * @param cursor Iterator over Elasticsearch {@link SearchHit} objects    * @param getter Converts an object into a list of fields    */
specifier|public
name|Elasticsearch5Enumerator
parameter_list|(
name|Iterator
...
begin_comment
comment|// End Elasticsearch5Enumerator.java
end_comment
