...
condition|)
block|{
comment|// The default column has been added automatically if we retrieved
comment|// the data source information with a segment metadata query. However,
comment|// we can remove it since we declared explicitly a name for the
