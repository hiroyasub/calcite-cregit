...
block|{
block|}
comment|/**    * Generates a list of {@link LocalInterval}s equivalent to a given    * expression. Assumes that all the predicates in the input    * reference a single column: the timestamp column.    */
specifier|public
specifier|static
name|List
argument_list|<
...
name|DATE
case|:
comment|// For uniformity, treat dates as timestamps
specifier|final
name|DateString
name|d
init|=
