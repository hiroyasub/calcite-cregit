...
expr_stmt|;
block|}
comment|/** Formats timestamp values to druid format using      * {@link DruidQuery.Translator#dateFormatter}. This is needed when pushing      * timestamp comparisons to druid using a TimeFormatExtractionFunction that      * returns a string value. */
annotation|@
