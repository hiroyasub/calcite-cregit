...
argument_list|)
expr_stmt|;
comment|//@TODO we can remove this ugly check by treating druid time columns as LONG
if|if
condition|(
name|rexNode
operator|.
...
argument_list|()
argument_list|,
literal|"Can not plan Scan Druid Query"
argument_list|)
argument_list|,
name|scanColumnNames
argument_list|)
