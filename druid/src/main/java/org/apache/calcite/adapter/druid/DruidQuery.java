...
argument_list|()
decl_stmt|;
comment|// Druid can't filter on metrics
return|return
operator|!
name|druidTable
operator|.
...
comment|// Use hyperUniqueCardinality post aggregator instead of field Accessor.
comment|// TODO: Expect to change after CALC-1787
return|return
operator|new
...
block|}
block|}
comment|/** Thetasketch operation Post aggregator writer */
specifier|private
specifier|static
class|class
name|JsonThetaSketchSetOp
extends|extends
name|JsonPostAggregation
block|{
specifier|final
