...
return|;
block|}
comment|/** Returns a consumer that checks that a particular Druid query is    * generated to implement a query. Expected lines should be exactly    * included in the actual query text, without changing quote types. */
specifier|private
name|Consumer
argument_list|<
name|List
argument_list|>
name|druidOriginalChecker
parameter_list|(
specifier|final
name|String
modifier|...
...
expr_stmt|;
block|}
comment|/**    * Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-2804">[CALCITE-2804]</a>    * Cast does not work in Druid when casting to timestamp    */
annotation|@
name|Test
specifier|public
name|void
...
literal|"intervals=[[1900-01-09T00:00:00.000Z/2992-01-10T00:00:00.000Z]], "
operator|+
literal|"filter=[AND(IS NOT TRUE(=($1, 1020)),<>($1, 1020))],"
operator|+
literal|" groups=[{}], aggs=[[COUNT()]])"
argument_list|)
expr_stmt|;
