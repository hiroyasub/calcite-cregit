...
name|DruidAdapterIT
block|{
comment|/** Connection factory based on the "druid-foodmart" model. */
specifier|public
specifier|static
specifier|final
name|ImmutableMap
...
argument_list|)
decl_stmt|;
comment|/** Connection factory based on the "druid-wiki" model    * and the "wikiticker" data set. */
specifier|public
specifier|static
specifier|final
name|ImmutableMap
...
return|;
block|}
comment|/** Creates a query against the {@link #WIKI} data set. */
specifier|private
name|CalciteAssert
operator|.
name|AssertQuery
