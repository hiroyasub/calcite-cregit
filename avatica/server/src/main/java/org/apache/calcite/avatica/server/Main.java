...
expr_stmt|;
block|}
comment|/**    * Factory that instantiates Jetty Handlers    */
specifier|public
interface|interface
name|HandlerFactory
block|{
...
block|}
decl_stmt|;
comment|/**    * Creates and starts an {@link HttpServer} using JSON POJO serialization of requests/responses.    *    *<p>Arguments are as follows:    *<ul>    *<li>args[0]: the {@link org.apache.calcite.avatica.Meta.Factory} class    *       name    *<li>args[1+]: arguments passed along to    *   {@link org.apache.calcite.avatica.Meta.Factory#create(java.util.List)}    *</ul>    *    * @param args Command-line arguments    */
specifier|public
specifier|static
name|HttpServer
name|start
