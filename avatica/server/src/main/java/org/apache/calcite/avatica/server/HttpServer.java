...
name|handler
decl_stmt|;
comment|// Wrap the provided handler for SPNEGO if we made one
if|if
condition|(
literal|null
operator|!=
...
return|;
block|}
comment|/**      * Configures the server to use SPNEGO authentication. This method requires that the      *<code>principal</code> contains the Kerberos realm.      *      * @param principal A kerberos principal with the realm required.      * @return<code>this</code>      */
specifier|public
name|Builder
name|withSpnego
parameter_list|(
