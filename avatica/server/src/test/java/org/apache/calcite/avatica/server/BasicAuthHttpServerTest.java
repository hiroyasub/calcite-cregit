...
begin_comment
comment|/**  * Test class for HTTP Basic authentication.  */
end_comment
...
name|assertNotNull
argument_list|(
literal|"Could not find properties file for basic auth users"
argument_list|,
name|userPropertiesFile
argument_list|)
expr_stmt|;
...
argument_list|()
operator|+
literal|";authentication=BASIC;serialization=PROTOBUF"
expr_stmt|;
...
specifier|public
name|void
name|testDisallowedAvaticaAllowedDbUser
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Allowed by avatica and hsqldb
specifier|final
name|Properties
name|props
init|=
...
name|url
argument_list|,
literal|"INVALID_AVATICA_USER_VALID_DB_USER"
argument_list|,
name|props
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testDisallowedAvaticaNoDbUser
parameter_list|()
throws|throws
name|Exception
block|{
...
name|url
argument_list|,
literal|"INVALID_AVATICA_USER_NO_DB_USER"
argument_list|,
name|props
argument_list|)
expr_stmt|;
...
name|url
argument_list|,
literal|"DISALLOWED_AVATICA_USER"
argument_list|,
name|props
argument_list|)
expr_stmt|;
...
specifier|public
name|void
name|testDisallowedDbUser
parameter_list|()
throws|throws
name|Exception
block|{
comment|// Disallowed by hsqldb, allowed by avatica
specifier|final
name|Properties
name|props
init|=
...
begin_comment
comment|// End BasicAuthHttpServerTest.java
end_comment
