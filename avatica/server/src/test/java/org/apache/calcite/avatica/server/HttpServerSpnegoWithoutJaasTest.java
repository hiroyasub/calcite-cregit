...
begin_comment
comment|/**  * Test class for SPNEGO with Kerberos. Purely testing SPNEGO, not the Avatica "protocol" on top  * of that HTTP. This variant of the test relies on the "feature" Avatica provides to not require  * JAAS configuration by the user.  */
end_comment

begin_class
specifier|public
class|class
name|HttpServerSpnegoWithoutJaasTest
block|{
specifier|private
specifier|static
specifier|final
...
comment|// We use `withAutomaticLogin(File)` here which should invalidate the need to do JAAS config
name|httpServer
operator|=
operator|new
name|HttpServer
...
begin_comment
comment|// End HttpServerSpnegoWithoutJaasTest.java
end_comment
