...
return|;
block|}
comment|/**    * The connection id is always different, therefore when present in the request,    * set it to 0.    */
specifier|private
name|String
name|canonicalizeConnectionId
parameter_list|(
...
name|put
argument_list|(
literal|"{\"request\":\"openConnection\",\"connectionId\":\"0\",\"info\":{}}"
argument_list|,
...
name|put
argument_list|(
literal|"{\"request\":\"closeConnection\",\"connectionId\":\"0\"}"
argument_list|,
...
name|put
argument_list|(
literal|"{\"request\":\"getColumns\",\"catalog\":null,\"schemaPattern\":null,"
operator|+
