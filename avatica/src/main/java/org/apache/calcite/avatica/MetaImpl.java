...
block|}
block|}
comment|/** Prepare result with a iterable. Use this for simple statements    * that have a canned response and don't need to be executed. */
specifier|protected
interface|interface
name|WithIterable
block|{
...
function_decl|;
block|}
comment|/** Prepare result that contains an iterable. */
specifier|protected
specifier|static
class|class
name|SignatureWithIterable
