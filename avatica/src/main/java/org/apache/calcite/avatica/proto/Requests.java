...
parameter_list|()
function_decl|;
comment|/**      *<code>repeated .TypedValue parameter_values = 5;</code>      *      *<pre>      * List of parameter values if statement is to be executed. Else, none.      *</pre>      */
name|java
operator|.
name|util
operator|.
...
parameter_list|)
function_decl|;
comment|/**      *<code>optional bool has_parameter_values = 6;</code>      *      *<pre>      * Having an empty list of param values is distinct from a null param list      *</pre>      */
name|boolean
