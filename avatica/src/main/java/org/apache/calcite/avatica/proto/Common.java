...
block|{
block|}
comment|/**    * Protobuf enum {@code StatementType}    *    *<pre>    * Has to be consistent with Meta.StatementType    *</pre>    */
specifier|public
enum|enum
name|StatementType
...
argument_list|)
block|,
comment|/**      *<code>OTHER_DDL = 10;</code>      */
name|OTHER_DDL
argument_list|(
literal|10
argument_list|,
...
expr_stmt|;
block|}
comment|// @@protoc_insertion_point(enum_scope:StatementType)
block|}
...
block|}
comment|/**    * Protobuf enum {@code Severity}    *    *<pre>    * The severity of some unexpected outcome to an operation.    * Protobuf enum values must be unique across all other enums    *</pre>    */
specifier|public
enum|enum
name|Severity
implements|implements
...
name|ProtocolMessageEnum
block|{
comment|/**      *<code>UNKNOWN_SEVERITY = 0;</code>      */
...
argument_list|)
block|,
comment|/**      *<code>FATAL_SEVERITY = 1;</code>      */
name|FATAL_SEVERITY
argument_list|(
literal|1
argument_list|,
...
argument_list|)
block|,
comment|/**      *<code>ERROR_SEVERITY = 2;</code>      */
name|ERROR_SEVERITY
argument_list|(
literal|2
argument_list|,
...
argument_list|)
block|,
comment|/**      *<code>WARNING_SEVERITY = 3;</code>      */
...
expr_stmt|;
block|}
comment|// @@protoc_insertion_point(enum_scope:Severity)
block|}
specifier|public
interface|interface
...
parameter_list|()
function_decl|;
comment|/**      *<code>optional .StatementType statementType = 5;</code>      */
name|int
name|getStatementTypeValue
parameter_list|()
function_decl|;
comment|/**      *<code>optional .StatementType statementType = 5;</code>      */
name|org
...
specifier|final
name|int
name|STATEMENTTYPE_FIELD_NUMBER
init|=
literal|5
decl_stmt|;
specifier|private
...
name|MessageOrBuilder
block|{
comment|/**      *<code>repeated .ColumnValue value = 1;</code>      */
name|java
operator|.
name|util
operator|.
...
name|ColumnValueOrBuilder
extends|extends
comment|// @@protoc_insertion_point(interface_extends:ColumnValue)
name|com
operator|.
name|google
operator|.
...
function_decl|;
block|}
comment|/**    * Protobuf type {@code ColumnValue}    *    *<pre>    * A value might be a TypedValue or an Array of TypedValue's    *</pre>    */
specifier|public
specifier|static
specifier|final
class|class
...
name|GeneratedMessage
implements|implements
comment|// @@protoc_insertion_point(message_implements:ColumnValue)
name|ColumnValueOrBuilder
block|{
comment|// Use ColumnValue.newBuilder() to construct.
specifier|private
name|ColumnValue
parameter_list|(
name|com
...
name|Common
operator|.
name|internal_static_ColumnValue_descriptor
return|;
block|}
specifier|protected
name|com
...
name|Common
operator|.
name|internal_static_ColumnValue_fieldAccessorTable
operator|.
name|ensureFieldAccessorsInitialized
argument_list|(
name|org
...
argument_list|>
implements|implements
comment|// @@protoc_insertion_point(builder_implements:ColumnValue)
name|org
operator|.
name|apache
operator|.
...
return|;
block|}
comment|// Construct using org.apache.calcite.avatica.proto.Common.ColumnValue.newBuilder()
specifier|private
name|Builder
parameter_list|()
block|{
...
return|;
block|}
comment|// @@protoc_insertion_point(builder_scope:ColumnValue)
block|}
comment|// @@protoc_insertion_point(class_scope:ColumnValue)
specifier|private
specifier|static
specifier|final
name|org
