...
block|}
block|}
comment|/**    * Response for any request that the server failed to successfully perform.    * It is used internally by the transport layers to format errors for    * transport over the wire. Thus, {@link Request#apply} will never return    * an ErrorResponse.    */
specifier|public
class|class
name|ErrorResponse
extends|extends
