...
name|Meta
block|{
comment|/**    * Return database static properties, deprecating single function call getNumericFunctions,    * getStringFunctions, getSystemFunctions, getSqlKeywords and getTimeDateFunctions    *    * @param DatabaseProperty to get    * @return CSV String of the supported function/keyword    */
name|String
...
block|}
block|}
comment|/** Database Properties Enum for Meta#{@link Meta#getDatabaseProperties(DatabaseProperties)}}    */
enum|enum
name|DatabaseProperties
block|{
...
name|SQL_KEYWORDS
block|;   }
comment|/** POJO for Meta#{@link Meta#getDatabaseProperties(PropertyName)}}    *    *<p>Payload for {@link Service.DatabasePropertyRequest} and    * {@link Service.DatabasePropertyResponse}    *    * For {@link Service.Request}, the value is set to null    */
class|class
name|DatabaseProperty
block|{
specifier|public
