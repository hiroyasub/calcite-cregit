...
begin_comment
comment|/**  * Implementation of JDBC connection  * for the Avatica framework.  *  *<p>Abstract to allow newer versions of JDBC to add methods.</p>  */
end_comment
...
return|;
block|}
comment|/** A means for anyone who has a trojan to call the protected method      * {@link net.hydromatic.avatica.AvaticaStatement#getParameterValues()}. */
specifier|public
name|List
argument_list|<
name|Object
