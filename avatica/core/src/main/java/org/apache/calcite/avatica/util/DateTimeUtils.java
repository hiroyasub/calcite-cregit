...
return|;
block|}
comment|/** Parses a fraction, multiplying the first character by {@code multiplier},    * the second character by {@code multiplier / 10},    * the third character by {@code multiplier / 100}, and so forth.    *    *<p>For example, {@code parseFraction("1234", 100)} yields {@code 123}. */
specifier|private
specifier|static
name|int
name|parseFraction
...
condition|)
block|{
comment|// We're at the last digit. Check for rounding.
if|if
condition|(
name|i
operator|+
