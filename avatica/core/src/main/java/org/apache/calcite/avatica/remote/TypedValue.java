...
name|STRING
case|:
comment|// TypedValue is still going to expect a string for BYTE_STRING even though we sent it
comment|// across the wire natively as bytes.
return|return
name|protoValue
operator|.
name|getStringValue
