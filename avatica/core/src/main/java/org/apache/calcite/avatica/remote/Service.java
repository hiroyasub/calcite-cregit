...
block|}
block|}
comment|/** Request for    * {@link Meta#prepareAndExecute(Meta.StatementHandle, String, long, int, Meta.PrepareCallback)}.    */
class|class
name|PrepareAndExecuteRequest
extends|extends
name|Request
...
specifier|final
name|FieldDescriptor
name|MAX_ROWS_TOTAL_DESCRIPTOR
init|=
name|Requests
operator|.
name|PrepareAndExecuteRequest
...
specifier|final
name|FieldDescriptor
name|FIRST_FRAME_MAX_SIZE_DESCRIPTOR
init|=
name|Requests
operator|.
name|PrepareAndExecuteRequest
...
expr_stmt|;
block|}
comment|// Use the old attribute, unless the new is set
name|long
name|maxRowsTotal
init|=
name|msg
...
expr_stmt|;
block|}
comment|// Use maxRowCount (cast to an integer) if firstFrameMaxSize isn't set
name|int
name|maxRowsInFirstFrame
init|=
operator|(
...
argument_list|)
expr_stmt|;
comment|// Set both attributes for backwards compat
name|builder
operator|.
name|setMaxRowCount
argument_list|(
...
expr_stmt|;
block|}
comment|// Use the old field unless the new field is provided
name|long
name|totalRowsForStatement
init|=
name|msg
operator|.
name|getMaxRowCount
...
expr_stmt|;
block|}
comment|// Set both field for backwards compatibility
return|return
name|builder
operator|.
name|setMaxRowCount
...
specifier|final
name|FieldDescriptor
name|FRAME_MAX_SIZE_DESCRIPTOR
init|=
name|Requests
operator|.
name|FetchRequest
...
argument_list|)
expr_stmt|;
comment|// Both fields for backwards compat
name|builder
operator|.
