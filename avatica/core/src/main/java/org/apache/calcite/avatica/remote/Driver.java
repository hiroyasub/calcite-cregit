...
argument_list|()
decl_stmt|;
comment|// Perform the login and launch the renewal thread if necessary
specifier|final
name|KerberosConnection
name|kerberosUtil
init|=
name|createKerberosUtility
argument_list|(
name|config
argument_list|)
decl_stmt|;
...
name|connection
operator|.
name|setKerberosConnection
argument_list|(
name|kerberosUtil
argument_list|)
expr_stmt|;
block|}
comment|// Create a single Service and set it on the Connection instance
specifier|final
name|Service
name|service
init|=
...
argument_list|()
decl_stmt|;
comment|// super.connect(...) should be creating a service and setting it in the AvaticaConnection
assert|assert
literal|null
operator|!=
name|service
