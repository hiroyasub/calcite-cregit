...
comment|// flushed to the server (be sure to introduce any new changes from connProps before
comment|// checking AND when connProps.isEmpty() (meaning, this was a request for a value, not
comment|// overriding a value). Otherwise, accumulate the change locally and return immediately.
if|if
condition|(
name|localProps
operator|.
