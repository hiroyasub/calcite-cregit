...
specifier|final
name|FieldDescriptor
name|COLUMN_CLASS_NAME_DESCRIPTOR
init|=
name|Common
operator|.
name|ColumnMetaData
...
condition|)
block|{
comment|// BIG_DECIMAL has to come back as a NUMBER
return|return
name|Rep
operator|.
name|NUMBER
