...
expr_stmt|;
block|}
comment|/** A "magic column" descriptor used to return statement execute update count via a    * {@link Meta.MetaResultSet}. */
specifier|private
specifier|static
specifier|final
name|ColumnMetaData
...
literal|15
argument_list|,
literal|"update_result"
argument_list|,
literal|"avatica_internal"
argument_list|,
name|ColumnMetaData
operator|.
name|scalar
...
argument_list|)
expr_stmt|;
comment|// TODO: must we retain a statement in all cases?
name|boolean
name|ret
init|=
name|statement
...
condition|)
block|{
comment|// build a non-JDBC result that contains the update count
name|int
name|updateCount
init|=
name|statement
