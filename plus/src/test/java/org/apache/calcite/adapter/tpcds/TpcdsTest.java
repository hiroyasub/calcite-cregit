...
operator|+
literal|"          EnumerableHashJoin(condition=[AND(=($82, $133), =($81, $132), =($88, $139))], joinType=[inner]): rowcount = 9.056715031420328E27, cumulative cost = {9.065771746593055E27 rows, 1.7776306E7 cpu, 0.0 io}\n"
operator|+
literal|"            EnumerableHashJoin(condition=[=($0, $86)], joinType=[inner]): rowcount = 3.8347337644821E13, cumulative cost = {8.097127760662506E13 rows, 7281360.0 cpu, 0.0 io}\n"
operator|+
literal|"              EnumerableTableScan(table=[[TPCDS, STORE]]): rowcount = 12.0, cumulative cost = {12.0 rows, 13.0 cpu, 0.0 io}\n"
operator|+
literal|"              EnumerableHashJoin(condition=[=($0, $52)], joinType=[inner]): rowcount = 2.1304076469345E13, cumulative cost = {2.1319863492416234E13 rows, 7281347.0 cpu, 0.0 io}\n"
operator|+
literal|"                EnumerableTableScan(table=[[TPCDS, ITEM]]): rowcount = 18000.0, cumulative cost = {18000.0 rows, 18001.0 cpu, 0.0 io}\n"
operator|+
literal|"                EnumerableHashJoin(condition=[=($0, $28)], joinType=[inner]): rowcount = 7.890398692349999E9, cumulative cost = {7.896430011596686E9 rows, 7263346.0 cpu, 0.0 io}\n"
operator|+
literal|"                  EnumerableCalc(expr#0..27=[{inputs}], expr#28=[Sarg['1998Q1']:CHAR(6)], expr#29=[SEARCH($t15, $t28)], proj#0..27=[{exprs}], $condition=[$t29]): rowcount = 18262.25, cumulative cost = {91311.25 rows, 4382941.0 cpu, 0.0 io}\n"
operator|+
