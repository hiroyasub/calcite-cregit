...
expr_stmt|;
block|}
comment|/**    * Creates a Cassandra schema.    *    * @param host Cassandra host, e.g. "localhost"    * @param port Cassandra port, e.g. 9042    * @param keyspace Cassandra keyspace name, e.g. "twissandra"    */
annotation|@
name|SuppressWarnings
argument_list|(
literal|"unused"
...
expr_stmt|;
block|}
comment|/**    * Creates a Cassandra schema.    *    * @param host Cassandra host, e.g. "localhost"    * @param port Cassandra port, e.g. 9042    * @param keyspace Cassandra keyspace name, e.g. "twissandra"    * @param username Cassandra username    * @param password Cassandra password    */
specifier|public
name|CassandraSchema
parameter_list|(
name|String
...
return|;
block|}
comment|/** Returns the partition key columns from the underlying CQL table.    *    * @return A list of field names that are part of the partition keys    */
name|List
argument_list|<
name|String
argument_list|>
...
return|;
block|}
comment|/** Returns the clustering keys from the underlying CQL table.    *    * @return A list of field names that are part of the clustering keys    */
name|List
argument_list|<
name|String
argument_list|>
name|getClusteringKeys
parameter_list|(
name|String
name|columnFamily
parameter_list|,
...
parameter_list|()
block|{
comment|// Close the hook used to get us here
name|hook
operator|.
name|close
argument_list|()
...
name|IllegalStateException
argument_list|(
literal|"Cannot find schema "
operator|+
name|name
operator|+
literal|" in parent schema "
operator|+
name|parentSchema
operator|.
name|getName
