...
argument_list|)
decl_stmt|;
comment|/**    * Creates a MongoToEnumerableConverterRule.    *    * @param relBuilderFactory Builder for relational expressions    */
specifier|public
name|MongoToEnumerableConverterRule
parameter_list|(
name|RelBuilderFactory
...
begin_comment
comment|// End MongoToEnumerableConverterRule.java
end_comment
