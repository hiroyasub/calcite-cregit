...
specifier|private
name|void
name|registerTableEmpNullables
parameter_list|(
name|MockTable
...
specifier|private
name|void
name|registerTableDeptNestedExpanded
parameter_list|(
name|MockSchema
name|salesSchema
parameter_list|,
...
name|fixture
operator|.
name|rectilinearPeekCoordMultisetType
argument_list|)
expr_stmt|;
name|registerTable
argument_list|(
...
specifier|private
name|void
name|registerTableEmptyProducts
parameter_list|(
name|MockSchema
name|salesSchema
parameter_list|,
...
specifier|private
name|void
name|registerTableProductsTemporal
parameter_list|(
name|MockSchema
name|salesSchema
parameter_list|,
...
specifier|private
name|void
name|registerViewEmpNullables20
parameter_list|(
name|MockSchema
name|salesSchema
parameter_list|,
...
argument_list|)
expr_stmt|;
comment|// Register "DEPT_NESTED_EXPANDED" table.
name|registerTableDeptNestedExpanded
argument_list|(
name|salesSchema
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// Register "EMPTY_PRODUCTS" table.
name|registerTableEmptyProducts
argument_list|(
name|salesSchema
argument_list|,
