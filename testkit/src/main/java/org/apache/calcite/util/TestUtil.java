...
return|;
block|}
comment|/** Rounds all decimal fractions inside a string to a given number of decimal    * places.    *    *<p>For example,    * {@code round("POINT(-1.23456, 9.87654)", 3)}    * returns "POINT(-1.235, 9.877)". */
specifier|public
specifier|static
name|String
name|roundGeom
...
literal|'.'
case|:
comment|// Entering the fractional part of a number
name|end
operator|=
name|i
operator|+
...
block|{
break|break;
comment|// Have seen a '.' but not enough digits yet
block|}
if|if
condition|(
name|c
...
return|;
block|}
comment|/** Increments the last digit of a decimal number in a StringBuilder, and if    * that digit was a '9', carries on going. */
specifier|private
specifier|static
name|void
name|carry
...
case|:
continue|continue;
comment|// continue to the left of decimal point
case|case
literal|'0'
case|:
case|case
...
argument_list|)
expr_stmt|;
comment|// '9' becomes '0', and continue carrying
continue|continue;
default|default:
name|b
operator|.
