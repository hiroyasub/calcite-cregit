...
specifier|final
name|Method
name|GENERATE_STRINGS_OF_INPUT_MAP_SIZE_METHOD
init|=
name|Types
operator|.
name|lookupMethod
...
name|class
argument_list|,
literal|"generateStringsOfInputMapSize"
argument_list|,
name|Map
operator|.
name|class
...
name|class
argument_list|,
literal|"fibonacciTableWithLimit100"
argument_list|)
decl_stmt|;
specifier|public
specifier|static
...
specifier|final
name|Method
name|FIBONACCI_INSTANCE_TABLE_METHOD
init|=
name|Types
operator|.
name|lookupMethod
...
specifier|final
name|Method
name|DUMMY_TABLE_METHOD_WITH_TWO_PARAMS
init|=
name|Types
operator|.
name|lookupMethod
...
name|class
argument_list|,
literal|"dummyTableFuncWithTwoParams"
argument_list|,
name|long
operator|.
name|class
...
specifier|static
name|QueryableTable
name|generateStringsOfInputSize
parameter_list|(
specifier|final
name|List
argument_list|<
...
specifier|static
name|QueryableTable
name|generateStringsOfInputMapSize
parameter_list|(
specifier|final
name|Map
argument_list|<
...
return|;
block|}
comment|/** A function that generates the Fibonacci sequence.    *    *<p>Interesting because it has one column and no arguments,    * and because it is infinite. */
specifier|public
specifier|static
name|ScannableTable
name|fibonacciTable
...
return|;
block|}
comment|/** A function that generates the first 100 terms of the Fibonacci sequence.    *    *<p>Interesting because it has one column and no arguments. */
specifier|public
specifier|static
name|ScannableTable
name|fibonacciTableWithLimit100
parameter_list|()
block|{
return|return
name|fibonacciTableWithLimit
...
return|;
block|}
comment|/** A function that takes 2 param as input. */
specifier|public
specifier|static
name|ScannableTable
name|dummyTableFuncWithTwoParams
parameter_list|(
specifier|final
name|long
name|param1
...
return|;
block|}
comment|/** A table whose row type is determined by parsing a JSON argument. */
specifier|private
specifier|static
class|class
name|DynamicRowTypeTable
...
block|}
block|}
comment|/** As {@link MyPlusFunction} but constructor has a    *  {@link org.apache.calcite.schema.FunctionContext} parameter. */
specifier|public
specifier|static
class|class
name|MyPlusInitFunction
...
name|append
argument_list|(
literal|" is constant and has value "
argument_list|)
operator|.
name|append
argument_list|(
...
block|}
block|}
comment|/** Example of a semi-strict UDF.    * (Returns null if its parameter is null or if its length is 4.) */
specifier|public
specifier|static
class|class
name|Null4Function
...
block|}
block|}
comment|/** Example of a picky, semi-strict UDF.    * Throws {@link NullPointerException} if argument is null.    * Returns null if its argument's length is 8. */
specifier|public
specifier|static
class|class
name|Null8Function
...
block|}
block|}
comment|/** Example of a UDF with non-default constructor.    *    *<p>Not used; we do not currently have a way to instantiate function    * objects other than via their default constructor. */
specifier|public
specifier|static
class|class
name|FibonacciTableFunction
...
block|}
block|}
comment|/** User-defined function that declares exceptions. */
specifier|public
specifier|static
class|class
...
name|IOException
argument_list|(
literal|"IOException when argument> 100"
argument_list|)
throw|;
block|}
return|return
...
block|}
block|}
comment|/** Example of a user-defined aggregate function (UDAF) with two parameters.    * The constructor has an initialization parameter. */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/** Another example of a user-defined aggregate function (UDAF) with two    * parameters. */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/** Example of a user-defined aggregate function (UDAF), whose methods are    * static. Similar to {@link MyThreeParamsSumFunctionWithFilter1}, but    * argument types are different. */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/**    * Implementation of {@link TableMacro} interface with    * {@link #apply} method that returns {@link Queryable} table.    */
specifier|public
specifier|static
class|class
name|SimpleTableMacro
implements|implements
name|TableMacro
block|{
annotation|@
...
block|}
block|}
comment|/** Table with columns (A, B). */
specifier|public
specifier|static
class|class
name|SimpleTable
