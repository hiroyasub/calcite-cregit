...
parameter_list|()
block|{
comment|// This should not really be a UDF. A SQL UDF has a fixed number of named
comment|// parameters, and this does not. But let's pretend that it has two
comment|// parameters of type 'ANY'
specifier|final
name|int
name|paramCount
init|=
