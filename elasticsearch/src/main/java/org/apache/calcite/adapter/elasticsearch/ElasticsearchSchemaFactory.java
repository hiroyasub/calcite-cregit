...
block|}
block|}
comment|/**    * Builds Elastic rest client from user configuration.    *    * @param hosts list of ES HTTP Hosts to connect to    * @param username the username of ES    * @param password the password of ES    * @return newly initialized low-level rest http client for ES    */
specifier|private
specifier|static
name|RestClient
name|connect
