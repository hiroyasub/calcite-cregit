...
expr_stmt|;
block|}
comment|/**      * Translates a condition that may be an AND of other conditions. Gathers      * together conditions that apply to the same field.      *      * @param node0 expression node      * @return list of elastic search term filters      */
specifier|private
name|List
argument_list|<
name|Map
...
block|}
block|}
comment|/**      * Translates a call to a binary operator, reversing arguments if      * necessary.      * @param op operation      * @param rop opposite operation of {@code op}      * @param call current relational call      * @return result can be ignored      */
specifier|private
name|Void
name|translateBinary
parameter_list|(
...
throw|;
block|}
comment|/**      * Translates a call to a binary operator. Returns whether successful.      * @param op operation      * @param left left node of the expression      * @param right right node of the expression      * @return {@code true} if translation happened, {@code false} otherwise      */
specifier|private
name|boolean
name|translateBinary2
parameter_list|(
