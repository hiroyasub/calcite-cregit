...
name|client
decl_stmt|;
comment|/**    * Creates an Elasticsearch schema.    *    * @param coordinates Map of Elasticsearch node locations (host, port)    * @param userConfig Map of user-specified configurations    * @param indexName Elasticsearch database name, e.g. "usa".    */
name|ElasticsearchSchema
parameter_list|(
name|Map
argument_list|<
...
name|RuntimeException
argument_list|(
literal|"Cannot connect to any elasticsearch nodes"
argument_list|)
throw|;
block|}
name|client
