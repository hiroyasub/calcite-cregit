...
literal|"_source"
decl_stmt|;
comment|/**    * Attribute that uniquely identifies a document (ID).    *    * @see<a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/mapping-id-field.html">ID Field</a>    */
name|String
name|ID
init|=
literal|"_id"
