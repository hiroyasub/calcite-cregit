...
return|return;
block|}
comment|// check if we have reached actual field mapping (leaf of JSON tree)
name|Predicate
argument_list|<
name|JsonNode
argument_list|>
...
begin_comment
comment|/**    * Allows to de-serialize total hits structures.    */
end_comment
