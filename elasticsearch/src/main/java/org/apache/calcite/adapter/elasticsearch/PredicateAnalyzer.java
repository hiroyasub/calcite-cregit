...
case|:
return|return
name|canBeTranslatedToTermsQuery
argument_list|(
name|call
argument_list|)
return|;
...
block|{
return|return
name|isSearchWithPoints
argument_list|(
name|search
argument_list|)
operator|||
name|isSearchWithComplementedPoints
argument_list|(
name|search
argument_list|)
return|;
...
name|ROOT
argument_list|,
literal|"Unsupported NOT operator: [%s]"
argument_list|,
name|call
argument_list|)
decl_stmt|;
...
parameter_list|)
function_decl|;
comment|/**      * Negate {@code this} QueryExpression (not the next one).      */
specifier|public
specifier|abstract
name|QueryExpression
name|not
...
name|PredicateAnalyzerException
argument_list|(
literal|"SqlOperatorImpl ['contains'] "
operator|+
literal|"cannot be applied to a compound expression"
argument_list|)
throw|;
...
name|PredicateAnalyzerException
argument_list|(
literal|"in cannot be applied to a compound expression"
argument_list|)
throw|;
block|}
annotation|@
...
name|PredicateAnalyzerException
argument_list|(
literal|"notIn cannot be applied to a compound expression"
argument_list|)
throw|;
block|}
block|}
...
argument_list|(
literal|"Builder was not initialized"
argument_list|)
throw|;
block|}
return|return
