...
return|;
block|}
comment|/**    * A query that wraps another query and simply returns a dismax score equal to the    * query boost for every document in the query.    *    * @param queryBuilder The query to wrap in a constant score query    */
specifier|static
...
block|}
block|}
comment|/**    * A query that wraps a filter and simply returns a dismax score equal to the    * query boost for every document in the filter.    */
specifier|static
class|class
name|DisMaxQueryBuilder
extends|extends
