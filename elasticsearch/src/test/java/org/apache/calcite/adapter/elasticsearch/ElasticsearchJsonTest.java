...
expr_stmt|;
block|}
comment|/**    * Validate that property names which are reserved keywords ES    * are correctly mapped (eg. {@code type} or {@code properties})    */
annotation|@
name|Test
name|void
name|reservedKeywordMapping
parameter_list|()
throws|throws
name|Exception
block|{
comment|// have special property names: type and properties
name|ObjectNode
name|mapping
init|=
name|mapper
...
literal|"{properties:{"
operator|+
literal|"type:{type:'text'},"
operator|+
literal|"keyword:{type:'keyword'},"
operator|+
literal|"properties:{type:'long'}"
operator|+
literal|"}}"
argument_list|,
name|ObjectNode
