...
name|query
argument_list|(
literal|"select count(*) from view where val1>= 10 and val1<=20"
argument_list|)
operator|.
name|returns
argument_list|(
...
name|query
argument_list|(
literal|"select count(*) from view where val1<= 10 or val1>=20"
argument_list|)
operator|.
name|returns
argument_list|(
...
name|query
argument_list|(
literal|"select count(*) from view where val1<= 10 or (val1> 15 and val1<= 20)"
argument_list|)
operator|.
name|returns
argument_list|(
...
name|query
argument_list|(
literal|"select count(*) from view where val1 in (10, 20)"
argument_list|)
operator|.
name|returns
argument_list|(
...
name|query
argument_list|(
literal|"select count(*) from view where cat4 in ('2018-01-01', '2019-12-12')"
argument_list|)
operator|.
name|returns
argument_list|(
...
name|query
argument_list|(
literal|"select count(*) from view where cat4 not in ('2018-01-01', '2019-12-12')"
argument_list|)
operator|.
name|returns
argument_list|(
