...
expr_stmt|;
block|}
comment|/**    * Creates alias in elastic search given an index.    * as dots({@code .}).    *    *<p>Example    *<pre>    *  {@code    *     b.a: long    *     b.b: keyword    *  }    *</pre>    *    * @param index index of the index    * @param alias alias of the index    * @throws IOException if there is an error    */
name|void
name|createAlias
parameter_list|(
name|String
