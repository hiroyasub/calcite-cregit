...
return|;
block|}
comment|/**    * Creates index in elastic search given mapping.    *    * @param index index of the index    * @param mapping field and field type mapping    * @throws IOException if there is an error    */
name|void
name|createIndex
parameter_list|(
name|String
