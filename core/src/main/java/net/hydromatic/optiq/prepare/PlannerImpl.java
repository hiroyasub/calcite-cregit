...
return|;
block|}
comment|/** Temporary method while we are phasing out schema names. Once            *<a href="https://github.com/julianhyde/optiq/issues/214">optiq-214</a>            * is fixed, the client will pass us a {@link SchemaPlus}, and that            * has a name. */
specifier|private
name|String
name|getName
parameter_list|(
