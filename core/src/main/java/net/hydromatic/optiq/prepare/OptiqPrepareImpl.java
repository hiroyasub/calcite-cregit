...
literal|true
decl_stmt|;
comment|/** Whether to enable Spark. */
specifier|private
specifier|static
specifier|final
name|ThreadLocal
...
name|forName
argument_list|(
literal|"net.hydromatic.optiq.impl.spark.SparkRel"
argument_list|)
operator|.
name|getField
argument_list|(
...
name|forName
argument_list|(
literal|"net.hydromatic.optiq.impl.spark.SparkRules"
argument_list|)
operator|.
name|getMethod
argument_list|(
