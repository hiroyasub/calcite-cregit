...
return|;
block|}
comment|/** Returns an {@link net.hydromatic.linq4j.Enumerable} over the rows of    * a given table, representing each row as an object array. */
specifier|public
specifier|static
name|Enumerable
argument_list|<
...
return|;
block|}
comment|/** Returns an {@link net.hydromatic.linq4j.Enumerable} over the rows of    * a given table, not applying any filters, representing each row as an object    * array. */
specifier|public
specifier|static
name|Enumerable
argument_list|<
...
return|;
block|}
comment|/** Returns an {@link net.hydromatic.linq4j.Enumerable} over object arrays,    * given a fully-qualified table name which leads to a    * {@link ScannableTable}. */
specifier|public
specifier|static
name|Table
name|table
