...
parameter_list|()
function_decl|;
comment|/** Accesses a timestamp value as a string. The timestamp is in SQL format    * (e.g. "2013-09-22 22:30:32"), not Java format ("2013-09-22 22:30:32.123").    *    * @param accessor Accessor for this column    * @return Timestamp string    */
specifier|static
name|String
