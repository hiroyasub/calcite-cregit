...
block|}
block|}
comment|// No direct hit. Look for roll-ups.
for|for
control|(
name|TileKey
name|tileKey2
...
return|;
block|}
comment|/** Definition of a particular combination of dimensions and measures of a    * lattice that is the basis of a materialization.    *    *<p>Holds similar information to a {@link Lattice.Tile} but a lattice is    * immutable and tiles are not added after their creation. */
specifier|public
specifier|static
class|class
name|TileKey
