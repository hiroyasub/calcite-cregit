...
parameter_list|)
block|{
comment|// orderChanged will be true if this is the first row with a particular
comment|// value of the ORDER BY key, including if it is the first row.
specifier|final
name|Expression
name|orderChanged
init|=
