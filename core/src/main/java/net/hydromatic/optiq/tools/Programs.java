...
block|{
comment|// Create a program that gathers together joins as a MultiJoinRel.
specifier|final
name|HepProgram
name|hep
init|=
...
comment|// We use the rule set passed in, but remove SwapJoinRule and
comment|// PushJoinThroughJoinRule, because they cause exhaustive search.
specifier|final
name|List
argument_list|<
name|RelOptRule
