...
name|sourceSchema
decl_stmt|;
comment|/**    * Creates a CloneSchema.    *    * @param parentSchema Parent schema    * @param name Name of schema    * @param expression Expression for schema    * @param sourceSchema JDBC data source    */
specifier|public
name|CloneSchema
parameter_list|(
name|Schema
