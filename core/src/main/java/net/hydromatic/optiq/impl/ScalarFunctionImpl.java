...
expr_stmt|;
block|}
comment|/**    * Creates {@link net.hydromatic.optiq.ScalarFunction} from given class.    * The class should contain {@code eval} method.    * When {@code eval} method is not found or it does not suit,    * {@code null} is returned.    *    * @param clazz class that is used to implement the function    * @return created {@link ScalarFunction} or null    */
specifier|public
specifier|static
name|ScalarFunction
name|create
