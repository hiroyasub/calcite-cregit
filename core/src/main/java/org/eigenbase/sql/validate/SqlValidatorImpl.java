...
block|{
comment|// Luckily, field names have not been uniquified yet.
specifier|final
name|List
argument_list|<
name|String
...
name|query
argument_list|,
literal|"Column has duplicate column name '"
operator|+
name|fieldNames
operator|.
name|get
...
argument_list|)
operator|+
literal|"' and no column list specified"
argument_list|)
throw|;
block|}
block|}
block|}
comment|// TODO: replace with resourced message
specifier|private
name|EigenbaseException
name|todoError
parameter_list|(
