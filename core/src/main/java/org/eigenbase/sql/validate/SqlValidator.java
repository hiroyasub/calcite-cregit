...
parameter_list|()
function_decl|;
comment|/**      * Saves the type of a {@link SqlNode}, now that it has been validated.      *      * @param node A SQL parse tree node      * @param type Its type; must not be null      *      * @deprecated This method should not be in the {@link SqlValidator}      * interface. The validator should drive the type-derivation process, and      * store nodes' types when they have been derived.      * @pre type != null      * @pre node != null      */
name|void
