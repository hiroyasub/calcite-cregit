...
comment|// the cost of each JoinRel that appears above that RelNode.
name|int
name|width
init|=
name|tree
...
comment|// MultiJoinRel was a full outer join, these should be the only
...
comment|// FilterRel placed on top off the projection created above.
name|RelNode
name|topRelNode
init|=
name|projRel
