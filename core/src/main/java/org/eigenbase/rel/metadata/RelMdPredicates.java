...
return|;
block|}
comment|/**    * Infers predicates for a UnionRelBase.    *    *<p>The pulled up expression is a disjunction of its children's predicates.    */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
...
return|;
block|}
comment|/**    * Infers predicates for a SortRel.    */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
