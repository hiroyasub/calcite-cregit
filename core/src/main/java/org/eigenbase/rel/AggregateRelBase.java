...
return|;
block|}
comment|/** Creates a copy of this aggregate.    *    * @see #copy(org.eigenbase.relopt.RelTraitSet, java.util.List)    */
specifier|public
specifier|abstract
name|AggregateRelBase
name|copy
...
return|;
block|}
comment|/** Computes the row type of an {@code AggregateRelBase} before it exists. */
specifier|public
specifier|static
name|RelDataType
name|deriveRowType
...
name|groupCount
decl_stmt|;
comment|/**      * Creates an AggCallBinding      *      * @param typeFactory  Type factory      * @param aggFunction  Aggregation function      * @param operands     Data types of operands      * @param groupCount   Number of columns in the GROUP BY clause      */
specifier|public
name|AggCallBinding
parameter_list|(
name|RelDataTypeFactory
