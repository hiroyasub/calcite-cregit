...
condition|)
block|{
comment|// Avoid creating a copy of a list that is already sorted.
comment|//noinspection unchecked
return|return
operator|(
name|List
...
return|;
block|}
comment|/** Returns whether an iterable is in non-descending order. */
specifier|public
specifier|static
parameter_list|<
name|E
