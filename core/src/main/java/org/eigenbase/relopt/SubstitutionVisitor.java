...
block|}
block|}
comment|/** Implementation of {@link UnifyRule} that matches if the query is already    * equal to the target.    *    *<p>Matches scans to the same table, because these will be    * {@link MutableScan}s with the same    * {@link org.eigenbase.rel.TableAccessRel} instance.</p>    */
specifier|private
specifier|static
class|class
name|TrivialRule
...
block|}
block|}
comment|/** Mutable equivalent of {@link TableAccessRel}. */
specifier|private
specifier|static
class|class
name|MutableScan
...
block|}
block|}
comment|/** Mutable equivalent of {@link ValuesRelBase}. */
specifier|private
specifier|static
class|class
name|MutableValues
...
block|}
block|}
comment|/** Mutable equivalent of {@link ProjectRel}. */
specifier|private
specifier|static
class|class
name|MutableProject
...
block|}
block|}
comment|/** Mutable equivalent of {@link FilterRel}. */
specifier|private
specifier|static
class|class
name|MutableFilter
...
block|}
block|}
comment|/** Mutable equivalent of {@link AggregateRel}. */
specifier|private
specifier|static
class|class
name|MutableAggregate
...
block|}
block|}
comment|/** Mutable equivalent of {@link SortRel}. */
specifier|private
specifier|static
class|class
name|MutableSort
...
block|}
block|}
comment|/** Mutable equivalent of {@link UnionRel}. */
specifier|private
specifier|static
class|class
name|MutableUnion
...
return|;
block|}
comment|/** Based on {@link RemoveTrivialProjectRule#isTrivial(ProjectRelBase)}. */
specifier|public
specifier|static
name|boolean
name|isTrivial
...
return|;
block|}
comment|/** Equivalence to {@link org.eigenbase.relopt.RelOptUtil#createCastRel}      * for {@link MutableRel}. */
specifier|public
specifier|static
name|MutableRel
name|createCastRel
...
block|}
block|}
comment|/**    * Rule that converts a {@link FilterRel} on top of a {@link ProjectRel} into    * a trivial filter (on a boolean column).    */
specifier|public
specifier|static
class|class
