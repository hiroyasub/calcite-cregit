...
return|;
block|}
comment|/**    * Creates a reference to an aggregate call, checking for repeated calls.    * @param aggCall aggregate call to be added    * @param groupCount number of groups in the aggregate relation    * @param aggCalls destination list of aggregate calls    * @param aggCallMapping the dictionary of already added calls    * @return Rex expression for the given aggregate call    * @deprecated Use {@link #addAggCall(org.eigenbase.rel.AggregateCall, int, java.util.List, java.util.Map, java.util.List)}    * Will be removed before optiq-0.9.    */
annotation|@
name|Deprecated
specifier|public
name|RexNode
...
return|;
block|}
comment|/**    * Creates a reference to an aggregate call, checking for repeated calls.    * Argument types help to optimize for repeated aggregates.    * For instance count(42) is equivalent to count(*)    * @param aggCall aggregate call to be added    * @param groupCount number of groups in the aggregate relation    * @param aggCalls destination list of aggregate calls    * @param aggCallMapping the dictionary of already added calls    * @return Rex expression for the given aggregate call    */
specifier|public
name|RexNode
name|addAggCall
parameter_list|(
...
block|}
block|}
comment|/** Converts the type of a value to comply with    * {@link org.eigenbase.rex.RexLiteral#valueMatchesType}. */
specifier|private
specifier|static
name|Object
name|clean
