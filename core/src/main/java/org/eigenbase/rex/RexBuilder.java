...
block|}
block|}
comment|/**    * Creates a literal of a given type. The value is assumed to be    * compatible with the type.    *    * @param type      Type    * @param allowCast Whether to allow a cast. If false, value is always a    *                  {@link RexLiteral} but may not be the exact type    * @return Simple literal, or cast simple literal    */
specifier|public
name|RexNode
name|makeLiteral
parameter_list|(
