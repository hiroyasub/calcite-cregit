...
expr_stmt|;
block|}
comment|/**    * Implementation of    * {@link net.hydromatic.optiq.rules.java.RexToLixTranslator.InputGetter}    * that reads the values of input fields by calling    *<code>{@link net.hydromatic.optiq.DataContext#get}("inputRecord")</code>.    */
specifier|private
specifier|static
class|class
name|DataContextInputGetter
