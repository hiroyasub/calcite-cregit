...
comment|// That is why we need findTypeParameters to find ExInstWithCause in
comment|// superclass chain
name|Type
name|type
init|=
name|method
...
name|IllegalStateException
argument_list|(
literal|"Unable to find superclass"
operator|+
literal|" ExInstWithCause for "
operator|+
name|type
argument_list|)
throw|;
...
name|IllegalStateException
argument_list|(
literal|"ExInstWithCause should have"
operator|+
literal|" exactly one type parameter"
argument_list|)
throw|;
block|}
return|return
