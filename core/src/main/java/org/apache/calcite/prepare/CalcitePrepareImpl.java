...
name|INSTANCE
decl_stmt|;
comment|// Use the Volcano because it can handle the traits.
specifier|final
name|VolcanoPlanner
name|planner
init|=
...
throw|;
block|}
comment|/** Returns CalcitePreparingStmt    *    *<p>Override this function to return a custom {@link CalcitePreparingStmt} and    * {@link #createSqlValidator} to enable custom validation logic.    */
specifier|protected
name|CalcitePreparingStmt
name|getPreparingStmt
parameter_list|(
...
return|;
block|}
comment|/** Holds state for the process of preparing a SQL statement.    *    *<p>Overload this class and {@link #createSqlValidator} to provide desired SqlValidator    * and custom validation logic.</p>    */
specifier|public
specifier|static
class|class
name|CalcitePreparingStmt
...
name|sqlValidator
decl_stmt|;
comment|/** Constructor.      *      *<p>Overload this constructor and {@link #createSqlValidator} to provide desired      *  SqlValidaor and custom validation logic.</p>      */
specifier|public
name|CalcitePreparingStmt
argument_list|(
name|CalcitePrepareImpl
...
name|prefer
argument_list|,
literal|"EnumerableRel.Prefer prefer"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
parameter_list|()
lambda|->
literal|"static field access is not implemented yet."
operator|+
literal|" field.name="
operator|+
name|field
