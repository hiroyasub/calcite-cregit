...
argument_list|)
decl_stmt|;
comment|// Use a short-lived type factory to populate "typeFamilies" and "argTypes".
comment|// SqlOperandMetadata.paramTypes will use the real type factory, during
comment|// validation.
specifier|final
name|RelDataTypeFactory
name|dummyTypeFactory
init|=
operator|new
name|JavaTypeFactoryImpl
argument_list|()
