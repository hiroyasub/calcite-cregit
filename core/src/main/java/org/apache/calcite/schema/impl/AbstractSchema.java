...
return|;
block|}
comment|/**    * Returns a map of types in this schema by name.    *    *<p>The implementations of {@link #getTypeNames()}    * and {@link #getType(String)} depend on this map.    * The default implementation of this method returns the empty map.    * Override this method to change their behavior.</p>    *    * @return Map of types in this schema by name    */
specifier|protected
name|Map
argument_list|<
name|String
...
return|;
block|}
comment|/** Schema factory that creates an    * {@link org.apache.calcite.schema.impl.AbstractSchema}. */
specifier|public
specifier|static
class|class
name|Factory
