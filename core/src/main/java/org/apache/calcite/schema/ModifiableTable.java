...
begin_comment
comment|/**  * A table that can be modified.  *  *<p>NOTE: The current API is inefficient and experimental. It will change  * without notice.</p>  *  * @see ModifiableView  */
end_comment
...
parameter_list|()
function_decl|;
comment|/** Creates a relational expression that modifies this table. */
name|TableModify
