...
return|;
block|}
comment|/**    * Returns whether a class has a public constructor with zero arguments.    *    * @param clazz Class to verify    * @return whether class has a public constructor with zero arguments    */
specifier|static
name|boolean
...
return|;
block|}
comment|/**    * Returns whether a class has a public constructor with one argument    * of type {@link FunctionContext}.    *    * @param clazz Class to verify    * @return whether class has a public constructor with one FunctionContext    * argument    */
specifier|static
name|boolean
