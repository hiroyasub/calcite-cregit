...
argument_list|>
name|bangEqualNotAllowed
parameter_list|()
function_decl|;
annotation|@
name|BaseMessage
argument_list|(
literal|"Percent remainder ''%'' is not allowed under the current SQL conformance level"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
argument_list|>
name|percentRemainderNotAllowed
parameter_list|()
function_decl|;
annotation|@
name|BaseMessage
...
name|BaseMessage
argument_list|(
literal|"Illegal identifier '':''. Was expecting ''VALUE''"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Table ''{0}'' not found; did you mean ''{1}''?"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
parameter_list|)
function_decl|;
comment|/** Same message as {@link #tableNameNotFound(String)} but a different kind    * of exception, so it can be used in {@code RelBuilder}. */
annotation|@
name|BaseMessage
argument_list|(
literal|"Table ''{0}'' not found"
...
name|BaseMessage
argument_list|(
literal|"Object ''{0}'' not found within ''{1}''"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Object ''{0}'' not found; did you mean ''{1}''?"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Object ''{0}'' not found within ''{1}''; did you mean ''{2}''?"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Table ''{0}'' is not a sequence"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Column ''{0}'' not found in any table; did you mean ''{1}''?"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Column ''{0}'' not found in table ''{1}''; did you mean ''{2}''?"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Expected a character type"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Duplicate column name ''{0}'' in UNPIVOT"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Value count in UNPIVOT ({0,number,#}) must match number of FOR columns ({1,number,#})"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"In UNPIVOT, cannot derive type for measure ''{0}'' because source columns have different data types"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"In UNPIVOT, cannot derive type for axis ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Cannot use PREV/NEXT in MEASURE ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Cannot nest PREV/NEXT under LAST/FIRST ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Cannot use aggregation in navigation ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Multiple pattern variables in ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Function ''{0}'' can only be used in MATCH_RECOGNIZE"
argument_list|)
name|ExInst
argument_list|<
name|SqlValidatorException
...
name|BaseMessage
argument_list|(
literal|"Invalid types for arithmetic: {0} {1} {2}"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Invalid types for comparison: {0} {1} {2}"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Invalid character for cast: {0}"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"More than one value in list: {0}"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal jsonpath spec ''{0}'', format of the spec should be: ''<lax|strict> $'{'expr'}'''"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal jsonpath mode ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal jsonpath mode ''{0}'' in jsonpath spec: ''{1}''"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Strict jsonpath mode requires a non empty returned value, but is null"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal error behavior ''{0}'' specified in JSON_EXISTS function"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal empty behavior ''{0}'' specified in JSON_VALUE function"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal error behavior ''{0}'' specified in JSON_VALUE function"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Strict jsonpath mode requires scalar value, and the actual value is: ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Illegal wrapper behavior ''{0}'' specified in JSON_QUERY function"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Strict jsonpath mode requires array or object value, and the actual value is: ''{0}''"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|BaseMessage
argument_list|(
literal|"Null key of JSON object is not allowed"
argument_list|)
name|ExInst
argument_list|<
name|CalciteException
...
name|CalciteException
argument_list|>
name|invalidInputForJsonStorageSize
parameter_list|(
name|String
name|value
parameter_list|)
