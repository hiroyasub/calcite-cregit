...
name|key
decl_stmt|;
comment|//The following paragraph of logic is mainly used to obtain the parent node path of path and
comment|//the key value that should be inserted when the preant Path is map.
comment|//eg: path is $.a ,parentPath is $
comment|//eg: path is $.a[1] ,parentPath is $.a
name|Integer
name|dotIndex
init|=
name|path
...
name|obj
argument_list|,
literal|"json object must not be null"
argument_list|)
return|;
block|}
annotation|@
...
name|NONE
block|}
comment|/**    * Used in the JsonModify function.    */
specifier|public
enum|enum
name|JsonModifyMode
block|{
