...
begin_comment
comment|/**  * Helper methods to implement SQL functions in generated code.  *  *<p>Not present: and, or, not (builtin operators are better, because they  * use lazy evaluation. Implementations do not check for null values; the  * calling code must do that.  *  *<p>Many of the functions do not check for null values. This is intentional.  * If null arguments are possible, the code-generation framework checks for  * nulls before calling the functions.  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/** A byte string consisting of a single byte that is the ASCII space    * character (0x20). */
specifier|private
specifier|static
specifier|final
name|ByteString
name|SINGLE_SPACE_BYTE_STRING
init|=
name|ByteString
operator|.
name|of
...
argument_list|)
decl_stmt|;
comment|// Date formatter for BigQuery's timestamp literals:
comment|// https://cloud.google.com/bigquery/docs/reference/standard-sql/lexical#timestamp_literals
specifier|private
specifier|static
specifier|final
name|DateTimeFormatter
name|BIG_QUERY_TIMESTAMP_LITERAL_FORMATTER
init|=
operator|new
name|DateTimeFormatterBuilder
argument_list|()
comment|// Unlike ISO 8601, BQ only supports years between 1 - 9999,
comment|// but can support single-digit month and day parts.
operator|.
name|appendValue
argument_list|(
name|ChronoField
...
name|NOT_NEGATIVE
argument_list|)
comment|// Everything after the date is optional. Optional sections can be nested.
operator|.
name|optionalStart
argument_list|()
comment|// BQ accepts either a literal 'T' or a space to separate the date from the time,
comment|// so make the 'T' optional but pad with 1 space if it's omitted.
operator|.
name|padNext
argument_list|(
literal|1
...
name|optionalEnd
argument_list|()
comment|// Unlike ISO 8601, BQ can support single-digit hour, minute, and second parts.
operator|.
name|appendValue
argument_list|(
name|ChronoField
...
name|NOT_NEGATIVE
argument_list|)
comment|// ISO 8601 supports up to nanosecond precision, but BQ only up to microsecond.
operator|.
name|optionalStart
argument_list|()
operator|.
...
argument_list|)
decl_stmt|;
comment|/** Whether the current Java version is 8 (1.8). */
specifier|private
specifier|static
specifier|final
name|boolean
...
block|{
block|}
comment|/** Internal THROW_UNLESS(condition, message) function.    *    *<p>The method is marked {@link NonDeterministic} to prevent the generator    * from storing its value as a constant. */
annotation|@
name|NonDeterministic
specifier|public
specifier|static
...
return|;
block|}
comment|/** SQL {@code LPAD(string, integer, string)} function. */
specifier|public
specifier|static
name|String
name|lpad
...
return|;
block|}
comment|/** SQL {@code LPAD(string, integer)} function. */
specifier|public
specifier|static
name|String
name|lpad
...
return|;
block|}
comment|/** SQL {@code LPAD(binary, integer, binary)} function. */
specifier|public
specifier|static
name|ByteString
name|lpad
...
parameter_list|)
block|{
comment|// 0x20 is the hexadecimal character for space ' '
return|return
name|lpad
argument_list|(
name|originalValue
...
return|;
block|}
comment|/** SQL {@code RPAD(string, integer, string)} function. */
specifier|public
specifier|static
name|String
name|rpad
...
return|;
block|}
comment|/** SQL {@code RPAD(string, integer)} function. */
specifier|public
specifier|static
name|String
name|rpad
...
return|;
block|}
comment|/** SQL {@code RPAD(binary, integer, binary)} function. */
specifier|public
specifier|static
name|ByteString
name|rpad
...
return|;
block|}
comment|/** SQL {@code RPAD(binary, integer)} function. */
specifier|public
specifier|static
name|ByteString
name|rpad
...
return|;
block|}
comment|/** SQL {@code ENDS_WITH(string, string)} function. */
specifier|public
specifier|static
name|boolean
name|endsWith
...
return|;
block|}
comment|/** SQL {@code ENDS_WITH(binary, binary)} function. */
specifier|public
specifier|static
name|boolean
name|endsWith
...
return|;
block|}
comment|/** SQL {@code STARTS_WITH(string, string)} function. */
specifier|public
specifier|static
name|boolean
name|startsWith
...
return|;
block|}
comment|/** SQL {@code STARTS_WITH(binary, binary)} function. */
specifier|public
specifier|static
name|boolean
name|startsWith
...
return|;
block|}
comment|/** SQL {@code SPLIT(string, string)} function. */
specifier|public
specifier|static
name|List
argument_list|<
...
block|}
block|}
comment|/** SQL {@code SPLIT(string)} function. */
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/** SQL {@code SPLIT(binary, binary)} function. */
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/** SQL SUBSTRING(binary FROM ...) function for binary. */
specifier|public
specifier|static
name|ByteString
name|substring
...
return|;
block|}
comment|/** SQL SUBSTRING(binary FROM ... FOR ...) function for binary. */
specifier|public
specifier|static
name|ByteString
name|substring
...
return|;
block|}
comment|/** SQL CHAR(integer) function, as in MySQL and Spark.    *    *<p>Returns the ASCII character of {@code n} modulo 256,    * or null if {@code n}&lt; 0. */
specifier|public
specifier|static
annotation|@
name|Nullable
...
return|;
block|}
comment|/** SQL CHR(integer) function, as in Oracle and Postgres.    *    *<p>Returns the UTF-8 character whose code is {@code n}. */
specifier|public
specifier|static
name|String
name|charFromUtf8
...
return|;
block|}
comment|/** SQL OCTET_LENGTH(binary) function. */
specifier|public
specifier|static
name|int
name|octetLength
...
return|;
block|}
comment|/** SQL {@code ILIKE} function. */
specifier|public
specifier|static
name|boolean
name|ilike
...
return|;
block|}
comment|/** SQL {@code ILIKE} function with escape. */
specifier|public
specifier|static
name|boolean
name|ilike
...
return|;
block|}
comment|/** Returns whether {@code b0} is less than {@code b1}    * (or {@code b1} is null). Helper for {@code ARG_MIN}. */
specifier|public
specifier|static
parameter_list|<
name|T
...
return|;
block|}
comment|/** Returns whether {@code b0} is greater than {@code b1}    * (or {@code b1} is null). Helper for {@code ARG_MAX}. */
specifier|public
specifier|static
parameter_list|<
name|T
...
return|;
block|}
comment|/** SQL<code>-</code> operator applied to nullable BigDecimal values. */
specifier|public
specifier|static
annotation|@
name|PolyNull
...
return|;
block|}
comment|/**    * Converts a SQL DATE value from the Java type    * ({@link java.sql.Date}) to the internal representation type    * (number of days since January 1st, 1970 as {@code int})    * in the local time zone.    *    *<p>Since a time zone is not available, the date is converted to represent    * the same date as a Unix date in UTC as the {@link java.sql.Date} value in    * the local time zone.    *    * @see #toInt(java.sql.Date, TimeZone)    * @see #internalToDate(int) converse method    */
specifier|public
specifier|static
name|int
name|toInt
...
return|;
block|}
comment|/**    * Converts a nullable SQL DATE value from the Java type    * ({@link java.sql.Date}) to the internal representation type    * (number of days since January 1st, 1970 as {@link Integer})    * in the local time zone.    *    *<p>Since a time zone is not available, the date is converted to represent    * the same date as a Unix date in UTC as the {@link java.sql.Date} value in    * the local time zone.    *    * @see #toInt(java.sql.Date, TimeZone)    * @see #internalToDate(Integer) converse method    */
specifier|public
specifier|static
annotation|@
name|PolyNull
...
return|;
block|}
comment|/**    * Converts a nullable SQL DATE value from the Java type    * ({@link java.sql.Date}) to the internal representation type    * (number of days since January 1st, 1970 as {@link Integer}).    *    * @see #toInt(java.sql.Date, TimeZone)    */
specifier|public
specifier|static
annotation|@
name|PolyNull
...
return|;
block|}
comment|/**    * Converts a SQL TIME value from the Java type    * ({@link java.sql.Time}) to the internal representation type    * (number of milliseconds since January 1st, 1970 as {@code int})    * in the local time zone.    *    * @see #toIntOptional(java.sql.Time)    * @see #internalToTime(int) converse method    */
specifier|public
specifier|static
name|int
name|toInt
...
return|;
block|}
comment|/**    * Converts a nullable SQL TIME value from the Java type    * ({@link java.sql.Time}) to the internal representation type    * (number of milliseconds since January 1st, 1970 as {@link Integer}).    *    * @see #toInt(java.sql.Time)    * @see #internalToTime(Integer) converse method    */
specifier|public
specifier|static
annotation|@
name|PolyNull
...
return|;
block|}
comment|/**    * Converts a SQL TIMESTAMP value from the Java type    * ({@link java.util.Date}) to the internal representation type    * (number of milliseconds since January 1st, 1970 as {@code long}).    *    *<p>Since a time zone is not available, converts the timestamp to represent    * the same date and time as a Unix timestamp in UTC as the    * {@link java.util.Date} value in the local time zone.    *    *<p>The {@link java.util.Date} class uses the standard Gregorian calendar    * which switches from the Julian calendar to the Gregorian calendar in    * October 1582. For compatibility with ISO-8601, converts the internal    * representation to use the proleptic Gregorian calendar.    */
specifier|public
specifier|static
name|long
name|toLong
...
return|;
block|}
comment|/**    * Converts a SQL TIMESTAMP value from the Java type    * ({@link Timestamp}) to the internal representation type    * (number of milliseconds since January 1st, 1970 as {@code long}).    *    *<p>For backwards compatibility, time zone offsets are calculated in    * relation to the local time zone instead of UTC. Providing the default time    * zone or {@code null} will return the timestamp unmodified.    *    *<p>The {@link Timestamp} class uses the standard Gregorian calendar which    * switches from the Julian calendar to the Gregorian calendar in    * October 1582. For compatibility with ISO-8601, the internal representation    * is converted to use the proleptic Gregorian calendar.    */
specifier|public
specifier|static
name|long
name|toLong
...
name|DateTimeUtils
operator|.
name|sqlTimestampToUnixTimestamp
argument_list|(
name|v
argument_list|,
name|timeZone
...
return|;
block|}
comment|/**    * Converts a nullable SQL TIMESTAMP value from the Java type    * ({@link Timestamp}) to the internal representation type    * (number of milliseconds since January 1st, 1970 as {@link Long})    * in the local time zone.    *    * @see #toLong(Timestamp, TimeZone)    * @see #internalToTimestamp(Long) converse method    */
specifier|public
specifier|static
annotation|@
name|PolyNull
...
return|;
block|}
comment|/**    * Converts a nullable SQL TIMESTAMP value from the Java type    * ({@link Timestamp}) to the internal representation type    * (number of milliseconds since January 1st, 1970 as {@link Long}).    *    * @see #toLong(Timestamp, TimeZone)    */
specifier|public
specifier|static
annotation|@
name|PolyNull
...
return|;
block|}
comment|/**    * Converts a nullable SQL DATE value from the internal representation type    * (number of days since January 1st, 1970) to the Java type    * ({@link java.sql.Date}).    *    * @see #internalToDate(int)    * @see #toIntOptional(java.sql.Date) converse method    */
specifier|public
specifier|static
name|java
operator|.
...
return|;
block|}
comment|/**    * Converts a SQL TIME value from the internal representation type    * (number of milliseconds since January 1st, 1970) to the Java type    * ({@link java.sql.Time}).    *    * @see #internalToTime(Integer)    * @see #toInt(java.sql.Time) converse method    */
specifier|public
specifier|static
name|java
operator|.
...
return|;
block|}
comment|/**    * Converts a nullable SQL TIME value from the internal representation type    * (number of milliseconds since January 1st, 1970) to the Java type    * ({@link java.sql.Time}).    *    * @see #internalToTime(Integer)    * @see #toIntOptional(java.sql.Time) converse method    */
specifier|public
specifier|static
name|java
operator|.
...
return|;
block|}
comment|/**    * Converts a SQL TIMESTAMP value from the internal representation type    * (number of milliseconds since January 1st, 1970) to the Java Type    * ({@link Timestamp})    * in the local time zone.    *    *<p>Since a time zone is not available, the timestamp is converted to    * represent the same timestamp as a {@link Timestamp} in the local time zone    * as the Unix timestamp in UTC.    *    *<p>The Unix timestamp should be the number of milliseconds since    * January 1st, 1970 using the proleptic Gregorian calendar as defined by    * ISO-8601. The returned {@link Timestamp} object will use the standard    * Gregorian calendar which switches from the Julian calendar to the    * Gregorian calendar in October 1582.    *    * @see #internalToTimestamp(Long)    * @see #toLong(Timestamp, TimeZone)    * @see #toLongOptional(Timestamp)    * @see #toLongOptional(Timestamp, TimeZone)    * @see #toLong(Timestamp) converse method    */
specifier|public
specifier|static
name|java
operator|.
...
return|;
block|}
comment|/**    * Converts a nullable SQL TIMESTAMP value from the internal representation    * type (number of milliseconds since January 1st, 1970) to the Java Type    * ({@link Timestamp})    * in the local time zone.    *    * @see #internalToTimestamp(long)    * @see #toLong(Timestamp)    * @see #toLong(Timestamp, TimeZone)    * @see #toLongOptional(Timestamp, TimeZone)    * @see #toLongOptional(Timestamp) converse method    */
specifier|public
specifier|static
name|java
operator|.
...
return|;
block|}
comment|/** SQL {@code DATE(year, month, day)} function. */
specifier|public
specifier|static
name|int
name|date
...
parameter_list|)
block|{
comment|// Calcite represents dates as Unix integers (days since epoch).
return|return
operator|(
name|int
operator|)
...
return|;
block|}
comment|/** SQL {@code DATE(TIMESTAMP)} and    * {@code DATE(TIMESTAMP WITH LOCAL TIME ZONE)} functions. */
specifier|public
specifier|static
name|int
name|date
...
block|{
comment|// Calcite represents dates as Unix integers (days since epoch).
comment|// Unix time ignores leap seconds; every day has the exact same number of
comment|// milliseconds. BigQuery TIMESTAMP and DATETIME values (Calcite TIMESTAMP
comment|// WITH LOCAL TIME ZONE and TIMESTAMP, respectively) are represented
comment|// internally as milliseconds since epoch (or epoch UTC).
return|return
operator|(
name|int
operator|)
...
return|;
block|}
comment|/** SQL {@code DATE(TIMESTAMP WITH LOCAL TIME, timeZone)} function. */
specifier|public
specifier|static
name|int
name|date
...
return|;
block|}
comment|/** SQL {@code DATETIME(<year>,<month>,<day>,<hour>,<minute>,<second>)}    * function. */
specifier|public
specifier|static
name|long
name|datetime
...
parameter_list|)
block|{
comment|// BigQuery's DATETIME function returns a Calcite TIMESTAMP,
comment|// represented internally as milliseconds since epoch UTC.
return|return
name|LocalDateTime
operator|.
name|of
...
return|;
block|}
comment|/** SQL {@code DATETIME(DATE)} function; returns a Calcite TIMESTAMP. */
specifier|public
specifier|static
name|long
name|datetime
...
block|{
comment|// BigQuery's DATETIME function returns a Calcite TIMESTAMP,
comment|// represented internally as milliseconds since epoch.
return|return
name|daysSinceEpoch
operator|*
name|DateTimeUtils
...
return|;
block|}
comment|/** SQL {@code DATETIME(DATE, TIME)} function; returns a Calcite TIMESTAMP. */
specifier|public
specifier|static
name|long
name|datetime
...
return|;
block|}
comment|/** SQL {@code DATETIME(TIMESTAMP WITH LOCAL TIME ZONE)} function;    * returns a Calcite TIMESTAMP. */
specifier|public
specifier|static
name|long
name|datetime
...
parameter_list|)
block|{
comment|// BigQuery TIMESTAMP and DATETIME values (Calcite TIMESTAMP WITH LOCAL TIME
comment|// ZONE and TIMESTAMP, respectively) are represented internally as
comment|// milliseconds since epoch (or epoch UTC).
return|return
name|millisSinceEpoch
return|;
block|}
comment|/** SQL {@code DATETIME(TIMESTAMP, timeZone)} function;    * returns a Calcite TIMESTAMP. */
specifier|public
specifier|static
name|long
name|datetime
...
return|;
block|}
comment|/** SQL {@code TIMESTAMP(<string>)} function. */
specifier|public
specifier|static
name|long
name|timestamp
...
parameter_list|)
block|{
comment|// Calcite represents TIMESTAMP WITH LOCAL TIME ZONE as Unix integers
comment|// (milliseconds since epoch).
return|return
name|parseBigQueryTimestampLiteral
argument_list|(
name|expression
argument_list|)
operator|.
...
return|;
block|}
comment|/** SQL {@code TIMESTAMP(<string>,<timeZone>)} function. */
specifier|public
specifier|static
name|long
name|timestamp
...
parameter_list|)
block|{
comment|// First try to parse with an offset, otherwise parse as a local and assume
comment|// UTC ("no offset").
try|try
block|{
return|return
name|OffsetDateTime
...
condition|)
block|{
comment|// JDK 8 has a bug that prevents matching offsets like "+00" but can
comment|// match "+00:00".
try|try
block|{
name|expression
...
name|ROOT
argument_list|,
literal|"Could not parse BigQuery timestamp literal: %s"
argument_list|,
name|expression
argument_list|)
argument_list|,
...
block|}
block|}
comment|/** SQL {@code TIMESTAMP(<date>)} function. */
specifier|public
specifier|static
name|long
name|timestamp
...
block|{
comment|// Calcite represents TIMESTAMP WITH LOCAL TIME ZONE as Unix integers
comment|// (milliseconds since epoch). Unix time ignores leap seconds; every day
comment|// has the same number of milliseconds.
return|return
operator|(
operator|(
name|long
...
return|;
block|}
comment|/** SQL {@code TIMESTAMP(<date>,<timeZone>)} function. */
specifier|public
specifier|static
name|long
name|timestamp
...
return|;
block|}
comment|/** SQL {@code TIMESTAMP(<timestamp>)} function; returns a TIMESTAMP WITH    * LOCAL TIME ZONE. */
specifier|public
specifier|static
name|long
name|timestamp
...
parameter_list|)
block|{
comment|// BigQuery TIMESTAMP and DATETIME values (Calcite TIMESTAMP WITH LOCAL
comment|// TIME ZONE and TIMESTAMP, respectively) are represented internally as
comment|// milliseconds since epoch UTC and epoch.
return|return
name|millisSinceEpoch
return|;
block|}
comment|/** SQL {@code TIMESTAMP(<timestamp>,<timeZone>)} function; returns a    * TIMESTAMP WITH LOCAL TIME ZONE. */
specifier|public
specifier|static
name|long
name|timestamp
...
return|;
block|}
comment|/** SQL {@code TIME(<hour>,<minute>,<second>)} function. */
specifier|public
specifier|static
name|int
name|time
...
parameter_list|)
block|{
comment|// Calcite represents time as Unix integers (milliseconds since midnight).
return|return
operator|(
name|int
operator|)
...
return|;
block|}
comment|/** SQL {@code TIME(<timestamp>)} and {@code TIME(<timestampLtz>)}    * functions. */
specifier|public
specifier|static
name|int
name|time
...
block|{
comment|// Calcite represents time as Unix integers (milliseconds since midnight).
comment|// Unix time ignores leap seconds; every day has the same number of
...
return|;
block|}
comment|/** SQL {@code TIME(<timestampLtz>,<timeZone>)} function. */
specifier|public
specifier|static
name|int
name|time
...
return|;
block|}
comment|/** Converts a timestamp (milliseconds since epoch)    * to a date (days since epoch). */
specifier|public
specifier|static
name|int
name|timestampToDate
...
return|;
block|}
comment|/** Converts a timestamp (milliseconds since epoch)    * to a time (milliseconds since midnight). */
specifier|public
specifier|static
name|int
...
return|;
block|}
comment|/** SQL {@code DATEADD} function applied to a custom time frame.    *    *<p>Custom time frames are created as part of a {@link TimeFrameSet}.    * This method retrieves the session's time frame set from the    * {@link DataContext.Variable#TIME_FRAME_SET} variable, then looks up the    * time frame by name. */
specifier|public
specifier|static
name|int
name|customDateAdd
...
return|;
block|}
comment|/** SQL {@code TIMESTAMPADD} function applied to a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|long
name|customTimestampAdd
parameter_list|(
name|DataContext
name|root
parameter_list|,
...
return|;
block|}
comment|/** SQL {@code DATEDIFF} function applied to a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|int
name|customDateDiff
...
return|;
block|}
comment|/** SQL {@code TIMESTAMPDIFF} function applied to a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|long
name|customTimestampDiff
parameter_list|(
name|DataContext
name|root
parameter_list|,
...
return|;
block|}
comment|/** SQL {@code FLOOR} function applied to a {@code DATE} value    * and a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|int
name|customDateFloor
parameter_list|(
name|DataContext
name|root
parameter_list|,
...
return|;
block|}
comment|/** SQL {@code CEIL} function applied to a {@code DATE} value    * and a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|int
name|customDateCeil
...
return|;
block|}
comment|/** SQL {@code FLOOR} function applied to a {@code TIMESTAMP} value    * and a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|long
name|customTimestampFloor
parameter_list|(
name|DataContext
name|root
parameter_list|,
...
return|;
block|}
comment|/** SQL {@code CEIL} function applied to a {@code TIMESTAMP} value    * and a custom time frame.    *    *<p>Custom time frames are created and accessed as described in    * {@link #customDateAdd}. */
specifier|public
specifier|static
name|long
name|customTimestampCeil
parameter_list|(
name|DataContext
name|root
parameter_list|,
...
return|;
block|}
comment|/**    * Returns whether there is an element in {@code list} for which {@code predicate} is true.    * Also, if {@code predicate} returns null for any element of {@code list}    * and does not return {@code true} for any element of {@code list},    * the result will be {@code null}, not {@code false}.    */
specifier|public
specifier|static
annotation|@
name|Nullable
...
return|;
block|}
comment|/**    * Returns whether {@code predicate} is true for all elements of {@code list}.    * Also, if {@code predicate} returns null for any element of {@code list}    * and does not return {@code false} for any element,    * the result will be {@code null}, not {@code true}.    */
specifier|public
specifier|static
annotation|@
name|Nullable
...
name|IllegalStateException
argument_list|(
literal|"Field name cannot be null for struct field access"
argument_list|)
throw|;
block|}
name|Field
