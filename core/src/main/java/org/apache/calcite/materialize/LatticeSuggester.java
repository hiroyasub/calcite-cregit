...
return|;
block|}
comment|/** Converts a column reference to an expression. */
specifier|public
name|RexNode
name|toRex
parameter_list|(
...
parameter_list|()
lambda|->
literal|"space.tableExpressions.get(table) is null for "
operator|+
name|table
argument_list|)
operator|.
...
name|ColRef
block|{   }
comment|/** Column reference that is within a single table. */
specifier|private
interface|interface
name|SingleTableColRef
block|{
...
block|}
block|}
comment|/** Variant of {@link DerivedColRef} where all referenced expressions are in    * the same table. */
specifier|private
specifier|static
class|class
name|SingleTableDerivedColRef
