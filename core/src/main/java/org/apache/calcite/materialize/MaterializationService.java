...
return|;
block|}
comment|/**    * TableFactory Interface defines functions required by    * MaterializationService to create tables that represent    * a materialized view.    */
specifier|public
interface|interface
name|TableFactory
block|{
...
function_decl|;
block|}
comment|/**    * Default implementation of TableFactory.    * Creates a table using CloneSchema.    */
specifier|public
specifier|static
class|class
name|DefaultTableFactory
