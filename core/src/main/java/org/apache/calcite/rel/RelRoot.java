...
return|;
block|}
comment|/** Creates a copy, assigning the query hints. */
specifier|public
name|RelRoot
name|withHints
parameter_list|(
...
return|;
block|}
comment|/** Returns the root relational expression as a {@link LogicalProject}.    *    * @param force Create a Project even if all fields are used */
specifier|public
name|RelNode
name|project
parameter_list|(
