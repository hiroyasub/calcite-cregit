...
block|{
comment|/** @deprecated Use {@link CoreRules#JOIN_LEFT_UNION_TRANSPOSE}. */
annotation|@
name|Deprecated
...
decl_stmt|;
comment|/** @deprecated Use {@link CoreRules#JOIN_RIGHT_UNION_TRANSPOSE}. */
annotation|@
name|Deprecated
comment|// to be removed before 1.25
specifier|public
...
decl_stmt|;
comment|/**    * Creates a JoinUnionTransposeRule.    *    * @param operand           root operand, must not be null    * @param description       Description, or null to guess description    * @param relBuilderFactory Builder for relational expressions    */
specifier|public
name|JoinUnionTransposeRule
parameter_list|(
name|RelOptRuleOperand
