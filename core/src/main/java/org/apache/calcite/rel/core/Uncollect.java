...
begin_comment
comment|/**  * Relational expression that unnests its input's sole column into a  * relation.  *  *<p>Like its inverse operation {@link Collect}, Uncollect is generally  * invoked in a nested loop, driven by {@link Correlator} or similar.  */
end_comment
...
comment|/**    * Creates an Uncollect.    *    *<p>The row type of the child relational expression must contain precisely    * one column, that column must be a multiset of records.    *    * @param cluster Cluster the relational expression belongs to    * @param traitSet Traits    * @param child   Child relational expression    */
specifier|public
name|Uncollect
parameter_list|(
name|RelOptCluster
