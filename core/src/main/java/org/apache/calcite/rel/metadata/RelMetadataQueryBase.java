...
block|{
return|return
name|getMetadataHandlerProvider
argument_list|()
operator|.
name|revise
argument_list|(
...
name|metadataHandlerProvider
argument_list|,
literal|"metadataHandlerProvider"
argument_list|)
expr_stmt|;
return|return
name|castNonNull
