...
name|fieldNameMap
decl_stmt|;
comment|/** Minimum number of fields where it is worth populating {@link #fieldNameMap}    * to accelerate lookups by field name. */
specifier|private
specifier|static
specifier|final
name|int
...
condition|)
block|{
comment|// the first dynamic star field is cached with a special name
name|map
operator|.
name|putIfAbsent
argument_list|(
