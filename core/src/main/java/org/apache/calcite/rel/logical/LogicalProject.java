...
block|}
comment|//~ Methods ----------------------------------------------------------------
comment|/**    * Creates a LogicalProject.    * @deprecated Use {@link #create(RelNode, List, List, List, Set)} instead    */
annotation|@
name|Deprecated
comment|// to be removed before 2.0
specifier|public
...
return|;
block|}
comment|/**    * Creates a LogicalProject, specifying row type rather than field names.    * @deprecated Use {@link #create(RelNode, List, List, RelDataType, Set)} instead    */
annotation|@
name|Deprecated
comment|// to be removed before 2.0
specifier|public
