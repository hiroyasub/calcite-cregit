...
comment|//
comment|// NOTE: SemiJoin is deprecated and wil be removed before 1.21; when you
comment|// remove the following lines, also remove the 'SuppressWarnings'
comment|// directive at the top of this method.
if|if
condition|(
name|rel
operator|instanceof
