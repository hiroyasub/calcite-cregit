...
return|;
block|}
comment|/**    * Wrap the {@code sqlNodeNull} in a CAST operator with target type as {@code field}.    * @param sqlNodeNull NULL literal    * @param field field description of {@code sqlNodeNull}    * @return null literal wrapped in CAST call.    */
specifier|private
name|SqlNode
name|castNullType
parameter_list|(
...
return|;
block|}
comment|/**    * Gets the {@link org.apache.calcite.rel.rel2sql.SqlImplementor.Builder} for    * the given {@link Aggregate} node.    *    * @param e Aggregate node    * @param inputResult Result from the input    * @param inputIsProject Whether the input is a Project    * @return A SQL builder    */
specifier|protected
name|Builder
