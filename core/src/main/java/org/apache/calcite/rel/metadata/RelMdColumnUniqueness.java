...
name|columns
operator|=
name|decorateWithConstantColumnsFromPredicates
argument_list|(
name|columns
argument_list|,
name|rel
...
return|;
block|}
comment|/**    * Deduce constant columns from predicates of rel and return the union    * bitsets of checkingColumns and the constant columns.    */
specifier|private
specifier|static
name|ImmutableBitSet
name|decorateWithConstantColumnsFromPredicates
...
block|}
block|}
comment|// If no constant columns deduced, return the original "checkingColumns".
return|return
name|checkingColumns
return|;
block|}
