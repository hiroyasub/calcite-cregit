...
expr_stmt|;
block|}
comment|/**    * Creates an AggregateCall.    *    * @param aggFunction Aggregate function    * @param distinct    Whether distinct    * @param approximate Whether approximate    * @param argList     List of ordinals of arguments    * @param filterArg   Ordinal of filter argument, or -1    * @param type        Result type    * @param name        Name (may be null)    */
specifier|private
name|AggregateCall
parameter_list|(
name|SqlAggFunction
