...
argument_list|)
decl_stmt|;
comment|/**    * Rule that reduces constants inside a {@link org.apache.calcite.rel.core.Filter}.    * If the condition is a constant, the filter is removed (if TRUE) or replaced with    * an empty {@link org.apache.calcite.rel.core.Values} (if FALSE or NULL).    *    * @see CoreRules#FILTER_REDUCE_EXPRESSIONS    */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/** Rule that reduces constants inside a    * {@link org.apache.calcite.rel.core.Project}.    *    * @see CoreRules#PROJECT_REDUCE_EXPRESSIONS */
specifier|public
specifier|static
class|class
...
argument_list|)
operator|:
literal|"Reduced expressions should be different from original expressions"
assert|;
name|call
operator|.
name|transformTo
...
block|}
block|}
comment|/** Rule that reduces constants inside a {@link Join}.    *    * @see CoreRules#JOIN_REDUCE_EXPRESSIONS */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/**    * Rule that reduces constants inside a {@link Calc}.    *    * @see CoreRules#CALC_REDUCE_EXPRESSIONS    */
specifier|public
specifier|static
class|class
...
block|}
block|}
comment|/**      * For static schema systems, a filter that is always false or null can be      * replaced by a values operator that produces no rows, as the schema      * information can just be taken from the input Rel. In dynamic schema      * environments, the filter might have an unknown input type, in these cases      * they must define a system specific alternative to a Values operator, such      * as inserting a limit 0 instead of a filter on top of the original input.      *      *<p>The default implementation of this method is to call      * {@link RelBuilder#empty}, which for the static schema will be optimized      * to an Immutable.Config.of()      * {@link org.apache.calcite.rel.core.Values}.      *      * @param input rel to replace, assumes caller has already determined      *              equivalence to Values operation for 0 records or a      *              false filter.      * @return equivalent but less expensive replacement rel      */
specifier|protected
name|RelNode
name|createEmptyRelOrEquivalent
parameter_list|(
...
block|}
block|}
comment|/** Rule that reduces constants inside a {@link Window}.    *    * @see CoreRules#WINDOW_REDUCE_EXPRESSIONS */
specifier|public
specifier|static
class|class
...
comment|/** Creates a ReduceExpressionsRule. */
specifier|protected
name|ReduceExpressionsRule
parameter_list|(
name|C
...
return|;
block|}
comment|/** Sets {@link #matchNullability()}. */
name|Config
name|withMatchNullability
parameter_list|(
name|boolean
