...
return|;
block|}
comment|/** Return if a given operator can be pushed into Case */
specifier|private
specifier|static
name|boolean
name|isPushableIntoCase
parameter_list|(
name|RexNode
name|node
parameter_list|)
...
argument_list|)
expr_stmt|;
comment|// For nested Case-When, the function should be pushed further deeper
comment|// For example,
comment|// Convert
comment|//   f(CASE WHEN p1 THEN (CASE WHEN p2 THEN v2 ... END) ... END, arg)
comment|// to
comment|//   CASE WHEN p1 THEN f((CASE WHEN p2 THEN v2 ... END), arg) ... END
comment|// further to
comment|//   CASE WHEN p1 THEN (CASE WHEN p2 THEN f(v2, arg) ... END) ... END
if|if
condition|(
name|isPushableIntoCase
argument_list|(
