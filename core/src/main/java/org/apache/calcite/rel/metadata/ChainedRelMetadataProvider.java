...
begin_comment
comment|/**  * Implementation of the {@link RelMetadataProvider}  * interface via the  * {@link org.eigenbase.util.Glossary#CHAIN_OF_RESPONSIBILITY_PATTERN}.  *  *<p>When a consumer calls the {@link #apply} method to ask for a provider  * for a particular type of {@link RelNode} and {@link Metadata}, scans the list  * of underlying providers.</p>  */
end_comment
