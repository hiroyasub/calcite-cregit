...
return|;
block|}
comment|/** Converts a JSON string (such as that produced by    * {@link RelJson#toJson(Object)}) into a Calcite type. */
specifier|public
specifier|static
name|RelDataType
name|readType
...
parameter_list|()
lambda|->
literal|"relJson.toAggregation output for "
operator|+
name|aggMap
argument_list|)
decl_stmt|;
