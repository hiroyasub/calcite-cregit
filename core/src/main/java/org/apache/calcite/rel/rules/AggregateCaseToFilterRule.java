...
begin_comment
comment|/**  * Rule that converts CASE-style filtered aggregates into true filtered  * aggregates.  *  *<p>For example,  *  *<blockquote>  *<code>SELECT SUM(CASE WHEN gender = 'F' THEN salary END)<br>  *   FROM Emp</code>  *</blockquote>  *  *<p>becomes  *  *<blockquote>  *<code>SELECT SUM(salary) FILTER (WHERE gender = 'F')<br>  *   FROM Emp</code>  *</blockquote>  */
end_comment
...
argument_list|)
decl_stmt|;
comment|// Possibly CAST the new aggregator to an appropriate type.
specifier|final
name|int
name|i
init|=
...
begin_comment
comment|// End AggregateCaseToFilterRule.java
end_comment
