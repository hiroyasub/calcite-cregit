...
begin_comment
comment|/**  * Planner rule that pushes a {@link org.apache.calcite.rel.core.Filter}  * past a {@link org.apache.calcite.rel.core.Aggregate}.  *  * @see org.apache.calcite.rel.rules.AggregateFilterTransposeRule  * @see CoreRules#FILTER_AGGREGATE_TRANSPOSE  */
end_comment
...
block|{
comment|/** Creates a FilterAggregateTransposeRule. */
specifier|protected
name|FilterAggregateTransposeRule
parameter_list|(
name|Config
...
name|DEFAULT
init|=
name|ImmutableFilterAggregateTransposeRule
operator|.
name|Config
operator|.
name|of
