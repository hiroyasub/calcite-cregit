...
comment|/**    * Creates a LogicalCorrelate.    * @param cluster      cluster this relational expression belongs to    * @param left         left input relational expression    * @param right        right input relational expression    * @param correlationId variable name for the row of left input    * @param requiredColumns    * @param joinType     join type    */
specifier|public
name|LogicalCorrelate
parameter_list|(
name|RelOptCluster
