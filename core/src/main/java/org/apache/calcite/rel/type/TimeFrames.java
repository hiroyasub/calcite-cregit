...
block|{
block|}
comment|/** The names of the frames that are WEEK starting on each week day.    * Entry 0 is "WEEK_SUNDAY" and entry 6 is "WEEK_SATURDAY". */
specifier|public
specifier|static
specifier|final
name|List
...
expr_stmt|;
comment|// a monday
comment|// Add "WEEK(SUNDAY)" through "WEEK(SATURDAY)"
name|Ord
operator|.
name|forEach
argument_list|(
