...
name|Window
block|{
comment|/**    * Creates a LogicalWindow.    *    *<p>Use {@link #create} unless you know what you're doing.    *    * @param cluster Cluster    * @param traitSet Trait set    * @param hints   Hints for this node    * @param input   Input relational expression    * @param constants List of constants that are additional inputs    * @param rowType Output row type    * @param groups Window groups    */
specifier|public
name|LogicalWindow
parameter_list|(
name|RelOptCluster
