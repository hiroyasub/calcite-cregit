...
lambda|->
block|{
comment|// Do not push down over's expression by default
if|if
condition|(
name|expr
operator|instanceof
...
condition|)
block|{
comment|// Do not push down not nullable cast's expression with the same type by default
comment|// eg: CAST($1):VARCHAR(10) NOT NULL, and type of $1 is nullable VARCHAR(10)
return|return
literal|false
return|;
block|}
