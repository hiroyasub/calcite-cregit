...
return|;
block|}
comment|/**    * Rewrites a sub-query into a    * {@link org.apache.calcite.rel.core.Collect}.    *    * @param e            Sub-query to rewrite    * @param variablesSet A set of variables used by a relational    *                     expression of the specified RexSubQuery    * @param builder      Builder    * @param offset       Offset to shift {@link RexInputRef}    * @return Expression that may be used to replace the RexSubQuery    */
specifier|private
specifier|static
name|RexNode
name|rewriteCollection
...
parameter_list|)
block|{
comment|// If the sub-query is guaranteed to produce at least one row, just return
comment|// TRUE.
specifier|final
name|RelMetadataQuery
name|mq
