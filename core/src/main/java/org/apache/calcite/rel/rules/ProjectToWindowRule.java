...
expr_stmt|;
block|}
comment|/**    * Instance of the rule that applies to a    * {@link org.apache.calcite.rel.core.Calc} that contains    * windowed aggregates and converts it into a mixture of    * {@link org.apache.calcite.rel.logical.LogicalWindow} and {@code Calc}.    *    * @see CoreRules#CALC_TO_WINDOW    */
specifier|public
specifier|static
class|class
...
name|ProjectToWindowRule
block|{
comment|/** Creates a CalcToWindowRule. */
specifier|protected
name|CalcToWindowRule
parameter_list|(
name|Config
...
name|typeImmutable
operator|=
literal|"ImmutableCalcToWindowRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|DEFAULT
init|=
name|ImmutableCalcToWindowRuleConfig
operator|.
name|of
argument_list|()
operator|.
...
block|}
block|}
comment|/**    * Instance of the rule that can be applied to a    * {@link org.apache.calcite.rel.core.Project} and that produces, in turn,    * a mixture of {@code LogicalProject}    * and {@link org.apache.calcite.rel.logical.LogicalWindow}.    *    * @see CoreRules#PROJECT_TO_LOGICAL_PROJECT_AND_WINDOW    */
specifier|public
specifier|static
class|class
...
name|ProjectToWindowRule
block|{
comment|/** Creates a ProjectToLogicalProjectAndWindowRule. */
specifier|protected
name|ProjectToLogicalProjectAndWindowRule
parameter_list|(
name|Config
...
name|typeImmutable
operator|=
literal|"ImmutableProjectToWindowRule"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|DEFAULT
init|=
name|ImmutableProjectToWindowRule
operator|.
name|of
argument_list|()
operator|.
