...
begin_comment
comment|/**  * Planner rule that pushes a {@link Project} under {@link Correlate} to apply  * on Correlate's left and right inputs.  *  * @see CoreRules#PROJECT_CORRELATE_TRANSPOSE  */
end_comment
...
block|{
comment|/** Creates a ProjectCorrelateTransposeRule. */
specifier|protected
name|ProjectCorrelateTransposeRule
parameter_list|(
name|Config
...
name|DEFAULT
init|=
name|ImmutableProjectCorrelateTransposeRule
operator|.
name|Config
operator|.
name|builder
