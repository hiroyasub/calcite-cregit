...
return|;
block|}
comment|/**    * Do a shallow clone of oldAggRel and update aggCalls. Could be refactored    * into Aggregate and subclasses - but it's only needed for some    * subclasses.    *    * @param oldAggregate LogicalAggregate to clone.    * @param input  Input relational expression    * @param newCalls  New list of AggregateCalls    * @return shallow clone with new list of AggregateCalls.    */
specifier|protected
name|Aggregate
name|newAggregateRel
parameter_list|(
