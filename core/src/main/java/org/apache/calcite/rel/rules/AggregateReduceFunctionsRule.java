...
argument_list|(
literal|"AggregateReduceFunctionsRule doesn't "
operator|+
...
name|class
argument_list|)
comment|// reduce all functions handled by this rule
operator|.
...
name|aggregateClass
argument_list|)
comment|// reduce specific functions provided by the client
operator|.
name|withFunctionsToReduce
argument_list|(
name|Objects
...
return|;
block|}
comment|/** Returns whether this rule can reduce a given aggregate function call. */
specifier|public
name|boolean
name|canReduce
parameter_list|(
...
return|;
block|}
comment|/** Returns whether this rule can reduce some agg-call,    * which its arg exists in the aggregate's group. */
specifier|public
name|boolean
name|canReduceAggCallByGrouping
parameter_list|(
name|Aggregate
name|oldAggRel
parameter_list|,
...
condition|)
block|{
comment|// arg doesn't exist in aggregate's group.
return|return
literal|false
return|;
block|}
...
condition|)
block|{
comment|// replace original MAX/MIN/AVG/ANY_VALUE/FIRST_VALUE/LAST_VALUE(x) with
comment|// target field of x, when x exists in group
specifier|final
name|RexNode
name|reducedNode
init|=
name|reduceAggCallByGrouping
argument_list|(
name|oldAggRel
argument_list|,
name|oldCall
...
name|DEFAULT
init|=
name|ImmutableAggregateReduceFunctionsRule
operator|.
name|Config
operator|.
name|of
...
name|SqlKind
argument_list|>
name|DEFAULT_FUNCTIONS_TO_REDUCE
init|=
name|ImmutableSet
operator|.
expr|<
