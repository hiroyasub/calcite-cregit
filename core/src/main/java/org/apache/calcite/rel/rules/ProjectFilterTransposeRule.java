...
block|{
comment|/** @deprecated Use {@link CoreRules#PROJECT_FILTER_TRANSPOSE}. */
annotation|@
name|Deprecated
...
decl_stmt|;
comment|/** @deprecated Use    * {@link CoreRules#PROJECT_FILTER_TRANSPOSE_WHOLE_EXPRESSIONS}. */
annotation|@
name|Deprecated
comment|// to be removed before 1.25
specifier|public
...
decl_stmt|;
comment|/** @deprecated Use    * {@link CoreRules#PROJECT_FILTER_TRANSPOSE_WHOLE_PROJECT_EXPRESSIONS}. */
annotation|@
name|Deprecated
comment|// to be removed before 1.25
specifier|public
...
comment|/**    * Creates a ProjectFilterTransposeRule.    *    * @param preserveExprCondition Condition for expressions that should be    *                              preserved in the projection    * @param wholeProject Whether to push whole expressions from the project;    *                   if false, only pushes references    * @param wholeFilter Whether to push whole expressions;    *                   if false, only pushes references    */
specifier|public
name|ProjectFilterTransposeRule
parameter_list|(
name|Class
