...
argument_list|)
decl_stmt|;
comment|/** Instance that pushes down project and filter expressions whole, not field    * references. */
specifier|public
specifier|static
specifier|final
name|ProjectFilterTransposeRule
...
argument_list|)
decl_stmt|;
comment|/** Instance that pushes down project expressions whole, but pushes down    * field references for filters. */
specifier|public
specifier|static
specifier|final
name|ProjectFilterTransposeRule
