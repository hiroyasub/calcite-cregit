...
argument_list|)
expr_stmt|;
comment|// bail out if there is no EXTRACT of YEAR, or call to FLOOR or CEIL
return|return
name|finder
operator|.
name|timeUnits
...
return|;
block|}
comment|/** Rule that converts EXTRACT, FLOOR and CEIL in a {@link Filter} into a date    * range. */
annotation|@
