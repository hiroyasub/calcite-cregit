...
begin_comment
comment|/**  * Planner rule that pushes an  * {@link org.apache.calcite.rel.core.Aggregate}  * past a {@link org.apache.calcite.rel.core.Join}.  *  * @see CoreRules#AGGREGATE_JOIN_TRANSPOSE  * @see CoreRules#AGGREGATE_JOIN_TRANSPOSE_EXTENDED  */
end_comment
...
argument_list|)
decl_stmt|;
comment|/** Extended instance that can push down aggregate functions. */
name|Config
name|EXTENDED
init|=
name|ImmutableAggregateJoinTransposeRule
...
parameter_list|)
function_decl|;
comment|/** Defines an operand tree for the given classes, and also sets      * {@link #isAllowFunctions()}. */
specifier|default
name|Config
name|withOperandFor
parameter_list|(
