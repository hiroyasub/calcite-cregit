...
return|;
block|}
comment|/** Returns a map from field names to fields.    *    *<p>Matching is case-sensitive.    *    *<p>If several fields have the same name, the map contains the first.    *    *<p>A {@link RelDataTypeField#isDynamicStar() dynamic star field} is indexed    * under its own name and "" (the empty string).    *    *<p>If the map is null, the type must do lookup the long way.    */
specifier|protected
annotation|@
name|Nullable
name|Map
