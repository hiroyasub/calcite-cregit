...
argument_list|()
decl_stmt|;
comment|/** @deprecated Use {@link CoreRules#FILTER_VALUES_MERGE}. */
annotation|@
name|Deprecated
...
decl_stmt|;
comment|/** @deprecated Use {@link CoreRules#PROJECT_VALUES_MERGE}. */
annotation|@
name|Deprecated
comment|// to be removed before 1.25
specifier|public
...
decl_stmt|;
comment|/** @deprecated Use {@link CoreRules#PROJECT_FILTER_VALUES_MERGE}. */
annotation|@
name|Deprecated
comment|// to be removed before 1.25
specifier|public
