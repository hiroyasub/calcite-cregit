...
argument_list|)
block|,
comment|/**      * The hint would be propagated to the Filter nodes.      */
name|FILTER
argument_list|(
name|Filter
operator|.
...
argument_list|)
block|,
comment|/**      * The hint would be propagated to the SetOp(Union, Intersect, Minus) nodes.      */
name|SETOP
argument_list|(
name|SetOp
operator|.
...
argument_list|)
block|,
comment|/**      * The hint would be propagated to the Sort nodes.      */
name|SORT
argument_list|(
name|Sort
operator|.
...
argument_list|)
block|,
comment|/**      * The hint would be propagated to the Values nodes.      */
name|VALUES
argument_list|(
name|Values
operator|.
...
argument_list|)
block|,
comment|/**      * The hint would be propagated to the Window nodes.      */
name|WINDOW
argument_list|(
name|Window
operator|.
