...
return|;
block|}
comment|/**    * Infers predicates for a correlate node.    */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
...
argument_list|)
decl_stmt|;
comment|// Simplify condition using RexSimplify.
specifier|final
name|RexNode
name|condition
init|=
...
parameter_list|()
lambda|->
literal|"exprFields.get(predicate) is null for "
operator|+
name|predicate
argument_list|)
decl_stmt|;
...
parameter_list|()
lambda|->
literal|"equivalence.get(p1) for "
operator|+
name|p1
argument_list|)
decl_stmt|;
...
parameter_list|()
lambda|->
literal|"equivalence.get(p2) for "
operator|+
name|p2
argument_list|)
expr_stmt|;
