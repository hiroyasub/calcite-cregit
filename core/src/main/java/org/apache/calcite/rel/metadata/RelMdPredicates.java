...
return|;
block|}
comment|/**    * Add the Filter condition to the pulledPredicates list from the child.    */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
...
return|;
block|}
comment|/** Infers predicates for a {@link org.apache.calcite.rel.core.SemiJoin}. */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
...
return|;
block|}
comment|/**    * Infers predicates for an Aggregate.    *    *<p>Pulls up predicates that only contains references to columns in the    * GroupSet. For e.g.    *    *<pre>    * childPullUpExprs : { a&gt; 7, b + c&lt; 10, a + e = 9}    * groupSet         : { a, b}    * pulledUpExprs    : { a&gt; 7}    *</pre>    */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
...
return|;
block|}
comment|/**    * Infers predicates for a Union.    *    *<p>The pulled up expression is a disjunction of its children's predicates.    */
specifier|public
name|RelOptPredicateList
name|getPredicates
parameter_list|(
