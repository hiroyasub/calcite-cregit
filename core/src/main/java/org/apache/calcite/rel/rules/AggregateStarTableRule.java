...
block|{
comment|/** @deprecated Use {@link CoreRules#AGGREGATE_STAR_TABLE}. */
annotation|@
name|Deprecated
...
decl_stmt|;
comment|/** @deprecated This field is prone to issues during class-loading;    * use {@link CoreRules#AGGREGATE_PROJECT_STAR_TABLE} instead. */
annotation|@
name|Deprecated
comment|// to be removed before 1.25
specifier|public
...
decl_stmt|;
comment|/**    * Creates an AggregateStarTableRule.    *    * @param operand           root operand, must not be null    * @param description       Description, or null to guess description    * @param relBuilderFactory Builder for relational expressions    */
specifier|public
name|AggregateStarTableRule
parameter_list|(
name|RelOptRuleOperand
