...
return|;
block|}
comment|/**    * Creates a Collect.    *    * @param input          Input relational expression    * @param sqlKind        SqlKind    * @param fieldName      Name of the sole output field    */
specifier|public
specifier|static
name|Collect
name|create
