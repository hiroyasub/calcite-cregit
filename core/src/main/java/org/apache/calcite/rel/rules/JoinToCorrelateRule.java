...
name|RelOptRule
block|{
comment|/**    * Function to extract the {@link org.apache.calcite.sql.SemiJoinType} parameter    * for the creation of the {@link org.apache.calcite.rel.logical.LogicalCorrelate}    */
specifier|private
specifier|final
name|Function
argument_list|<
...
annotation|@
name|Deprecated
comment|// to be removed (should use JOIN instead), kept for backwards compatibility
specifier|public
specifier|static
specifier|final
name|JoinToCorrelateRule
