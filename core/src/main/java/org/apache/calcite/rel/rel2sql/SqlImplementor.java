...
return|;
block|}
comment|/** Visits {@code e}, the {@code i}th input of the current relational    * expression.    *    * @param i Ordinal of input within its consumer    * @param e Relational expression    * @param anon Whether to remove trivial aliases such as "EXPR$0"    * @return Result    *    * @see #isAnon()    */
specifier|public
specifier|abstract
name|Result
name|visitChild
...
expr_stmt|;
block|}
comment|/** As {@link #builder(RelNode, boolean, Clause...)}, but with      * {@code ignoreClauses} false. */
specifier|public
name|Builder
name|builder
parameter_list|(
