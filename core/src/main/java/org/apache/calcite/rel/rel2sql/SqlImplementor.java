...
return|;
block|}
comment|/**    * Converts a {@link RexNode} condition into a {@link SqlNode}.    *    * @param node            condition Node    * @param leftContext     LeftContext    * @param rightContext    RightContext    * @param leftFieldCount  Number of field on left result    * @return SqlJoin which represent the condition    */
specifier|public
specifier|static
name|SqlNode
