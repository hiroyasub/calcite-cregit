...
argument_list|)
block|,
comment|/** Set of built-in and custom time frames for use in functions such as      * {@code FLOOR} and {@code EXTRACT}. Required; defaults to      * {@link org.apache.calcite.rel.type.TimeFrames#CORE}. */
name|TIME_FRAME_SET
argument_list|(
literal|"timeFrameSet"
argument_list|,
name|TimeFrameSet
operator|.
name|class
