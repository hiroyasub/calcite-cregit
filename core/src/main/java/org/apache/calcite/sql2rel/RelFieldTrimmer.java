...
expr_stmt|;
block|}
comment|/**    * Creates a RelFieldTrimmer.    *    * @param validator Validator    * @param projectFactory Project factory    * @param filterFactory Filter factory    * @param joinFactory Join factory    * @param semiJoinFactory SemiJoin factory    * @param sortFactory Sort factory    * @param aggregateFactory Aggregate factory    * @param setOpFactory SetOp factory    * @param useNamesInIdentityProjCalc    *            Include field names in identity project determination    *    * @deprecated Remove before    * {@link org.apache.calcite.util.Bug#upgrade Calcite-1.1}. */
specifier|public
name|RelFieldTrimmer
parameter_list|(
name|SqlValidator
