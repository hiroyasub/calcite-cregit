...
return|;
block|}
comment|/**    * Maps the ordinal of a field pre-flattening to the ordinal of the    * corresponding field post-flattening, and also returns its type.    *    * @param oldOrdinal Pre-flattening ordinal    * @param existingOffset offset already calculated the target column inside the oldOrdinal column.    *                       For unnested column, it should be 0.    * @return Post-flattening ordinal and type    */
specifier|private
name|Ord
argument_list|<
name|RelDataType
