...
return|;
block|}
comment|/** Decorrelates a query.    *    *<p>This is the main entry point to {@code RelDecorrelator}.    *    * @param rootRel           Root node of the query    * @param relBuilder        Builder for relational expressions    *    * @return Equivalent query with all    * {@link org.apache.calcite.rel.logical.LogicalCorrelate} instances removed    */
specifier|public
specifier|static
name|RelNode
name|decorrelateQuery
...
return|;
block|}
comment|/**    * Rewrite LogicalSnapshot.    *    * @param rel the snapshot rel to rewrite    */
specifier|public
name|Frame
name|decorrelateRel
parameter_list|(
