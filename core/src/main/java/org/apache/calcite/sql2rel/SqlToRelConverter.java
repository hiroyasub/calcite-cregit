...
name|viewExpander
decl_stmt|;
comment|/** Whether to expand sub-queries. If false, each sub-query becomes a    * {@link org.apache.calcite.rex.RexSubQuery}. */
specifier|private
name|boolean
name|expand
init|=
...
parameter_list|()
block|{
comment|// To work around [CALCITE-842] "Decorrelator gets field offsets confused if
comment|// fields have been trimmed", if expansion is disabled, trim fields after
comment|// expansion and decorrelation.
return|return
name|trimUnusedFields
operator|&&
name|expand
