...
name|WITH_ITEM
case|:
comment|/*       final SqlWithItem withItem = (SqlWithItem) from; // TODO: revert?       final List<String> fieldNames2 =           ImmutableList.copyOf(SqlIdentifier.simpleNames(withItem.columnList));       convertFrom(bb, withItem.query, fieldNames2); */
name|convertFrom
argument_list|(
name|bb
argument_list|,
