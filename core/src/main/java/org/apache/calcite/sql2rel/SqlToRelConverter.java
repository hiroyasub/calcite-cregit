...
block|{
comment|// REVIEW danny 2020-04-26: should we unify the normal field aliases and the item aliases ?
name|uncollect
operator|=
name|relBuilder
operator|.
...
argument_list|)
decl_stmt|;
comment|// RexLiteral for each GROUP_ID, note the type should be BIGINT
specifier|final
name|RelDataType
name|groupIdType
init|=
...
expr_stmt|;
block|}
comment|// Skip to create Union when there is only one child, i.e., no duplicate group set.
if|if
condition|(
name|projects
operator|.
...
name|Config
argument_list|>
name|relBuilderConfigTransform
init|=
name|c
lambda|->
name|c
...
return|;
block|}
comment|/** Whether to push down join conditions; default true. */
specifier|public
name|ConfigBuilder
name|withPushJoinCondition
parameter_list|(
