...
block|}
block|}
comment|/** Implements {@link Compatible#navigableSet}. */
specifier|static
parameter_list|<
name|E
parameter_list|>
...
condition|)
block|{
comment|// In Guava 12 and later, ImmutableSortedSet implements NavigableSet.
...
block|{
comment|// In Guava 11, we have to make a copy.
return|return
operator|new
name|TreeSet
argument_list|<
...
block|}
block|}
comment|/** Implements {@link Compatible#navigableMap}. */
specifier|static
parameter_list|<
name|K
parameter_list|,
...
condition|)
block|{
comment|// In Guava 12 and later, ImmutableSortedMap implements NavigableMap.
comment|//noinspection unchecked
return|return
operator|(
name|NavigableMap
