...
return|;
block|}
comment|/**    * Applies a mapping to a collection of {@code ImmutableBitSet}s.    *    * @param mapping Mapping    * @param bitSets Collection of bit sets    * @return Bit sets with mapping applied    */
specifier|public
specifier|static
name|ImmutableList
argument_list|<
