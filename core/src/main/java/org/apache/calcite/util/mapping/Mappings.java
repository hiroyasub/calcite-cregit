...
return|;
block|}
comment|/**    * Applies a mapping to a collection of {@code ImmutableBitSet}s.    *    * @param mapping Mapping    * @param bitSets Collection of bit sets    * @return Sorted bit sets with mapping applied    */
specifier|public
specifier|static
name|ImmutableList
argument_list|<
...
return|;
block|}
comment|/**    * Returns a mapping as a list such that {@code list.get(source)} is    * {@code mapping.getTarget(source)} and {@code list.size()} is    * {@code mapping.getSourceCount()}.    *    *<p>Converse of {@link #target(List, int)}</p>    * @see #asListNonNull(TargetMapping)    */
annotation|@
name|CheckReturnValue
specifier|public
specifier|static
...
return|;
block|}
comment|/**    * Returns a mapping as a list such that {@code list.get(source)} is    * {@code mapping.getTarget(source)} and {@code list.size()} is    * {@code mapping.getSourceCount()}.    *    *<p>The resulting list never contains null elements</p>    *    *<p>Converse of {@link #target(List, int)}</p>    * @see #asList(TargetMapping)    */
annotation|@
name|CheckReturnValue
specifier|public
specifier|static
...
name|source
operator|+
literal|" is not found in mapping "
operator|+
name|mapping
argument_list|)
throw|;
...
return|;
block|}
comment|/** Creates a bijection.    *    *<p>Throws if sources and targets are not one to one. */
specifier|public
specifier|static
name|Mapping
name|bijection
...
return|;
block|}
comment|/**    * Returns whether a mapping keeps order.    *    *<p>For example, {0:0, 1:1} and {0:1, 1:1} keeps order,    * and {0:1, 1:0} breaks the initial order.    */
specifier|public
specifier|static
name|boolean
name|keepsOrdering
