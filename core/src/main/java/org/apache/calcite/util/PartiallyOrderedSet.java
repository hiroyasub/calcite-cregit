...
expr_stmt|;
block|}
comment|/**    * Internal constructor.    *    * @param ordering Ordering relation    * @param map Map from values to nodes    */
specifier|private
name|PartiallyOrderedSet
parameter_list|(
name|Ordering
...
expr_stmt|;
block|}
comment|/**    * Returns the values in this partially-ordered set that are less-than    * a given value and there are no intervening values.    *    *<p>If the value is not in this set, returns the empty list.</p>    *    * @see #getDescendants    *    * @param e Value    * @return List of values in this set that are directly less than the given    *   value    */
specifier|public
name|List
argument_list|<
name|E
...
condition|)
block|{
comment|// child list contains bottom element, so officially there are no
comment|// children
return|return
name|Collections
operator|.
...
block|}
block|}
comment|/**    * Returns the values in this partially-ordered set that are greater-than    * a given value and there are no intervening values.    *    *<p>If the value is not in this set, returns the empty list.</p>    *    * @see #getAncestors    *    * @param e Value    * @return List of values in this set that are directly greater than the    *   given value    */
specifier|public
name|List
argument_list|<
name|E
...
condition|)
block|{
comment|// parent list contains top element, so officially there are no
comment|// parents
return|return
name|Collections
operator|.
...
block|}
block|}
comment|/**    * Cut-down version of java.util.ArrayDeque, which is not available until    * JDK 1.6.    *    * @param<E> Element type    */
specifier|private
specifier|static
class|class
name|ArrayDeque
...
name|es
decl_stmt|;
comment|// length must be multiple of 2
specifier|private
name|int
name|first
decl_stmt|;
...
argument_list|(
block|{
literal|"SuspiciousSystemArraycopy"
block|,
literal|"unchecked"
block|}
argument_list|)
