...
parameter_list|)
block|{
comment|// IGNORE never throws, so don't bother remembering message and args.
return|return
name|this
return|;
block|}
...
block|}
block|}
comment|/** Creates a Litmus that, if it fails, will use the given arguments. */
specifier|default
name|Litmus
name|withMessageArgs
parameter_list|(
