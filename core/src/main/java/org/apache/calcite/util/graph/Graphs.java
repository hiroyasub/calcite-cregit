...
expr_stmt|;
block|}
comment|/**      * Returns an iterator of all paths between two nodes,      * in non-decreasing order of path lengths.      *      *<p>The current implementation is not optimal.</p>      */
specifier|public
name|List
argument_list|<
name|List
...
return|;
block|}
comment|/**      * Returns the shortest distance between two points, -1, if there is no path.      * @param from From      * @param to To      * @return The shortest distance, -1, if there is no path.      */
specifier|public
name|int
