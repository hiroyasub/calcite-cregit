...
return|;
block|}
comment|/**    * Returns a new immutable bit set containing all the bits in the given    * {@link BitSet}.    */
specifier|public
specifier|static
name|ImmutableBitSet
name|fromBitSet
...
return|;
block|}
comment|/**    * Returns a new {@code ImmutableBitSet}    * composed of bits from this {@code ImmutableBitSet}    * from {@code fromIndex} (inclusive) to {@code toIndex} (exclusive).    *    * @param  fromIndex index of the first bit to include    * @param  toIndex index after the last bit to include    * @return a new {@code ImmutableBitSet} from a range of    *         this {@code ImmutableBitSet}    * @throws IndexOutOfBoundsException if {@code fromIndex} is negative,    *         or {@code toIndex} is negative, or {@code fromIndex} is    *         larger than {@code toIndex}    */
specifier|public
name|ImmutableBitSet
name|get
parameter_list|(
...
return|;
block|}
comment|/** Returns the number of bits set to {@code true} in this    * {@code ImmutableBitSet}.    *    * @see #size() */
specifier|public
name|int
name|cardinality
parameter_list|()
...
return|;
block|}
comment|/**    * Returns the number of bits of space actually in use by this    * {@code ImmutableBitSet} to represent bit values.    * The maximum element in the set is the size - 1st element.    *    * @return the number of bits currently in this bit set    *    * @see #cardinality()    */
specifier|public
name|int
name|size
parameter_list|()
...
return|;
block|}
comment|/** Creates a view onto this bit set as a set of integers.    *    *<p>The {@code size} and {@code contains} methods are both O(n), but the    * iterator is efficient. */
specifier|public
name|Set
argument_list|<
name|Integer
...
return|;
block|}
comment|/** Returns the union of this immutable bit set with a {@link BitSet}. */
specifier|public
name|ImmutableBitSet
name|union
parameter_list|(
...
name|rebuild
argument_list|()
comment|// remember "this" and try to re-use later
operator|.
name|addAll
argument_list|(
name|BitSets
...
return|;
block|}
comment|/** Creates a Builder whose initial contents are the same as this    * ImmutableBitSet. */
specifier|public
name|Builder
name|rebuild
parameter_list|()
...
return|;
block|}
comment|/** Returns a bit set the same as this but with a given bit set (if b is    * true) or unset (if b is false). */
specifier|public
name|ImmutableBitSet
name|set
parameter_list|(
...
return|;
block|}
comment|/** Returns a bit set with every bit moved up {@code offset} positions.    * Offset may be negative, but throws if any bit ends up negative. */
specifier|public
name|ImmutableBitSet
name|shift
parameter_list|(
...
return|;
block|}
comment|/**    * Checks if all bit sets contain a particular bit.    */
specifier|public
specifier|static
name|boolean
name|allContain
...
return|;
block|}
comment|/** Builds an ImmutableBitSet from the contents of this Builder.      *      *<p>After calling this method, the Builder may be used again. */
specifier|public
name|ImmutableBitSet
name|buildAndReset
parameter_list|()
...
return|;
block|}
comment|/** Merges another builder. Does not modify the other builder. */
specifier|public
name|Builder
name|combine
parameter_list|(
...
name|IllegalArgumentException
argument_list|(
literal|"Given builder is empty"
argument_list|)
throw|;
block|}
if|if
...
condition|)
block|{
comment|// Right has more bits. Copy the right and OR in the words of the
comment|// previous left.
specifier|final
name|long
index|[]
name|newWords
...
block|{
comment|// Left has same or more bits. OR in the words of the right.
for|for
control|(
name|int
name|i
...
block|}
block|}
comment|/** Refinement of {@link Builder} that remembers its original    * {@link org.apache.calcite.util.ImmutableBitSet} and tries to use it    * when {@link #build} is called. */
specifier|private
specifier|static
class|class
name|Rebuilder
...
parameter_list|)
block|{
comment|// We try to re-use both originalBitSet and bitSet.
if|if
condition|(
name|wouldEqual
argument_list|(
