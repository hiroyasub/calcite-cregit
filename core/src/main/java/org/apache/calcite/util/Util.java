...
return|;
block|}
comment|/**    * Runs an external application process.    *    * @param pb        ProcessBuilder for the application; might be    *                  returned by {@link #newAppProcess}.    * @param logger    if not null, command and exit status will be logged here    * @param appInput  if not null, data will be copied to application's stdin    * @param appOutput if not null, data will be captured from application's    *                  stdout and stderr    * @return application process exit value    * @throws IOException    * @throws InterruptedException    */
specifier|public
specifier|static
name|int
name|runAppProcess
...
return|;
block|}
comment|/** Returns the first value if it is not null,    * otherwise the second value.    *    *<p>The result may be null.    *    *<p>Equivalent to the Elvis operator ({@code ?:}) of languages such as    * Groovy or PHP. */
specifier|public
specifier|static
parameter_list|<
name|T
...
return|;
block|}
comment|/** Returns the value of a system property as a boolean, returning a given    * default value if the property is not specified. */
specifier|public
specifier|static
name|boolean
name|getBooleanProperty
