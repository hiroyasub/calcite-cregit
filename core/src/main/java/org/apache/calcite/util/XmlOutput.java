...
parameter_list|)
block|{
comment|// This method previously used a LineNumberReader, but that class is
comment|// susceptible to a form of DoS attack. It uses lots of memory and CPU if a
comment|// malicious client gives it input with very long lines.
if|if
condition|(
name|content
operator|!=
...
name|translationTable
argument_list|,
literal|"clone.translationTable"
argument_list|)
argument_list|)
expr_stmt|;
name|clone
