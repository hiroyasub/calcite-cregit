...
comment|/**    *<p>This table shows how and where the Gang of Four patterns are applied.    * The table uses information from the GoF book and from a course on    * advanced object design taught by Craig Larman.</p>    *    *<p>The patterns are in three groups depicting frequency of use. The    * patterns in light green are used    *<i>frequently</i>. Those in yellow have    *<i>moderate</i> use. Patterns in red are    *<i>infrequently</i> used. The GoF column gives the original Gang Of Four    * category for the pattern. The Problem and Pattern columns are from    * Craig's refinement of the type of problems they apply to and a refinement    * of the original three pattern categories.</p>    *    *<table style="border-spacing:0px;padding:3px;border:1px">    *<caption>    *<a href="http://www.onr.com/user/loeffler/java/references.html#gof">    *<b>Gang of Four Patterns</b></a>    *</caption>    *<tr>    *<!-- Headers for each column -->    *    *<th>Pattern Name</th>    *<th style="text-align:middle"><a href="#category">GOF Category</a></th>    *<th style="text-align:middle">Problem</th>    *<th style="text-align:middle">Pattern</th>    *<th style="text-align:middle">Often Uses</th>    *<th style="text-align:middle">Related To</th>    *</tr>    *    *<!-- Frequently used patterns have a lime background -->    *<tr>    *<td style="background-color:lime"><a href="#AbstractFactoryPattern">Abstract Factory</a>    *</td>    *<td style="background-color:teal;color:white">Creational</td>    *<td>Creating Instances</td>    *<td>Class/Interface Definition plus Inheritance</td>    *<td><a href="#FactoryMethodPattern">Factory Method</a><br>    *<a href="#PrototypePattern">Prototype</a><br>    *<a href="#SingletonPattern">Singleton</a> with<a href="#FacadePattern">    * Facade</a></td>    *<td><a href="#FactoryMethodPattern">Factory Method</a><br>    *<a href="#PrototypePattern">Prototype</a><br>    *<a href="#SingletonPattern">Singleton</a></td>    *</tr>    *    *<tr>    *<td style="background-color:lime"><a href="#ObjectAdapterPattern">Object Adapter</a>    *</td>    *<td style="background-color:silver">Structural</td>    *<td>Interface</td>    *<td>Wrap One</td>    *<td style="text-align:middle">-</td>    *<td><a href="#BridgePattern">Bridge</a><br>    *<a href="#DecoratorPattern">Decorator</a><br>    *<a href="#ProxyPattern">Proxy</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#CommandPattern">Command</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Organization or Communication of Work<br>    * Action/Response</td>    *<td>Behavior Objects</td>    *<td><a href="#CompositePattern">Composite</a></td>    *<td><a href="#CompositePattern">Composite</a><br>    *<a href="#MementoPattern">Memento</a><br>    *<a href="#PrototypePattern">Prototype</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#CompositePattern">Composite</a></td>    *<td style="background-color:silver">Structural</td>    *<td>Structural Decomposition of Objects or Subsystems</td>    *<td>Wrap Many</td>    *<td style="text-align:middle">-</td>    *<td><a href="#DecoratorPattern">Decorator</a><br>    *<a href="#IteratorPattern">Iterator</a><br>    *<a href="#VisitorPattern">Visitor</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#DecoratorPattern">Decorator</a></td>    *<td style="background-color:silver">Structural</td>    *<td>Instance Behavior</td>    *<td>Wrap One</td>    *<td style="text-align:middle">-</td>    *<td><a href="#ObjectAdapterPattern">Object Adapter</a><br>    *<a href="#CompositePattern">Composite</a><br>    *<a href="#StrategyPattern">Strategy</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#FacadePattern">Facade</a></td>    *<td style="background-color:silver">Structural</td>    *<td>Access Control<br>    *&nbsp;    *<hr>    *<p>Structural Decomposition of Objects or Subsystems</td>    *<td>Wrap Many</td>    *<td><a href="#SingletonPattern">Singleton</a> with<a    * href="#AbstractFactoryPattern">Abstract Factory</a></td>    *<td><a href="#AbstractFactoryPattern">Abstract Factory</a><br>    *<a href="#MediatorPattern">Mediator</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#FlyweightPattern">Flyweight</a></td>    *<td style="background-color:silver">Structural</td>    *<td>Shared Resource Handling</td>    *<td>Object State or Values</td>    *<td style="text-align:middle">-</td>    *<td><a href="#SingletonPattern">Singleton</a><br>    *<a href="#StatePattern">State</a><br>    *<a href="#StrategyPattern">Strategy</a><br>    * Shareable</td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#IteratorPattern">Iterator</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Traversal Algorithm<br>    *&nbsp;    *<hr>    *<p>Access Control</td>    *<td>Low Coupling</td>    *<td style="text-align:middle">-</td>    *<td><a href="#CompositePattern">Composite</a><br>    *<a href="#FactoryMethodPattern">Factory Method</a><br>    *<a href="#MementoPattern">Memento</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#ObserverPattern">Observer</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Event Response<br>    *&nbsp;    *<hr>    *<p>Organization or Communication of Work</td>    *<td>Low Coupling</td>    *<td style="text-align:middle">-</td>    *<td><a href="#MediatorPattern">Mediator</a><br>    *<a href="#SingletonPattern">Singleton</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#ProxyPattern">Proxy</a></td>    *<td style="background-color:silver">Structural</td>    *<td>Access Control</td>    *<td>Wrap One</td>    *<td style="text-align:middle">-</td>    *<td><a href="#ObjectAdapterPattern">Adapter</a><br>    *<a href="#DecoratorPattern">Decorator</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#SingletonPattern">Singleton</a></td>    *<td style="background-color:teal;color:white">Creational</td>    *<td>Access Control</td>    *<td>Other</td>    *<td style="text-align:middle">-</td>    *<td><a href="#AbstractFactoryPattern">Abstract Factory</a><br>    *<a href="#BuilderPattern">Builder</a><br>    *<a href="#PrototypePattern">Prototype</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#StatePattern">State</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Instance Behavior</td>    *<td>Object State or Values</td>    *<td><a href="#FlyweightPattern">Flyweight</a></td>    *<td><a href="#FlyweightPattern">Flyweight</a><br>    *<a href="#SingletonPattern">Singleton</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#StrategyPattern">Strategy</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Single Algorithm</td>    *<td>Behavior Objects</td>    *<td style="text-align:middle">-</td>    *<td><a href="#FlyweightPattern">Flyweight</a><br>    *<a href="#StatePattern">State</a><br>    *<a href="#TemplateMethodPattern">Template Method</a></td>    *</tr>    *<tr>    *<td style="background-color:lime"><a href="#TemplateMethodPattern">Template Method</a>    *</td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Single Algorithm</td>    *<td>Class or Interface Definition plus Inheritance</td>    *<td style="text-align:middle">-</td>    *<td><a href="#StrategyPattern">Strategy</a></td>    *</tr>    *<!-- Moderately use patterns have a yellow background -->    *<tr>    *<td style="background-color:yellow"><a href="#ClassAdapterPattern">Class Adapter</a>    *</td>    *<td style="background-color:silver">Structural</td>    *<td>Interface</td>    *<td>Class or Interface Definition plus Inheritance</td>    *<td style="text-align:middle">-</td>    *<td><a href="#BridgePattern">Bridge</a><br>    *<a href="#DecoratorPattern">Decorator</a><br>    *<a href="#ProxyPattern">Proxy</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#BridgePattern">Bridge</a></td>    *<td style="background-color:silver">Structural</td>    *<td>Implementation</td>    *<td>Wrap One</td>    *<td style="text-align:middle">-</td>    *<td><a href="#AbstractFactoryPattern">Abstract Factory</a><br>    *<a href="#ClassAdapterPattern">Class Adaptor</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#BuilderPattern">Builder</a></td>    *<td style="background-color:teal;color:white">Creational</td>    *<td>Creating Structures</td>    *<td>Class or Interface Definition plus Inheritance</td>    *<td style="text-align:middle">-</td>    *<td><a href="#AbstractFactoryPattern">Abstract Factory</a><br>    *<a href="#CompositePattern">Composite</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#ChainOfResponsibilityPattern">Chain of    * Responsibility</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Single Algorithm<br>    *&nbsp;    *<hr>    *<p>Organization or Communication of Work</td>    *<td>Low Coupling</td>    *<td style="text-align:middle">-</td>    *<td><a href="#CompositePattern">Composite</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#FactoryMethodPattern">Factory Method</a>    *</td>    *<td style="background-color:teal;color:white">Creational</td>    *<td>Creating Instances</td>    *<td>Class or Interface Definition plus Inheritance</td>    *<td><a href="#TemplateMethodPattern">Template Method</a></td>    *<td><a href="#AbstractFactoryPattern">Abstract Factory</a><br>    *<a href="#TemplateMethodPattern">Template Method</a><br>    *<a href="#PrototypePattern">Prototype</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#MediatorPattern">Mediator</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Interaction between Objects<br>    *&nbsp;    *<hr>    *<p>Organization or Communication of Work</td>    *<td>Low Coupling</td>    *<td style="text-align:middle">-</td>    *<td><a href="#FacadePattern">Facade</a><br>    *<a href="#ObserverPattern">Observer</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#PrototypePattern">Prototype</a></td>    *<td style="background-color:teal;color:white">Creational</td>    *<td>Creating Instances</td>    *<td>Other</td>    *<td style="text-align:middle">-</td>    *<td><a href="#PrototypePattern">Prototype</a><br>    *<a href="#CompositePattern">Composite</a><br>    *<a href="#DecoratorPattern">Decorator</a></td>    *</tr>    *<tr>    *<td style="background-color:yellow"><a href="#VisitorPattern">Visitor</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Single Algorithm</td>    *<td>Behavior Objects</td>    *<td style="text-align:middle">-</td>    *<td><a href="#CompositePattern">Composite</a><br>    *<a href="#VisitorPattern">Visitor</a></td>    *</tr>    *<!-- Seldom used patterns have a red background -->    *<tr>    *<td style="background-color:red;color:white"><a href="#InterpreterPattern">    * Interpreter</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Organization or Communication of Work</td>    *<td>Other</td>    *<td style="text-align:middle">-</td>    *<td><a href="#CompositePattern">Composite</a><br>    *<a href="#FlyweightPattern">Flyweight</a><br>    *<a href="#IteratorPattern">Iterator</a><br>    *<a href="#VisitorPattern">Visitor</a></td>    *</tr>    *<tr>    *<td style="background-color:red;color:white"><a href="#MementoPattern">    * Memento</a></td>    *<td style="background-color:maroon;color:white">Behavioral</td>    *<td>Instance Management</td>    *<td>Object State or Values</td>    *<td style="text-align:middle">-</td>    *<td><a href="#CommandPattern">Command</a><br>    *<a href="#IteratorPattern">Iterator</a></td>    *</tr>    *</table>    */
...
literal|null
decl_stmt|;
comment|/**    * The official SQL-92 standard (ISO/IEC 9075:1992). To reference this    * standard from methods that implement its rules, use the&#64;sql.92    * custom block tag in Javadoc comments; for the tag body, use the format    *<code>&lt;SectionId&gt; [ ItemType&lt;ItemId&gt; ]</code>, where    *    *<ul>    *<li><code>SectionId</code> is the numbered or named section in the table    * of contents, e.g. "Section 4.18.9" or "Annex A"    *<li><code>ItemType</code> is one of { Table, Syntax Rule, Access Rule,    * General Rule, or Leveling Rule }    *<li><code>ItemId</code> is a dotted path expression to the specific item    *</ul>    *    *<p>For example,    *    *<blockquote><pre><code>&#64;sql.92 Section 11.4 Syntax Rule 7.c    *</code></pre></blockquote>    *    *<p>is a well-formed reference to the rule for the default character set to    * use for column definitions of character type.    *    *<p>Note that this tag is a block tag (like&#64;see) and cannot be used    * inline.    */
name|Glossary
name|SQL92
init|=
literal|null
decl_stmt|;
comment|/**    * The official SQL:1999 standard (ISO/IEC 9075:1999), which is broken up    * into five parts. To reference this standard from methods that implement    * its rules, use the&#64;sql.99 custom block tag in Javadoc comments; for    * the tag body, use the format<code>&lt;PartId&gt;&lt;SectionId&gt; [    * ItemType&lt;ItemId&gt; ]</code>, where    *    *<ul>    *<li><code>PartId</code> is the numbered part (up to Part 5)    *<li><code>SectionId</code> is the numbered or named section in the part's    * table of contents, e.g. "Section 4.18.9" or "Annex A"    *<li><code>ItemType</code> is one of { Table, Syntax Rule, Access Rule,    * General Rule, or Conformance Rule }    *<li><code>ItemId</code> is a dotted path expression to the specific item    *</ul>    *    *<p>For example,    *    *<blockquote><pre><code>&#64;sql.99 Part 2 Section 11.4 Syntax Rule 7.b    *</code></pre></blockquote>    *    *<p>is a well-formed reference to the rule for the default character set to    * use for column definitions of character type.    *    *<p>Note that this tag is a block tag (like&#64;see) and cannot be used    * inline.    */
name|Glossary
name|SQL99
init|=
literal|null
decl_stmt|;
comment|/**    * The official SQL:2003 standard (ISO/IEC 9075:2003), which is broken up    * into numerous parts. To reference this standard from methods that    * implement its rules, use the&#64;sql.2003 custom block tag in Javadoc    * comments; for the tag body, use the format<code>&lt;PartId&gt;    *&lt;SectionId&gt; [ ItemType&lt;ItemId&gt; ]</code>, where    *    *<ul>    *<li><code>PartId</code> is the numbered part    *<li><code>SectionId</code> is the numbered or named section in the part's    * table of contents, e.g. "Section 4.11.2" or "Annex A"    *<li><code>ItemType</code> is one of { Table, Syntax Rule, Access Rule,    * General Rule, or Conformance Rule }    *<li><code>ItemId</code> is a dotted path expression to the specific item    *</ul>    *    *<p>For example,    *    *<blockquote><pre><code>&#64;sql.2003 Part 2 Section 11.4 Syntax Rule 10.b    *</code></pre></blockquote>    *    *<p>is a well-formed reference to the rule for the default character set to    * use for column definitions of character type.    *    *<p>Note that this tag is a block tag (like&#64;see) and cannot be used    * inline.    */
name|Glossary
name|SQL2003
init|=
literal|null
