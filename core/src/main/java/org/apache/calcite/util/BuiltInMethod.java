...
name|class
argument_list|,
literal|"toTimeWithLocalTimeZone"
argument_list|,
name|String
operator|.
name|class
...
name|class
argument_list|,
literal|"toTimestampWithLocalTimeZone"
argument_list|,
name|String
operator|.
name|class
...
name|class
argument_list|,
literal|"timeWithLocalTimeZoneToTime"
argument_list|,
name|int
operator|.
name|class
...
name|class
argument_list|,
literal|"timeWithLocalTimeZoneToTimestamp"
argument_list|,
name|String
operator|.
name|class
...
name|class
argument_list|,
literal|"timeWithLocalTimeZoneToTimestampWithLocalTimeZone"
argument_list|,
name|String
operator|.
name|class
...
name|class
argument_list|,
literal|"timeWithLocalTimeZoneToString"
argument_list|,
name|int
operator|.
name|class
...
name|class
argument_list|,
literal|"timestampWithLocalTimeZoneToDate"
argument_list|,
name|long
operator|.
name|class
...
name|class
argument_list|,
literal|"timestampWithLocalTimeZoneToTime"
argument_list|,
name|long
operator|.
name|class
...
name|class
argument_list|,
literal|"timestampWithLocalTimeZoneToTimeWithLocalTimeZone"
argument_list|,
name|long
operator|.
name|class
...
name|class
argument_list|,
literal|"timestampWithLocalTimeZoneToTimestamp"
argument_list|,
name|long
operator|.
name|class
...
name|class
argument_list|,
literal|"timestampWithLocalTimeZoneToString"
argument_list|,
name|long
operator|.
name|class
...
name|class
argument_list|,
literal|"monthNameWithTimestamp"
argument_list|,
name|long
operator|.
name|class
...
argument_list|)
block|,
name|DATE_TO_INT_OPTIONAL_OFFSET
argument_list|(
name|SqlFunctions
operator|.
name|class
...
name|class
argument_list|,
literal|"multisetIntersectDistinct"
argument_list|,
name|Collection
operator|.
name|class
...
name|class
argument_list|,
literal|"multisetExceptDistinct"
argument_list|,
name|Collection
operator|.
name|class
...
name|class
argument_list|,
literal|"singleGroupResultSelector"
argument_list|,
name|Function1
operator|.
name|class
...
parameter_list|)
block|{
comment|// TODO: split enum in three different ones
name|this
operator|.
name|method
operator|=
