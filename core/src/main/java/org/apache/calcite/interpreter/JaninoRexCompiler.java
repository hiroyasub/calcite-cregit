...
argument_list|()
decl_stmt|;
comment|// public Scalar apply(DataContext root) {
comment|//<<staticList>>
comment|//   return new Scalar() {
comment|//<<inner declarations>>
comment|//   };
comment|// }
specifier|final
name|List
...
comment|// public Object apply(Object root) {
comment|//   return this.apply((DataContext) root);
comment|// }
specifier|final
name|ParameterExpression
name|objectRoot
