...
parameter_list|()
lambda|->
literal|"Unable to create AggregateFunctionImpl for "
operator|+
name|clazz
argument_list|)
return|;
...
name|values
argument_list|,
literal|"def.sendContext.values"
argument_list|)
decl_stmt|;
name|System
operator|.
...
name|resultMethod
argument_list|,
literal|"aggFunction.resultMethod"
argument_list|)
operator|.
name|invoke
argument_list|(
