...
expr_stmt|;
block|}
comment|/** Per {@link #rewrite(RelNode)}, writes to {@link #rel}.      *      *<p>We don't handle {@link CalcRelBase} directly. Expand to a      * {@link ProjectRelBase} on {@link FilterRelBase} (or just a      * {@link ProjectRelBase}). */
specifier|public
name|void
name|rewrite
parameter_list|(
