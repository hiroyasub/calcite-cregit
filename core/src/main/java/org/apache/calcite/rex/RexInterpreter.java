...
return|;
block|}
comment|/** Translates the values in a RangeSet from literal format to runtime format.    * For example the DATE SQL type uses DateString for literals and Integer at    * runtime. */
annotation|@
name|SuppressWarnings
argument_list|(
block|{
