...
return|;
block|}
comment|/**    * Rounds the time part of a TIME or TIMESTAMP value to the given precision.    *    * @param timestamp The value to be rounded, will change in place    * @param precision the desired precision    */
specifier|private
name|void
name|roundTime
parameter_list|(
