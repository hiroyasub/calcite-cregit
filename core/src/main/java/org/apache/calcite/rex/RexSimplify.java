...
condition|)
block|{
comment|// SEARCH(x, [TRUE])  -> TRUE
comment|// SEARCH(x, [NOT NULL])  -> TRUE if x's type is NOT NULL
return|return
name|rexBuilder
operator|.
name|makeLiteral
...
argument_list|)
decl_stmt|;
comment|// Now we've strengthened containsNull to false, try to simplify again
return|return
name|simplifySearch
argument_list|(
name|call
