...
return|;
block|}
comment|/** Returns the intersection of two range sets.    *    *<p>For example:    *<ul>    *<li>empty intersect empty&rarr; empty    *<li>{1, [3, 5], (9,&inf;)} intersect {1, 3, 5, 7, 9, 11}}&rarr;    *   {1, 3, 5, 11}    *<li>all intersect {[3, 5)}&rarr; {[3, 5)}    *</ul>    *    * @param s0 First range set    * @param s1 Second range set    * @param<C> Value type    * @return Intersection of range sets    */
comment|// TODO
specifier|private
specifier|static
parameter_list|<
