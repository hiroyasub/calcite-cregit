...
decl_stmt|;
comment|/**      * Creates a Checker.      *      * @param litmus               Whether to fail      * @param inputRowType         Types of the input fields      * @param internalExprTypeList Types of the internal expressions      */
specifier|public
name|Checker
parameter_list|(
name|Litmus
