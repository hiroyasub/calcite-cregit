...
block|}
block|}
comment|/**    * Returns whether a node represents a {@link SqlTypeName#SYMBOL} literal.    */
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/** Expands all the calls to {@link SqlStdOperatorTable#SEARCH} in an expression. */
specifier|public
specifier|static
name|RexNode
name|expandSearch
...
return|;
block|}
comment|/** Expands calls to {@link SqlStdOperatorTable#SEARCH}    * whose complexity is greater than {@code maxComplexity} in an expression. */
specifier|public
specifier|static
name|RexNode
name|expandSearch
...
condition|)
block|{
comment|// Generate 'ref = value1 OR ... OR ref = valueN'
name|sarg
operator|.
name|rangeSet
operator|.
...
condition|)
block|{
comment|// Generate 'ref<> value1 AND ... AND ref<> valueN'
specifier|final
name|List
argument_list|<
name|RexNode
...
return|;
block|}
comment|/** Expands an 'all' or 'none' sarg. */
specifier|public
specifier|static
parameter_list|<
name|C
...
name|UNKNOWN
case|:
comment|// "x IS NOT NULL OR UNKNOWN"
return|return
name|rexBuilder
operator|.
name|makeCall
...
name|UNKNOWN
case|:
comment|// "CASE WHEN x IS NULL THEN UNKNOWN ELSE FALSE END", or "x<> x"
return|return
name|rexBuilder
operator|.
name|makeCall
...
return|;
block|}
comment|/**    * Given some expressions, gets the indices of the non-constant ones.    */
specifier|public
specifier|static
name|ImmutableBitSet
...
return|;
block|}
comment|/**    * Given some expressions and columns, gets the indices of the non-constant ones.    */
specifier|public
specifier|static
name|ImmutableBitSet
name|getNonConstColumns
...
block|}
block|}
comment|/** Converts a {@link Range} to a {@link RexNode} expression.    *    * @param<C> Value type */
specifier|private
specifier|static
class|class
name|RangeToRex
...
block|}
block|}
comment|/** Shuttle that expands calls to    * {@link org.apache.calcite.sql.fun.SqlStdOperatorTable#SEARCH}.    *    *<p>Calls whose complexity is greater than {@link #maxComplexity}    * are retained (not expanded). */
specifier|private
specifier|static
class|class
name|SearchExpandingShuttle
...
condition|)
block|{
comment|// Flatten AND/OR operands.
case|case
name|OR
case|:
name|clonedOperands
...
return|;
block|}
comment|// Sarg is complex (therefore useful); fall through
default|default:
return|return
name|super
operator|.
