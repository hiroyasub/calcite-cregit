...
return|;
block|}
comment|/**    * Simplifies a boolean expression, leaving UNKNOWN values as UNKNOWN, and    * using the default executor.    *    * @deprecated Use {@link RexSimplify#simplify(RexNode)},    * which allows you to specify an {@link RexExecutor}.    */
annotation|@
name|Deprecated
comment|// to be removed before 2.0
specifier|public
...
return|;
block|}
comment|/**    * Simplifies a conjunction of boolean expressions.    *    * @deprecated Use {@link RexSimplify#simplifyAnds(Iterable)},    * which allows you to specify an {@link RexExecutor}.    */
annotation|@
name|Deprecated
comment|// to be removed before 2.0
specifier|public
