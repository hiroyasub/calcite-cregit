...
expr_stmt|;
block|}
comment|/**    * Appends the specified value in the provided destination as a Java string. The value must be    * consistent with the type, as per {@link #valueMatchesType}.    *    *<p>Typical return values:</p>    *    *<ul>    *<li>true</li>    *<li>null</li>    *<li>"Hello, world!"</li>    *<li>1.25</li>    *<li>1234ABCD</li>    *</ul>    *    * @param value    Value to be appended to the provided destination as a Java string    * @param sb       Destination to which to append the specified value    * @param typeName Type name to be used for the transformation of the value to a Java string    * @param type Type to be used for the transformation of the value to a Java string    * @param includeType Whether to include the data type in the Java representation    */
specifier|private
specifier|static
name|void
name|appendAsJava
...
name|List
operator|:
literal|"value must implement List: "
operator|+
name|value
assert|;
annotation|@
...
expr_stmt|;
block|}
comment|/** Converts a value to a temporary literal, for the purposes of generating a    * digest. Literals of type ROW and MULTISET require that their components are    * also literals. */
specifier|private
specifier|static
name|RexLiteral
name|toLiteral
...
block|}
block|}
comment|/**    * Converts a Jdbc string into a RexLiteral. This method accepts a string,    * as returned by the Jdbc method ResultSet.getString(), and restores the    * string into an equivalent RexLiteral. It allows one to use Jdbc strings    * as a common format for data.    *    *<p>Returns null if and only if {@code literal} is null.    *    * @param type     data type of literal to be read    * @param typeName type family of literal    * @param literal  the (non-SQL encoded) string representation, as returned    *                 by the Jdbc call to return a column as a string    * @return a typed RexLiteral, or null    */
specifier|public
specifier|static
annotation|@
name|PolyNull
