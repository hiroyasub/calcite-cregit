...
return|;
block|}
comment|/** Returns whether this aggregate function is a PERCENTILE function.    * Such functions require a {@code WITHIN GROUP} clause that has precisely    * one sort key.    *    *<p>NOTE: This API is experimental and subject to change without notice. */
annotation|@
name|Experimental
specifier|public
name|boolean
