...
block|}
block|}
comment|/**    * Returns an immutable list of {@link RelHint} from sql hints, with a given    * inherit path from the root node.    *    *<p>The inherit path would be empty [].    *    * @param hintStrategies The hint strategies to validate if the sql hints    * @param sqlHints       The sql hints nodes    * @return the {@code RelHint} list    */
specifier|public
specifier|static
name|List
argument_list|<
