...
block|}
block|}
comment|/**    * Looks up all subject routines matching the given name and argument types.    *    * @param opTab    operator table to search    * @param funcName name of function being invoked    * @param argTypes argument types    * @param argNames argument names, or null if call by position    * @param category category of routine to look up    * @return list of matching routines    * @sql.99 Part 2 Section 10.4    */
specifier|public
specifier|static
name|List
argument_list|<
...
condition|)
block|{
comment|// Arguments passed by name. Make sure that the function has parameters
comment|// of all of these names.
specifier|final
name|Map
argument_list|<
name|Integer
