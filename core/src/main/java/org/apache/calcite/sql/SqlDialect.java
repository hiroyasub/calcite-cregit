...
return|;
block|}
comment|/**    * Returns the SqlNode for emulating the null direction for the given field    * or<code>null</code> if no emulation needs to be done.    *    * @param node The SqlNode representing the expression    * @param nullsFirst<code>true</code> if nulls should come first,<code>false</code> otherwise    * @return A SqlNode for null direction emulation or<code>null</code> if not required    */
specifier|public
name|SqlNode
