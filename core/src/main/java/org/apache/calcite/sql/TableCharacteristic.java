...
name|Semantics
block|{
comment|/**      * Row semantics means that the the result of the Window TableFunction      * is decided on a row-by-row basis.      * As an extreme example, the DBMS could atomize the input table into      * individual rows, and send each single row to a different virtual      * processor.      */
name|ROW
block|,
