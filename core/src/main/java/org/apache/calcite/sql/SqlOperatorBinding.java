...
throw|;
block|}
comment|/**    * Returns whether an operand is a time frame.    *    * @param ordinal   zero-based ordinal of operand of interest    * @return whether operand is a time frame    */
specifier|public
name|boolean
name|isOperandTimeFrame
parameter_list|(
name|int
name|ordinal
parameter_list|)
