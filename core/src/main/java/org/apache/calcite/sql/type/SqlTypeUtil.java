...
return|;
block|}
comment|/**    * Returns whether two struct types are equal, ignoring nullability.    *    *<p>They do not need to come from the same factory.    *    * @param factory       Type factory    * @param type1         First type    * @param type2         Second type    * @param nameMatcher   Name matcher used to compare the field names    * @return Whether types are equal, ignoring nullability    */
specifier|public
specifier|static
name|boolean
...
return|;
block|}
comment|/**    * Checks that there is no expression inside list which may    * return struct type.    *    * @param exprList list of expressions to check    * @return true if all expressions don't return struct type    */
specifier|public
specifier|static
name|boolean
name|isFlat
