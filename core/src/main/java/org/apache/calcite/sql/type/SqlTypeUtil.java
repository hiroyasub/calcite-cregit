...
literal|2
operator|:
literal|"operands.size() should be 2 or greater, actual: "
operator|+
name|operands
operator|.
name|size
...
return|;
block|}
comment|/**    * Derives component type for ARRAY, MULTISET, MAP when input is sub-query.    *    * @param origin original component type    * @return component type    */
specifier|public
specifier|static
name|RelDataType
...
name|AssertionError
argument_list|(
literal|"Impossible to derive component type for "
operator|+
name|collectionType
argument_list|)
throw|;
...
return|;
block|}
comment|/**    * Derives type of the call via its binding.    * @param binding binding to derive the type from    * @return datatype of the call    */
annotation|@
name|API
argument_list|(
name|since
...
return|;
block|}
comment|/**    * Derives type of the given call under given binding.    * @param binding binding to derive the type from    * @param node node type to derive    * @return datatype of the given node    */
annotation|@
name|API
argument_list|(
name|since
...
return|;
block|}
comment|/**    * Derives types for the list of nodes.    * @param binding binding to derive the type from    * @param nodes the list of nodes to derive types from    * @return the list of types of the given nodes    */
annotation|@
name|API
argument_list|(
name|since
...
return|;
block|}
comment|/**    * Creates a RelDataType having the same type of the sourceRelDataType,    * and the same nullability as the targetRelDataType.    */
specifier|public
specifier|static
name|RelDataType
...
parameter_list|(
name|RelDataType
name|sourceRelDataType
parameter_list|,
name|RelDataType
name|targetRelDataType
parameter_list|,
name|RelDataTypeFactory
name|typeFactory
parameter_list|)
...
name|expression
operator|=
literal|"#1.getIntervalQualifier()"
argument_list|,
name|result
operator|=
literal|true
...
argument_list|(
literal|"Unsupported type when convertTypeToSpec: "
operator|+
name|typeName
argument_list|)
throw|;
...
return|;
block|}
comment|/** Creates a MAP type from a record type. The record type must have exactly    * two fields. */
specifier|public
specifier|static
name|RelDataType
...
return|;
block|}
comment|/**    * Returns whether the decimal value is valid for the type. For example, 1111.11 is not    * valid for DECIMAL(3, 1) since it overflows.    *    * @param value Value of literal    * @param toType Type of the literal    * @return whether the value is valid for the type    */
specifier|public
specifier|static
name|boolean
