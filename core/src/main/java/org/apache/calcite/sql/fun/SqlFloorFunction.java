...
comment|//
comment|//  * In "FLOOR(x TO YEAR)" operand 1 is a SqlIntervalQualifier with
comment|//    startUnit = YEAR and timeFrameName = null.
comment|//
comment|//  * In "FLOOR(x TO MINUTE15)" operand 1 is a SqlIntervalQualifier with
comment|//    startUnit = EPOCH and timeFrameName = 'MINUTE15'.
comment|//
