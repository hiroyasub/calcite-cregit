...
expr_stmt|;
block|}
comment|/**    * Returns whether this operator matches the case of its operands.    *    * @return whether this operator matches the case of its operands    */
specifier|public
name|boolean
...
return|;
block|}
comment|/**    * Returns whether this is 'NOT' variant of an operator.    *    * @see #not()    */
specifier|public
name|boolean
name|isNegated
parameter_list|()
