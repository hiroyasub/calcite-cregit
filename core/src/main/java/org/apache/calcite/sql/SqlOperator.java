...
return|;
block|}
comment|/** Not supported. Choose between    * {@link #createCall(SqlLiteral, SqlParserPos, SqlNode...)} and    * {@link #createCall(SqlParserPos, List)}. The ambiguity arises because    * {@link SqlNodeList} extends {@link SqlNode}    * and also implements {@code List<SqlNode>}. */
annotation|@
name|Deprecated
specifier|public
specifier|static
...
return|;
block|}
comment|/** Not supported. Choose between    * {@link #createCall(SqlParserPos, SqlNode...)} and    * {@link #createCall(SqlParserPos, List)}. The ambiguity arises because    * {@link SqlNodeList} extends {@link SqlNode}    * and also implements {@code List<SqlNode>}. */
annotation|@
name|Deprecated
specifier|public
name|SqlCall
