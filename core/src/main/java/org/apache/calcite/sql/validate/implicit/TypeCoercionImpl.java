...
parameter_list|()
lambda|->
literal|"getElseOperand() is null for "
operator|+
name|caseCall
argument_list|)
decl_stmt|;
...
parameter_list|()
lambda|->
literal|"getOperandTypeChecker is not defined for "
operator|+
name|function
argument_list|)
decl_stmt|;
...
block|{
comment|// Note: this is dead code since sourceExpressionList is always non-null
return|return
name|coerceSourceRowType
argument_list|(
name|sourceScope
