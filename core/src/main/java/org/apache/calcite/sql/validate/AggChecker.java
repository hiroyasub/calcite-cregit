...
comment|/**    * Creates an AggChecker.    *    * @param validator  Validator    * @param scope      Scope    * @param extraExprs Expressions in GROUP BY (or SELECT DISTINCT) clause,    *                   that are therefore available    * @param measureExprs Expressions that are the names of measures    * @param groupExprs Expressions in GROUP BY (or SELECT DISTINCT) clause,    *                   that are therefore available    * @param distinct   Whether aggregation checking is because of a SELECT    *                   DISTINCT clause    */
name|AggChecker
parameter_list|(
name|SqlValidatorImpl
name|validator
