...
argument_list|)
expr_stmt|;
comment|// VARCHAR is castable from BOOLEAN, DATE, TIMESTAMP, numeric types, binary and
comment|// intervals
name|coerceRules
operator|.
name|add
...
argument_list|)
expr_stmt|;
comment|// CHAR is castable from BOOLEAN, DATE, TIME, TIMESTAMP and numeric types, binary and
comment|// intervals
name|coerceRules
operator|.
name|add
