...
name|scope
argument_list|,
literal|"scope is needed for needToCast(scope, operand, targetType)"
argument_list|)
expr_stmt|;
if|if
condition|(
...
name|dataType
init|=
name|getTightestCommonTypeOrThrow
argument_list|(
name|leftType
argument_list|,
name|rightType
...
parameter_list|()
lambda|->
literal|"expected non-null getTightestCommonType for "
operator|+
name|type1
operator|+
literal|" and "
...
return|;
block|}
comment|/**    * Coerce STRING type to ARRAY type.    */
specifier|protected
name|Boolean
name|coerceStringToArray
parameter_list|(
