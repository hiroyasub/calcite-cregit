...
return|;
block|}
comment|/**    * Does not throw an error (returns null) if the type is not built-in.    */
specifier|public
name|RelDataType
name|deriveType
parameter_list|(
...
return|;
block|}
comment|/**    * Converts this type specification to a {@link RelDataType}.    *    *<p>Does not throw an error (returns null) if the type is not built-in.    *    * @param nullable Whether the type is nullable if the type specification    *                 does not explicitly state    */
specifier|public
name|RelDataType
name|deriveType
parameter_list|(
