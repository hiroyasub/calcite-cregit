...
block|}
block|}
comment|/**    * Validate the heading operands are in the form:    * (ROW, DESCRIPTOR, DESCRIPTOR ..., other params).    *    * @param callBinding The call binding    * @param descriptors The number of descriptors following the first operand (e.g. the table)    *    * @return true if validation passes    */
specifier|protected
specifier|static
name|boolean
...
return|;
block|}
comment|/**    * Validate the operands starting from position {@code startPos} are all INTERVAL.    *    * @param callBinding The call binding    * @param startPos    The start position to validate (starting index is 0)    *    * @return true if validation passes    */
specifier|protected
specifier|static
name|boolean
