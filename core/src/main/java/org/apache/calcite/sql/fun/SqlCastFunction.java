...
return|;
block|}
comment|/** Derives the type of "CAST(expression AS targetType)". */
specifier|public
specifier|static
name|RelDataType
name|deriveType
...
condition|)
block|{
comment|// Cast between types compared with different collators: not monotonic.
return|return
name|SqlMonotonicity
operator|.
name|NOT_MONOTONIC
