...
comment|/**    * Creates a new SqlFunction for a call to a built-in function.    *    * @param name Name of built-in function    * @param kind Kind of operator implemented by function    * @param syntax Syntax    * @param deterministic Whether the function is deterministic    * @param returnTypeInference Strategy to use for return type inference    * @param operandTypeInference Strategy to use for parameter type inference    * @param operandHandler Strategy to use for handling operands    * @param operandTypeChecker Strategy to use for parameter type checking    * @param callValidator Strategy to validate calls    * @param category Categorization for function    * @param monotonicityInference Strategy to infer monotonicity of a call    */
specifier|private
name|SqlBasicFunction
parameter_list|(
name|String
...
return|;
block|}
comment|/** Returns a copy of this function with a given strategy for handling    * operands. */
specifier|public
name|SqlBasicFunction
