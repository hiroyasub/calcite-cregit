...
argument_list|)
decl_stmt|;
comment|/** Transforms a call binding of {@code CONVERT} to an equivalent binding for    *  {@code CAST}. */
specifier|private
specifier|static
name|SqlCallBinding
name|transformConvert
...
parameter_list|)
block|{
comment|// Guaranteed to be a SqlCallBinding, with 2 or 3 arguments
specifier|final
name|SqlCallBinding
name|binding
init|=
...
return|;
block|}
comment|/** Transforms a call to {@code CONVERT} to an equivalent call to    *  {@code CAST}. */
specifier|private
specifier|static
name|SqlCall
name|transformConvert
...
argument_list|)
decl_stmt|;
comment|/** The "SPLIT(string [, delimiter])" function. */
annotation|@
name|LibraryOperator
argument_list|(
name|libraries
