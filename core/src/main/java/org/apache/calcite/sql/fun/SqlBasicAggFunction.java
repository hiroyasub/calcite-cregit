...
argument_list|)
decl_stmt|;
comment|// Assigning back the operands that might have been casted by validator
for|for
control|(
name|int
name|i
...
parameter_list|()
block|{
comment|// constructor ensures it is non-null
return|return
name|requireNonNull
argument_list|(
name|super
...
return|;
block|}
comment|/** Returns whether this aggregate function allows '{@code SEPARATOR string}'    * among its arguments. */
specifier|public
name|boolean
name|allowsSeparator
parameter_list|()
...
return|;
block|}
comment|/** Sets {@link #allowsSeparator()}. */
specifier|public
name|SqlBasicAggFunction
...
return|;
block|}
comment|/** Sets {@link #isPercentile()}. */
specifier|public
name|SqlBasicAggFunction
name|withPercentile
parameter_list|(
