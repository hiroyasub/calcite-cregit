...
block|}
decl_stmt|;
comment|/** {@code AS} function that defines a measure inside {@code MATCH_RECOGNIZE}.    * The order of operands will change when the expression is unparsed. */
specifier|public
specifier|static
specifier|final
name|SqlSpecialOperator
name|PATTERN_DEFINE_AS
init|=
operator|new
name|SqlAsOperator
argument_list|(
