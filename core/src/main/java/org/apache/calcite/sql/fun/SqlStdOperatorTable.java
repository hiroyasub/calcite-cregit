...
argument_list|()
decl_stmt|;
comment|/**    * String and array-to-array concatenation operator, '<code>||</code>'.    *    * @see SqlLibraryOperators#CONCAT_FUNCTION    */
specifier|public
specifier|static
specifier|final
name|SqlBinaryOperator
...
argument_list|)
argument_list|,
literal|"inferred CONCAT element type"
argument_list|)
return|;
block|}
argument_list|)
...
argument_list|)
decl_stmt|;
comment|/**    *<code>MODE</code> aggregate function.    */
specifier|public
specifier|static
specifier|final
name|SqlAggFunction
...
argument_list|)
decl_stmt|;
comment|/**    *<code>ARG_MAX</code> aggregate function.    */
specifier|public
specifier|static
specifier|final
name|SqlBasicAggFunction
...
argument_list|)
decl_stmt|;
comment|/**    *<code>ARG_MIN</code> aggregate function.    */
specifier|public
specifier|static
specifier|final
name|SqlBasicAggFunction
...
argument_list|)
decl_stmt|;
comment|/**    *<code>EVERY</code> aggregate function.    */
specifier|public
specifier|static
specifier|final
name|SqlAggFunction
...
argument_list|)
decl_stmt|;
comment|/**    *<code>SOME</code> aggregate function.    */
specifier|public
specifier|static
specifier|final
name|SqlAggFunction
...
argument_list|(
literal|"POSIX REGEX CASE SENSITIVE"
argument_list|,
name|SqlKind
operator|.
name|POSIX_REGEX_CASE_SENSITIVE
...
name|SqlPosixRegexOperator
argument_list|(
literal|"POSIX REGEX CASE INSENSITIVE"
argument_list|,
name|SqlKind
operator|.
name|POSIX_REGEX_CASE_INSENSITIVE
...
name|SqlPosixRegexOperator
argument_list|(
literal|"NEGATED POSIX REGEX CASE SENSITIVE"
argument_list|,
name|SqlKind
operator|.
name|POSIX_REGEX_CASE_SENSITIVE
...
name|SqlPosixRegexOperator
argument_list|(
literal|"NEGATED POSIX REGEX CASE INSENSITIVE"
argument_list|,
name|SqlKind
operator|.
name|POSIX_REGEX_CASE_INSENSITIVE
...
argument_list|)
decl_stmt|;
comment|/** Alias for {@link #CHAR_LENGTH}. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code POWER(numeric, numeric)} function.    *    *<p>The return type is always {@code DOUBLE} since we don't know    * what the result type will be by just looking at the operand types. For    * example {@code POWER(INTEGER, INTEGER)} can return a non-INTEGER if the    * second operand is negative.    */
specifier|public
specifier|static
specifier|final
name|SqlBasicFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code LN(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code LOG10(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code ABS(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code ACOS(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code ASIN(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code ATAN(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code ATAN2(numeric, numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code CBRT(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code COS(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code COT(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code DEGREES(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code EXP(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code RADIANS(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code ROUND(numeric [, numeric])} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code SIGN(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code SIN(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code TAN(numeric)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code TRUNCATE(numeric [, numeric])} function. */
specifier|public
specifier|static
specifier|final
name|SqlBasicFunction
...
argument_list|)
decl_stmt|;
comment|/** The {@code LAST_DAY(date)} function. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
argument_list|)
decl_stmt|;
comment|/**    * {@code PERCENTILE_DISC} inverse distribution aggregate function.    *    *<p>The argument must be a numeric literal in the range 0 to 1 inclusive    * (representing a percentage), and the return type is the type of the    * {@code ORDER BY} expression.    */
specifier|public
specifier|static
specifier|final
name|SqlAggFunction
...
argument_list|)
decl_stmt|;
comment|/**    * The INTERSECTION operator. Multiset aggregator function.    */
specifier|public
specifier|static
specifier|final
name|SqlAggFunction
...
block|}
decl_stmt|;
comment|/** DESCRIPTOR(column_name, ...). */
specifier|public
specifier|static
specifier|final
name|SqlOperator
...
block|}
block|}
comment|/** Returns the operator for {@code LIKE} with given case-sensitivity,    * optionally negated. */
specifier|public
specifier|static
name|SqlOperator
name|like
