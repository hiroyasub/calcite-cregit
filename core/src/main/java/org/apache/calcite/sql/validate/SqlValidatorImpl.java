...
name|projectMap
init|=
name|getConstraintForModifiableView
argument_list|(
name|modifiableViewTable
argument_list|,
name|targetRowType
...
block|}
block|}
comment|/**    * Ensures that a source value does not violate the constraint of the target column.    *    * @param table            The SqlValidatorTable which wraps a ModifiableViewTable.    * @param columnName       The target column name.    * @param sourceValue      The insert value being validated.    * @param targetConstraint The constraint applied to sourceValue for validation.    */
specifier|private
name|void
name|checkConstraint
parameter_list|(
...
block|{
block|}
comment|/**    * Throws a validator exception.    */
specifier|public
class|class
name|ValidationErrorFunction
implements|implements
...
return|;
block|}
comment|/**    * check all pattern var within one function is the same    */
specifier|private
name|SqlNode
name|navigationInDefine
parameter_list|(
...
block|}
block|}
comment|/**    * Expand navigation expression :    * eg: PREV(A.price + A.amount) to PREV(A.price) + PREV(A.amount)    * eg: FIRST(A.price * 2) to FIST(A.PRICE) * 2    */
specifier|private
class|class
name|NavigationExpander
extends|extends
...
block|}
block|}
comment|/**    * Replace {@code A as A.price> PREV(B.price)}    * with {@code PREV(A.price, 0)> last(B.price, 0)}.    */
specifier|private
class|class
name|NavigationReplacer
extends|extends
