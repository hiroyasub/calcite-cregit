...
argument_list|()
decl_stmt|;
comment|// If the INSERT does not have a target column list and the target
comment|// table specifies a custom star expansion list, we will set the new
comment|// target column list as the star expansion list.
name|rewriteTargetColumnList
argument_list|(
name|insert
argument_list|,
name|targetNamespace
