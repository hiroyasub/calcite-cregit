...
return|;
block|}
comment|/**    * Creates a single-operand checker that passes if the operand's type has a    * particular {@link SqlTypeName}.    */
specifier|public
specifier|static
...
return|return
operator|new
name|TypeNameChecker
argument_list|(
name|typeName
argument_list|)
return|;
block|}
comment|/**    * Creates a checker that passes if the operand is an interval appropriate for    * a given date/time type. For example, the time frame HOUR is appropriate for    * type TIMESTAMP or DATE but not TIME.    */
specifier|public
specifier|static
name|SqlSingleOperandTypeChecker
name|interval
...
return|;
block|}
comment|/**    * Creates a checker for DATE intervals (YEAR, WEEK, ISOWEEK,    * WEEK_WEDNESDAY, etc.)    */
specifier|public
specifier|static
name|SqlSingleOperandTypeChecker
name|dateInterval
...
return|;
block|}
comment|/**    * Creates a checker for TIME intervals (HOUR, SECOND, etc.)    */
specifier|public
specifier|static
name|SqlSingleOperandTypeChecker
name|timeInterval
...
return|;
block|}
comment|/**    * Creates a checker for TIMESTAMP intervals (YEAR, WEEK, ISOWEEK,    * WEEK_WEDNESDAY, HOUR, SECOND, etc.)    */
specifier|public
specifier|static
name|SqlSingleOperandTypeChecker
...
argument_list|)
decl_stmt|;
comment|/** Type-checker that matches "TIMESTAMP WITH LOCAL TIME ZONE" but not other    * members of the "TIMESTAMP" family (e.g. "TIMESTAMP"). */
specifier|public
specifier|static
specifier|final
name|SqlSingleOperandTypeChecker
...
argument_list|)
decl_stmt|;
comment|/** Type-checker that matches "TIMESTAMP" but not other members of the    * "TIMESTAMP" family (e.g. "TIMESTAMP WITH LOCAL TIME ZONE"). */
specifier|public
specifier|static
specifier|final
name|SqlSingleOperandTypeChecker
...
begin_comment
comment|/**    * Operand type-checking strategy used by {@code ARG_MIN(value, comp)} and    * similar functions, where the first operand can have any type and the second    * must be comparable.    */
end_comment
...
return|;
block_content|}
comment|// Scope is non-null at validate time, which is when we need to make
comment|// this check.
block|final @Nullable SqlValidatorScope scope = callBinding.getScope(
block|)
block|;
if|if
condition|(
...
begin_comment
comment|/** Checker that passes if the operand's type has a particular    * {@link SqlTypeName}. */
end_comment
...
parameter_list|)
block|{
comment|// FIXME we assume that there is exactly one operand
return|return
name|checkSingleOperandType
argument_list|(
name|callBinding
