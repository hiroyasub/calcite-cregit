...
name|validator
decl_stmt|;
comment|/** Computes and stores information that cannot be computed on construction,    * but only after sub-queries have been validated. */
annotation|@
...
literal|null
argument_list|,
literal|"resolve already in progress"
argument_list|)
expr_stmt|;
name|SqlValidatorUtil
operator|.
...
block|}
block|}
comment|/** Analyzes expressions in this scope and populates a    * {@code GroupAnalyzer}. */
specifier|protected
name|void
name|analyze
parameter_list|(
...
condition|)
block|{
comment|// Find all expressions in this scope that reference measures
for|for
control|(
name|ScopeChild
name|child
