...
if|if
condition|(
name|hasAmbiguousUnresolvedStar
argument_list|(
name|namespace
operator|.
name|getRowType
...
return|;
block|}
comment|/** Returns whether {@code rowType} contains more than one star column.    * Having more than one star columns implies ambiguous column. */
specifier|private
name|boolean
name|hasAmbiguousUnresolvedStar
parameter_list|(
