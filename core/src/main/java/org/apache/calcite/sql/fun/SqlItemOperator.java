...
begin_comment
comment|/**  * The item operator {@code [ ... ]}, used to access a given element of an  * array, map or struct. For example, {@code myArray[3]}, {@code "myMap['foo']"},  * {@code myStruct[2]} or {@code myStruct['fieldName']}.  */
end_comment
...
argument_list|()
argument_list|,
literal|"operandType.getKeyType()"
argument_list|)
decl_stmt|;
name|SqlTypeName
name|sqlTypeName
...
parameter_list|()
lambda|->
literal|"operandType.getValueType() is null for "
operator|+
name|operandType
argument_list|)
argument_list|,
...
name|AssertionError
argument_list|(
literal|"Cannot infer type of field at position "
operator|+
name|index
operator|+
literal|" within ROW type: "
...
name|AssertionError
argument_list|(
literal|"Unsupported field identifier type: '"
operator|+
name|indexType
operator|+
literal|"'"
