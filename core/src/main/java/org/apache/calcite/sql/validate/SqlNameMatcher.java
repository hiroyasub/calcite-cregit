...
parameter_list|)
function_decl|;
comment|/** Returns a copy of a collection, removing duplicates and retaining    * iteration order. */
specifier|default
name|List
argument_list|<
name|String
...
return|;
block|}
comment|/** Returns the index of the first element of a collection that matches. */
specifier|default
name|int
name|indexOf
parameter_list|(
