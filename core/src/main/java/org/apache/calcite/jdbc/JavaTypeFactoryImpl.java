...
condition|)
block|{
comment|// Transform to sql type, take care for two cases:
comment|// 1. type.getJavaClass() is collection with erased generic type
comment|// 2. ElementType returned by JavaType is also of JavaType,
comment|// and needs conversion using typeFactory
specifier|final
name|RelDataType
name|elementType
init|=
name|toSqlTypeWithNullToAny
argument_list|(
name|typeFactory
argument_list|,
name|type
