...
parameter_list|)
function_decl|;
comment|/** Adds implicit type names to a builder. */
specifier|protected
specifier|abstract
name|void
...
return|;
block|}
comment|/** Defines a type within this schema. */
specifier|public
name|TypeEntry
name|add
parameter_list|(
...
return|;
block|}
comment|/** Returns a subset of a map whose keys match the given string    * case-insensitively.    * @deprecated use NameMap    */
annotation|@
name|Deprecated
...
return|;
block|}
comment|/** Returns a subset of a set whose values match the given string    * case-insensitively.    * @deprecated use NameSet    */
annotation|@
name|Deprecated
comment|// to be removed before 2.0
specifier|protected
...
function_decl|;
block|}
comment|/** Membership of a type in a schema. */
specifier|public
specifier|abstract
specifier|static
class|class
...
block|}
block|}
comment|/**    * Implementation of {@link TypeEntry}    * where all properties are held in fields.    */
specifier|public
specifier|static
class|class
name|TypeEntryImpl
...
name|protoDataType
decl_stmt|;
comment|/** Creates a TypeEntryImpl. */
specifier|public
name|TypeEntryImpl
parameter_list|(
name|CalciteSchema
