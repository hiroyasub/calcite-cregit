...
name|ROOT
decl_stmt|;
comment|// Give a hook chance to alter standard input, output, error streams.
specifier|final
name|Holder
argument_list|<
name|Object
...
argument_list|()
decl_stmt|;
comment|// This duplicates org.apache.calcite.prepare.CalcitePrepareImpl.prepare2_
specifier|final
name|SqlParser
operator|.
name|Config
