...
throw|;
block|}
comment|/**    * Copy the {@link org.apache.calcite.rel.hint.RelHint}s from {@code originalRel}    * to {@code newRel} if both of them are {@link Hintable}.    *    *<p>The hints are also filtered by the specified hint strategies.    *    * @param originalRel Original relational expression    * @param newRel      New relational expression    * @return A copy of {@code newRel} with hints of {@code originalRel}, or {@code newRel}    * directly if one of them are not {@link Hintable}    */
specifier|public
specifier|static
name|RelNode
name|copyRelHints
...
argument_list|()
decl_stmt|;
comment|// Keep all the hints of project node for 2 reasons:
