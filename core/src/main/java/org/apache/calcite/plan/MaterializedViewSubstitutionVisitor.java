...
block|}
block|}
comment|/**    * Implementation of {@link SubstitutionVisitor.UnifyRule} that matches a    * {@link MutableUnion} to a {@link MutableUnion} where the query and target    * have the same inputs but might not have the same order.    */
specifier|private
specifier|static
class|class
name|UnionToUnionRule
