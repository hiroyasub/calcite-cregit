...
return|;
block|}
comment|/**    * Returns how to deduce whether a particular {@link RexNode} expression is null,    * given whether its arguments are null.    */
specifier|public
specifier|static
name|Policy
name|policy
...
return|;
block|}
comment|/**    * Returns whether a given expression is strong.    *    *<p>Examples:</p>    *<ul>    *<li>Returns true for {@code c = 1} since it returns null if and only if    *   c is null    *<li>Returns false for {@code c IS NULL} since it always returns TRUE    *   or FALSE    *</ul>    *    * @param e Expression    * @return true if the expression is strong, false otherwise    */
specifier|public
specifier|static
name|boolean
name|isStrong
...
return|;
block|}
comment|/** Returns whether all expressions in a list are strong. */
specifier|public
specifier|static
name|boolean
name|allStrong
...
condition|)
block|{
comment|//TODO Enrich with more possible cases?
case|case
name|IS_NOT_NULL
case|:
return|return
...
block|}
block|}
comment|/** Returns whether all expressions in a list are definitely not true. */
specifier|private
name|boolean
name|allNotTrue
parameter_list|(
...
return|;
block|}
comment|/** Returns whether any expressions in a list are definitely not true. */
specifier|private
name|boolean
name|anyNotTrue
parameter_list|(
