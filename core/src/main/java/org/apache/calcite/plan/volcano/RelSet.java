...
name|rel
decl_stmt|;
comment|/**    * The position indicator of rel node that is to be processed.    */
specifier|private
name|int
name|relCursor
init|=
literal|0
decl_stmt|;
comment|/**    * The relnodes after applying logical rules and physical rules,    * before trait propagation and enforcement.    */
specifier|final
name|Set
argument_list|<
name|RelNode
...
condition|)
block|{
comment|// enforcer may be manually created for some reason
if|if
condition|(
name|relCursor
operator|<
