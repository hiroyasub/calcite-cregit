...
name|rel
decl_stmt|;
comment|/**    * Exploring state of current RelSet.    */
annotation|@
name|Nullable
name|ExploringState
name|exploringState
decl_stmt|;
comment|/**    * Records conversions / enforcements that have happened on the    * pair of derived and required traitset.    */
specifier|final
name|Set
argument_list|<
name|Pair
...
parameter_list|()
lambda|->
literal|"convention is null for "
operator|+
name|subset
argument_list|)
decl_stmt|;
...
literal|null
assert|;
comment|// propagate the new best information from changed relNodes.
for|for
control|(
name|RelNode
name|rel
...
comment|/**    * An enum representing exploring state of current RelSet.    */
enum|enum
name|ExploringState
block|{
comment|/**      * The RelSet is exploring.      * It means all possible rule matches are scheduled, but not fully applied.      * This RelSet will refuse to explore again, but cannot provide a valid LB.      */
name|EXPLORING
block|,
comment|/**      * The RelSet is fully explored and is able to provide a valid LB.      */
name|EXPLORED
block|}
block|}
end_class
