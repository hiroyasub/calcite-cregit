...
begin_comment
comment|/**  * The digest is the exact representation of the corresponding {@code RelNode},  * at anytime, anywhere. The only difference is that digest is compared using  * {@code #equals} and {@code #hashCode}, which are prohibited for RelNode,  * for legacy reasons.  *  *<p>It is highly recommended to override {@link AbstractRelNode#digestHash}  * and {@link AbstractRelNode#digestEquals(Object)}, instead of relying on  * {@link AbstractRelNode#explainTerms(RelWriter)}, which is used as the  * default source for equivalent comparison, for backward compatibility.</p>  *  *<p>INTERNAL USE ONLY.</p>  *  * @see AbstractRelNode#digestHash()  * @see AbstractRelNode#digestEquals(Object)  */
end_comment
