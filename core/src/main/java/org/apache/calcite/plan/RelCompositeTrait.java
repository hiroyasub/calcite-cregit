...
name|trait
decl_stmt|;
comment|// This trait should be the same or stricter, so this trait should satisfy each component
for|for
control|(
name|T
name|t
...
return|;
block|}
comment|// This trait might be stricter, so at least one component should satisfy given trait
for|for
control|(
name|T
name|t
