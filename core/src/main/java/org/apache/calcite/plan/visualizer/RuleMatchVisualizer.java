...
argument_list|()
decl_stmt|;
comment|/**    * Use this constructor to save the result on disk at the end of the planning phase.    *<p>    * Note: when using HepPlanner, {@link #writeToFile()} needs to be called manually.    *</p>    */
specifier|public
name|RuleMatchVisualizer
parameter_list|(
name|String
