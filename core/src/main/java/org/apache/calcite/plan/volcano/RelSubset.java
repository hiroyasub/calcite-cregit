...
name|timestamp
decl_stmt|;
comment|/**    * Physical property state of current subset    * 0: logical operators, NONE convention is neither DERIVED nor REQUIRED    * 1: traitSet DERIVED from child operators or itself    * 2: traitSet REQUIRED from parent operators    * 3: both DERIVED and REQUIRED    */
specifier|private
name|int
name|state
init|=
