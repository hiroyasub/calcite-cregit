...
expr_stmt|;
block|}
comment|// we need to sort at most rowCount rows
name|toSort
operator|=
name|Math
operator|.
...
argument_list|)
expr_stmt|;
comment|// we need to process rowCount rows, and for every row
comment|// we search the key in a TreeMap with at most toSort entries
specifier|final
name|double
name|lookup
init|=
