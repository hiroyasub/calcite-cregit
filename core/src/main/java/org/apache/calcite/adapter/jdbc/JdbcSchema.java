...
condition|)
block|{
comment|// From JDBC 4.1, catalog and schema can be retrieved from the connection object,
comment|// hence try to get it from there if it was not specified by user
name|catalog
operator|=
name|Util
operator|.
