...
return|;
block|}
comment|/**    * The powerful version of {@code org.apache.calcite.linq4j.tree.Expressions#call(    * Type, String, Iterable<? extends Expression>)}. Try best effort to convert the    * accepted arguments to match parameter type.    *    * @param clazz Class against which method is invoked    * @param methodName Name of method    * @param arguments argument expressions    * @param targetExpression target expression    *    * @return MethodCallExpression that call the given name method    * @throws RuntimeException if no suitable method found    */
specifier|public
specifier|static
name|MethodCallExpression
name|call
...
return|;
block|}
comment|/** Generates a window selector which appends attribute of the window based on    * the parameters. */
specifier|static
name|Expression
