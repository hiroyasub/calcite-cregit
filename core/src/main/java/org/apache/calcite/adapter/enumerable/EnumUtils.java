...
condition|)
block|{
comment|// Actual join type does not matter much, joinSelector would skip selection
comment|// of the columns that are not required (see if (expressions.size() == outputFieldCount) {)
name|joinRelType
operator|=
name|JoinRelType
operator|.
