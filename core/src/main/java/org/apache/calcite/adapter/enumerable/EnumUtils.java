...
return|;
block|}
comment|/** Returns a function that converts an internal value to an external    * value.    *    *<p>Datetime values' internal representations have no time zone,    * and their external values are moments (relative to UTC epoch),    * so the {@code timeZone} parameter supplies the implicit time zone of    * the internal representation. If you specify the local time zone of the    * JVM, then {@link Timestamp#toString}, {@link Date#toString()}, and    * {@link Time#toString()} on the external values will give a value    * consistent with the internal values. */
specifier|public
specifier|static
name|Function
argument_list|<
...
block|}
block|}
comment|/** Returns a function that converts an array of internal values to    * a list of external values. */
annotation|@
