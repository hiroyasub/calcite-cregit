...
condition|)
block|{
comment|// Convert Enumerable<Row> to Enumerable<SyntheticRecord>
for|for
control|(
name|int
name|i
...
condition|)
block|{
comment|// Convert Enumerable<Object[]> to Enumerable<SyntheticRecord>
for|for
control|(
name|int
name|i
...
block|}
block|}
comment|/** Relational expression that executes its children using an interpreter.    *    *<p>Although quite a few kinds of {@link RelNode} can be interpreted,    * this is only created by default for {@link FilterableTable}    * and {@link ProjectableFilterableTable}.    */
specifier|public
specifier|static
class|class
