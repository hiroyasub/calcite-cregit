...
return|;
block|}
comment|/**    * Used for safe operators that return null if an exception is thrown.    */
specifier|private
specifier|static
name|Expression
name|expressionHandlingSafe
parameter_list|(
name|Expression
name|body
parameter_list|,
...
name|convert2
init|=
name|checkExpressionPadTruncate
argument_list|(
name|convert
argument_list|,
name|sourceType
...
return|;
block|}
comment|// Checkstyle thinks that the previous branch should have a break, but it
comment|// is mistaken.
