...
argument_list|()
decl_stmt|;
comment|// The conversion must be strict so optimizations of the targetFormat should not be performed
comment|// by the code that follows. If necessary the target format can be optimized before calling
comment|// this method.
name|PhysType
name|targetPhysType
init|=
