...
throw|;
block|}
comment|/** Returns a function that, given a {@link ResultSet}, returns a function    * that will yield successive rows from that result set. */
specifier|static
name|Function1
argument_list|<
name|ResultSet
...
return|;
block|}
comment|/** Returns a function that, given a {@link ResultSet}, returns a function    * that will yield successive rows from that result set;    * as {@link #rowBuilderFactory(List)} except that values are in Calcite's    * internal format (e.g. DATE represented as int). */
specifier|static
name|Function1
argument_list|<
name|ResultSet
...
block|}
block|}
comment|/** Row builder that shifts DATE, TIME, TIMESTAMP values into local time    * zone. */
specifier|static
class|class
name|ObjectArrayRowBuilder1
extends|extends
...
block|}
block|}
comment|/** Row builder that converts JDBC values into internal values. */
specifier|static
class|class
name|ObjectArrayRowBuilder2
extends|extends
