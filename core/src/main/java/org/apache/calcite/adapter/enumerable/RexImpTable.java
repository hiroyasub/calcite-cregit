...
block|}
block|}
comment|/** Implements PREV match-recognize function. */
specifier|private
specifier|static
class|class
name|PrevImplementor
...
block|}
block|}
comment|/** Implements per-key sessionization. */
specifier|private
specifier|static
class|class
name|SessionImplementor
