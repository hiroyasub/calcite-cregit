...
name|ZERO
decl_stmt|;
comment|/** Oracle's {@code SUBSTR} function.    * Oracle does not support {@link SqlStdOperatorTable#SUBSTRING}. */
specifier|public
specifier|static
specifier|final
name|SqlFunction
...
name|aliases
decl_stmt|;
comment|/** Creates an AliasContext; use {@link #aliasContext(List, boolean)}. */
specifier|private
name|AliasContext
parameter_list|(
name|List
