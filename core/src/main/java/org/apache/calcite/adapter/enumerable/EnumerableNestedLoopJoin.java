...
return|;
block|}
comment|// EnumerableNestedLoopJoin traits passdown shall only pass through collation to left input.
comment|// It is because for EnumerableNestedLoopJoin always uses left input as the outer loop,
comment|// thus only left input can preserve ordering.
