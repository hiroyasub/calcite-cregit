...
argument_list|()
decl_stmt|;
comment|// nested ROW type is always represented as array.
if|if
condition|(
name|field0Type
operator|.
...
return|;
block|}
comment|/** Returns a reference to a particular field.    *    *<p>{@code fromType} may be null; if null, uses the natural type of the    * field.    */
specifier|public
specifier|abstract
name|Expression
name|field
