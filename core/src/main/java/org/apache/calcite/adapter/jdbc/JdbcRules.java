...
argument_list|()
argument_list|,
literal|"JdbcProject does not allow variables"
argument_list|)
expr_stmt|;
specifier|final
name|RelOptCluster
...
argument_list|()
argument_list|,
literal|"JdbcFilter does not allow variables"
argument_list|)
expr_stmt|;
return|return
operator|new
...
block|}
decl_stmt|;
comment|/** A {@link RelBuilderFactory} that creates a {@link RelBuilder} that will    * create JDBC relational expressions for everything. */
specifier|public
specifier|static
specifier|final
name|RelBuilderFactory
...
argument_list|)
decl_stmt|;
comment|/** Creates a list of rules with the given JDBC convention instance. */
specifier|public
specifier|static
name|List
argument_list|<
...
return|;
block|}
comment|/** Creates a list of rules with the given JDBC convention instance    * and builder factory. */
specifier|public
specifier|static
name|List
argument_list|<
...
name|JdbcConverterRule
block|{
comment|/** Creates a JdbcToEnumerableConverterRule. */
specifier|public
specifier|static
name|JdbcTableModificationRule
name|create
