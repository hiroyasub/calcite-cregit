...
block|}
block|}
comment|/**      * Returns whether a condition is supported by {@link JdbcJoin}.      *      *<p>Corresponds to the capabilities of      * {@link JdbcJoin#convertConditionToSqlNode}.      *      * @param node Condition      * @return Whether condition is supported      */
specifier|private
name|boolean
name|canJoinOnCondition
parameter_list|(
...
argument_list|(
literal|"not supported: offset or fetch"
argument_list|)
throw|;
block|}
return|return
