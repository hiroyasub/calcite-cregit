...
control|)
block|{
comment|// Check if type collations match, otherwise store it in this bitset to generate a cast later
comment|// to guarantee that all inputs will be sorted in the same way
specifier|final
name|ImmutableBitSet
operator|.
name|Builder
name|fieldsRequiringCastBuilder
init|=
name|ImmutableBitSet
operator|.
name|builder
...
block|{
comment|// At least one cast is required, generate the corresponding projection
name|builder
operator|.
name|push
argument_list|(
