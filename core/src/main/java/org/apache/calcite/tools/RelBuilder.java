...
argument_list|()
operator|&&
name|isNotRestructuringProjection
argument_list|(
name|frame
operator|.
name|rel
...
return|;
block|}
comment|/**    * Restructuring projection is when inputProjection returns flat type    * but new projection collects flatten types back into struct columns.    * Given method negates the condition to know whether projects can be merged.    *    * @param inputProjectionType input projection result type    * @param newProjects         new projections    * @return whether new projections don't do restructuring    * (collection of flattened fields back into struct fields)    */
specifier|private
name|boolean
name|isNotRestructuringProjection
parameter_list|(
name|RelDataType
name|inputProjectionType
parameter_list|,
name|List
argument_list|<
name|RexNode
