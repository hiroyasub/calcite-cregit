...
condition|)
block|{
comment|// more efficient than starting an iterator
return|return
name|Objects
operator|.
name|requireNonNull
...
return|;
block|}
comment|/** Evaluates an expression with a relational expression temporarily on the    * stack. */
specifier|public
parameter_list|<
name|E
parameter_list|>
...
block|}
block|}
comment|/** Performs an action with a temporary simplifier. */
specifier|public
parameter_list|<
name|E
parameter_list|>
...
block|}
block|}
comment|/** Performs an action using predicates of    * the {@link #peek() current node} to simplify. */
specifier|public
parameter_list|<
name|E
parameter_list|>
...
return|;
block|}
comment|/** Creates an IN predicate with a list of values.    *    *<p>For example,    *<pre>{@code    * b.scan("Emp")    *     .filter(b.in(b.field("deptno"), b.literal(10), b.literal(20)))    * }</pre>    * is equivalent to SQL    *<pre>{@code    * SELECT *    * FROM Emp    * WHERE deptno IN (10, 20)    * }</pre> */
specifier|public
name|RexNode
name|in
parameter_list|(
...
return|;
block|}
comment|/** Creates an IN predicate with a list of values.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Emps")    *     .filter(    *         b.in(b.field("deptno"),    *             Arrays.asList(b.literal(10), b.literal(20))))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT *    * FROM Emps    * WHERE deptno IN (10, 20)    * }</pre> */
specifier|public
name|RexNode
name|in
parameter_list|(
...
return|;
block|}
comment|/** Creates an IN predicate with a sub-query. */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates a SOME (or ANY) predicate.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Emps")    *     .filter(    *         b.some(b.field("commission"),    *             SqlStdOperatorTable.GREATER_THAN,    *             b2 -> b2.scan("Emps")    *                 .filter(    *                     b2.eq(b2.field("job"), b2.literal("Manager")))    *                 .project(b2.field("sal"))    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT *    * FROM Emps    * WHERE commission> SOME (SELECT sal FROM Emps WHERE job = 'Manager')    * }</pre>    *    *<p>or (since {@code SOME} and {@code ANY} are synonyms) the SQL    *    *<pre>{@code    * SELECT *    * FROM Emps    * WHERE commission> ANY (SELECT sal FROM Emps WHERE job = 'Manager')    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates an ALL predicate.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Emps")    *     .filter(    *         b.all(b.field("commission"),    *             SqlStdOperatorTable.GREATER_THAN,    *             b2 -> b2.scan("Emps")    *                 .filter(    *                     b2.eq(b2.field("job"), b2.literal("Manager")))    *                 .project(b2.field("sal"))    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT *    * FROM Emps    * WHERE commission> ALL (SELECT sal FROM Emps WHERE job = 'Manager')    * }</pre>    *    *<p>Calcite translates {@code ALL} predicates to {@code NOT SOME}. The    * following SQL is equivalent to the previous:    *    *<pre>{@code    * SELECT *    * FROM Emps    * WHERE NOT (commission<= SOME (SELECT sal FROM Emps WHERE job = 'Manager'))    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexNode
...
return|;
block|}
comment|/** Creates an EXISTS predicate.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Depts")    *     .filter(    *         b.exists(b2 ->    *             b2.scan("Emps")    *                 .filter(    *                     b2.eq(b2.field("job"), b2.literal("Manager")))    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT *    * FROM Depts    * WHERE EXISTS (SELECT 1 FROM Emps WHERE job = 'Manager')    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates a UNIQUE predicate.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Depts")    *     .filter(    *         b.exists(b2 ->    *             b2.scan("Emps")    *                 .filter(    *                     b2.eq(b2.field("job"), b2.literal("Manager")))    *                 .project(b2.field("deptno")    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT *    * FROM Depts    * WHERE UNIQUE (SELECT deptno FROM Emps WHERE job = 'Manager')    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates a scalar sub-query.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Depts")    *     .project(    *         b.field("deptno")    *         b.scalarQuery(b2 ->    *             b2.scan("Emps")    *                 .aggregate(    *                     b2.eq(b2.field("job"), b2.literal("Manager")))    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT deptno, (SELECT MAX(sal) FROM Emps)    * FROM Depts    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates an ARRAY sub-query.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Depts")    *     .project(    *         b.field("deptno")    *         b.arrayQuery(b2 ->    *             b2.scan("Emps")    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT deptno, ARRAY (SELECT * FROM Emps)    * FROM Depts    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates a MULTISET sub-query.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Depts")    *     .project(    *         b.field("deptno")    *         b.multisetQuery(b2 ->    *             b2.scan("Emps")    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT deptno, MULTISET (SELECT * FROM Emps)    * FROM Depts    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates a MAP sub-query.    *    *<p>For example,    *    *<pre>{@code    * b.scan("Depts")    *     .project(    *         b.field("deptno")    *         b.multisetQuery(b2 ->    *             b2.scan("Emps")    *                 .project(b2.field("empno"), b2.field("job"))    *                 .build()))    * }</pre>    *    *<p>is equivalent to the SQL    *    *<pre>{@code    * SELECT deptno, MAP (SELECT empno, job FROM Emps)    * FROM Depts    * }</pre> */
annotation|@
name|Experimental
specifier|public
name|RexSubQuery
...
return|;
block|}
comment|/** Creates an expression equivalent to "{@code o0 IS NOT DISTINCT FROM o1}".    * It is also equivalent to    * "{@code o0 = o1 OR (o0 IS NULL AND o1 IS NULL)}". */
specifier|public
name|RexNode
...
return|;
block|}
comment|/** Creates an expression equivalent to {@code o0 IS DISTINCT FROM o1}.    * It is also equivalent to    * "{@code NOT (o0 = o1 OR (o0 IS NULL AND o1 IS NULL))}. */
specifier|public
name|RexNode
name|isDistinctFrom
parameter_list|(
...
return|;
block|}
comment|// Methods that create window bounds
comment|/** Creates an {@code UNBOUNDED PRECEDING} window bound,    * for use in methods such as {@link OverCall#rowsFrom(RexWindowBound)}    * and {@link OverCall#rangeBetween(RexWindowBound, RexWindowBound)}. */
specifier|public
name|RexWindowBound
...
return|;
block|}
comment|/** Creates a {@code bound PRECEDING} window bound,    * for use in methods such as {@link OverCall#rowsFrom(RexWindowBound)}    * and {@link OverCall#rangeBetween(RexWindowBound, RexWindowBound)}. */
specifier|public
name|RexWindowBound
name|preceding
parameter_list|(
...
return|;
block|}
comment|/** Creates a {@code CURRENT ROW} window bound,    * for use in methods such as {@link OverCall#rowsFrom(RexWindowBound)}    * and {@link OverCall#rangeBetween(RexWindowBound, RexWindowBound)}. */
specifier|public
name|RexWindowBound
name|currentRow
parameter_list|()
...
return|;
block|}
comment|/** Creates a {@code bound FOLLOWING} window bound,    * for use in methods such as {@link OverCall#rowsFrom(RexWindowBound)}    * and {@link OverCall#rangeBetween(RexWindowBound, RexWindowBound)}. */
specifier|public
name|RexWindowBound
name|following
parameter_list|(
...
return|;
block|}
comment|/** Creates an {@code UNBOUNDED FOLLOWING} window bound,    * for use in methods such as {@link OverCall#rowsFrom(RexWindowBound)}    * and {@link OverCall#rangeBetween(RexWindowBound, RexWindowBound)}. */
specifier|public
name|RexWindowBound
...
return|;
block|}
comment|/**    * Creates a {@link Filter} of a list of correlation variables    * and a list of predicates.    *    *<p>The predicates are combined using AND,    * and optimized in a similar way to the {@link #and} method.    * If simplification is on and the result is TRUE, no filter is created. */
specifier|public
name|RelBuilder
name|filter
parameter_list|(
...
return|;
block|}
comment|/**    * The same with {@link #project(Iterable, Iterable, boolean)}, with additional    * variablesSet param.    *    * @param nodes Expressions    * @param fieldNames Suggested field names    * @param force create project even if it is identity    * @param variablesSet Correlating variables that are set when reading a row    *                     from the input, and which may be referenced from the    *                     projection expressions    */
specifier|public
name|RelBuilder
name|project
argument_list|(
...
expr_stmt|;
block|}
comment|// Do not merge projection when top projection has correlation variables
name|bloat
label|:
if|if
condition|(
...
argument_list|)
expr_stmt|;
comment|// Keep bottom projection's variablesSet.
return|return
name|project_
argument_list|(
name|newNodes
...
name|IllegalArgumentException
argument_list|(
literal|"group sets contained expressions "
operator|+
literal|"not in group key: "
operator|+
name|Util
operator|.
name|skip
...
begin_comment
comment|/** Creates a {@link Sort} by a list of expressions, with limitNode and offsetNode.    *    * @param offsetNode RexLiteral means number of rows to skip is deterministic,    *                   RexDynamicParam means number of rows to skip is dynamic.    * @param fetchNode  RexLiteral means maximum number of rows to fetch is deterministic,    *                   RexDynamicParam mean maximum number is dynamic.    * @param nodes      Sort expressions    */
end_comment
...
name|IllegalArgumentException
argument_list|(
literal|"OFFSET node must be RexLiteral or RexDynamicParam"
argument_list|)
throw|;
block|}
block|}
...
name|IllegalArgumentException
argument_list|(
literal|"FETCH node must be RexLiteral or RexDynamicParam"
argument_list|)
throw|;
block|}
block|}
...
return|;
block|}
comment|/** Returns a copy of this AggCall that makes its input values unique by      * {@code distinctKeys} before aggregating, as in SQL's      * {@code WITHIN DISTINCT} clause. */
name|AggCall
name|unique
parameter_list|(
annotation|@
...
return|;
block|}
comment|/** Converts this aggregate call to a windowed aggregate call. */
name|OverCall
name|over
parameter_list|()
function_decl|;
...
begin_comment
comment|/**    * Checks for {@link CorrelationId}, then validates the id is not used on left,    * and finally checks if id is actually used on right.    *    * @return true if a correlate id is present and used    *    * @throws IllegalArgumentException if the {@link CorrelationId} is used by left side or if the a    *   {@link CorrelationId} is present and the {@link JoinRelType} is FULL or RIGHT.    */
end_comment
...
begin_comment
comment|/** Call to a windowed aggregate function.    *    *<p>To create an {@code OverCall}, start with an {@link AggCall} (created    * by a method such as {@link #aggregateCall}, {@link #sum} or {@link #count})    * and call its {@link AggCall#over()} method. For example,    *    *<pre>{@code    *      b.scan("EMP")    *         .project(b.field("DEPTNO"),    *            b.aggregateCall(SqlStdOperatorTable.ROW_NUMBER)    *               .over()    *               .partitionBy()    *               .orderBy(b.field("EMPNO"))    *               .rowsUnbounded()    *               .allowPartial(true)    *               .nullWhenCountZero(false)    *               .as("x"))    * }</pre>    *    *<p>Unlike an aggregate call, a windowed aggregate call is an expression    * that you can use in a {@link Project} or {@link Filter}. So, to finish,    * call {@link OverCall#toRex()} to convert the {@code OverCall} to a    * {@link RexNode}; the {@link OverCall#as} method (used in the above example)    * does the same but also assigns an column alias.    */
end_comment
...
name|OverCall
block|{
comment|/** Performs an action on this OverCall. */
specifier|default
parameter_list|<
name|R
parameter_list|>
...
return|;
block|}
comment|/** Sets the PARTITION BY clause to an array of expressions. */
name|OverCall
name|partitionBy
parameter_list|(
name|RexNode
...
parameter_list|)
function_decl|;
comment|/** Sets the PARTITION BY clause to a list of expressions. */
name|OverCall
name|partitionBy
parameter_list|(
name|Iterable
...
parameter_list|)
function_decl|;
comment|/** Sets the ORDER BY BY clause to an array of expressions.      *      *<p>Use {@link #desc(RexNode)}, {@link #nullsFirst(RexNode)},      * {@link #nullsLast(RexNode)} to control the sort order. */
name|OverCall
name|orderBy
parameter_list|(
name|RexNode
...
parameter_list|)
function_decl|;
comment|/** Sets the ORDER BY BY clause to a list of expressions.      *      *<p>Use {@link #desc(RexNode)}, {@link #nullsFirst(RexNode)},      * {@link #nullsLast(RexNode)} to control the sort order. */
name|OverCall
name|orderBy
parameter_list|(
name|Iterable
...
parameter_list|)
function_decl|;
comment|/** Sets an unbounded ROWS window,      * equivalent to SQL {@code ROWS BETWEEN UNBOUNDED PRECEDING AND      * UNBOUNDED FOLLOWING}. */
specifier|default
name|OverCall
name|rowsUnbounded
parameter_list|()
...
return|;
block|}
comment|/** Sets a ROWS window with a lower bound,      * equivalent to SQL {@code ROWS BETWEEN lower AND CURRENT ROW}. */
specifier|default
name|OverCall
name|rowsFrom
parameter_list|(
...
return|;
block|}
comment|/** Sets a ROWS window with an upper bound,      * equivalent to SQL {@code ROWS BETWEEN CURRENT ROW AND upper}. */
specifier|default
name|OverCall
name|rowsTo
parameter_list|(
...
return|;
block|}
comment|/** Sets a RANGE window with lower and upper bounds,      * equivalent to SQL {@code ROWS BETWEEN lower ROW AND upper}. */
name|OverCall
name|rowsBetween
parameter_list|(
name|RexWindowBound
...
parameter_list|)
function_decl|;
comment|/** Sets an unbounded RANGE window,      * equivalent to SQL {@code RANGE BETWEEN UNBOUNDED PRECEDING AND      * UNBOUNDED FOLLOWING}. */
specifier|default
name|OverCall
name|rangeUnbounded
parameter_list|()
...
return|;
block|}
comment|/** Sets a RANGE window with a lower bound,      * equivalent to SQL {@code RANGE BETWEEN lower AND CURRENT ROW}. */
specifier|default
name|OverCall
name|rangeFrom
parameter_list|(
...
return|;
block|}
comment|/** Sets a RANGE window with an upper bound,      * equivalent to SQL {@code RANGE BETWEEN CURRENT ROW AND upper}. */
specifier|default
name|OverCall
name|rangeTo
parameter_list|(
...
return|;
block|}
comment|/** Sets a RANGE window with lower and upper bounds,      * equivalent to SQL {@code RANGE BETWEEN lower ROW AND upper}. */
name|OverCall
name|rangeBetween
parameter_list|(
name|RexWindowBound
...
parameter_list|)
function_decl|;
comment|/** Sets whether to allow partial width windows; default true. */
name|OverCall
name|allowPartial
parameter_list|(
name|boolean
...
parameter_list|)
function_decl|;
comment|/** Sets whether the aggregate function should evaluate to null if no rows      * are in the window; default false. */
name|OverCall
...
parameter_list|)
function_decl|;
comment|/** Sets the alias of this expression, and converts it to a {@link RexNode};      * default is the alias that was set via {@link AggCall#as(String)}. */
name|RexNode
name|as
parameter_list|(
name|String
...
parameter_list|)
function_decl|;
comment|/** Converts this expression to a {@link RexNode}. */
name|RexNode
name|toRex
parameter_list|()
function_decl|;
...
begin_comment
comment|/** Implementation of {@link OverCall}. */
end_comment
...
expr_stmt|;
block|}
comment|/** Creates an OverCallImpl with default settings. */
name|OverCallImpl
parameter_list|(
name|SqlAggFunction
name|op
