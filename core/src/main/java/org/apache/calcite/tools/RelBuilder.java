...
block|{
comment|// There are duplicate aggregate calls.
specifier|final
name|Set
argument_list|<
name|AggregateCall
...
return|;
block|}
comment|/**    * Creates a {@link TableSpool} for the most recent relational expression.    *    * @param readType Spool's read type (as described in {@link Spool.Type})    * @param writeType Spool's write type (as described in {@link Spool.Type})    * @param tableName Table name    */
specifier|private
name|RelBuilder
name|tableSpool
parameter_list|(
...
block|}
block|}
comment|/** Configuration of RelBuilder.    *    *<p>It is immutable, and all fields are public.    *    *<p>Use the {@link #DEFAULT} instance,    * or call {@link #builder()} to create a builder then    * {@link RelBuilder.ConfigBuilder#build()}. You can also use    * {@link #toBuilder()} to modify a few properties of an existing Config. */
specifier|public
specifier|static
class|class
name|Config
...
argument_list|)
decl_stmt|;
comment|/** Whether {@link RelBuilder#aggregate} should eliminate duplicate      * aggregate calls; default true but currently disabled. */
specifier|public
specifier|final
name|boolean
name|dedupAggregateCalls
...
name|simplify
decl_stmt|;
comment|// called only from ConfigBuilder and when creating DEFAULT;
comment|// parameters and fields must be in alphabetical order
specifier|private
name|Config
parameter_list|(
name|boolean
...
expr_stmt|;
block|}
comment|/** Creates a ConfigBuilder with all properties set to their default      * values. */
specifier|public
specifier|static
name|ConfigBuilder
name|builder
...
return|;
block|}
comment|/** Creates a ConfigBuilder with properties set to the values in this      * Config. */
specifier|public
name|ConfigBuilder
name|toBuilder
parameter_list|()
