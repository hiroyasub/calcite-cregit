...
return|;
block|}
comment|/** @deprecated Use {@link #groupKey(ImmutableBitSet, ImmutableList)}. */
annotation|@
name|Deprecated
...
argument_list|)
expr_stmt|;
comment|// If, after de-duplication, the field names are unchanged, discard the
comment|// identity project we just created.
if|if
condition|(
name|peek
argument_list|()
