...
return|;
block|}
comment|/** Creates a call to an aggregate function.    *    *<p>To add other operands, apply    * {@link AggCall#filter(RexNode...)},    * {@link AggCall#distinct()},    * {@link AggCall#as},    * {@link AggCall#sort} to the result. */
specifier|public
name|AggCall
name|aggregateCall
parameter_list|(
