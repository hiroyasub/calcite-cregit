...
return|;
block|}
comment|/**    * Creates a connection with a given query provider. If provider is null,    * uses the connection as its own provider. The connection contains a    * schema called "foodmart" backed by a JDBC connection to MySQL.    *    * @param withClone Whether to create a "foodmart2" schema as in-memory    *     clone    * @return Connection    * @throws ClassNotFoundException    * @throws java.sql.SQLException    */
specifier|static
name|OptiqConnection
name|getConnection
parameter_list|(
...
block|}
block|}
comment|/** Checks that when the query (which was set using      * {@link AssertThat#query(String)}) is converted to a relational algrebra      * expression matching the given string. */
specifier|public
name|AssertQuery
