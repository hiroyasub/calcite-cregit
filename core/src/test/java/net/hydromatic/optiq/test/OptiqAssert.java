...
name|DATE
case|:
comment|// Avoid differences between SQL datetime formats and Java datetime
comment|// formats, and in particular automatic offset into local timezone, by
comment|// going straight from int to String, avoiding java.sql.Date, Time and
comment|// Timestamp.
specifier|final
name|int
name|date
