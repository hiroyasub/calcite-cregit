...
argument_list|)
expr_stmt|;
comment|// Now with milliseconds ending in zero (3 equivalent strings).
specifier|final
name|TimestampString
name|ts3
init|=
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.01"
argument_list|)
argument_list|)
expr_stmt|;
specifier|final
...
name|TimestampString
argument_list|(
literal|"1969-07-21 02:56:15.010"
argument_list|)
decl_stmt|;
name|assertThat
argument_list|(
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.000000056"
argument_list|)
argument_list|)
expr_stmt|;
comment|// Check rounding; uses RoundingMode.DOWN
specifier|final
name|TimestampString
name|ts5
init|=
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.00234567"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.0023"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.00234"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.002345"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
name|is
argument_list|(
literal|"1969-07-21 02:56:15.102030405060708090102"
argument_list|)
argument_list|)
expr_stmt|;
comment|// From milliseconds
specifier|final
name|TimestampString
name|ts7
init|=
...
name|is
argument_list|(
literal|"2016-02-26 19:06:00.12"
argument_list|)
argument_list|)
expr_stmt|;
specifier|final
...
name|is
argument_list|(
literal|"2016-02-26 19:06:00.987654321"
argument_list|)
argument_list|)
expr_stmt|;
comment|// TimestampString.toCalendar
specifier|final
name|Calendar
name|c
init|=
...
argument_list|)
expr_stmt|;
comment|// TimestampString.fromCalendarFields
name|c
operator|.
name|set
argument_list|(
...
name|is
argument_list|(
literal|"1969-02-26 19:06:00.987"
argument_list|)
argument_list|)
expr_stmt|;
name|assertThat
...
expr_stmt|;
block|}
comment|/** Emulate a user defined type. */
specifier|private
specifier|static
class|class
name|UDT
...
argument_list|)
decl_stmt|;
comment|// when the space before "NOT NULL" is missing, the digest is not correct
comment|// and the suffix should not be removed.
name|assertThat
argument_list|(
name|literal
operator|.
...
name|is
argument_list|(
literal|"0L:(udt)NOT NULL"
argument_list|)
argument_list|)
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-5489">[CALCITE-5489]    * RexCall to TIMESTAMP_DIFF function fails to convert a TIMESTAMP literal to    * a org.apache.calcite.avatica.util.TimeUnit</a>. */
annotation|@
name|Test
name|void
name|testTimestampDiffCall
parameter_list|()
block|{
specifier|final
name|RexImplicationCheckerFixtures
