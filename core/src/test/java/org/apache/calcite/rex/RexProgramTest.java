...
argument_list|)
expr_stmt|;
comment|// condition "(a>= 1 and a<= 3) or (a>= 2 and a<= 4)"
comment|// yelds "a>= 1 and a<= 4"
name|checkSimplifyFilter
argument_list|(
name|or
argument_list|(
...
argument_list|)
argument_list|,
literal|"SEARCH(?0.a, Sarg[[1..4]])"
argument_list|)
expr_stmt|;
comment|// condition "(a>= 1 and a<= 3) or (a>= 0 and a<= 2)"
comment|// yelds "a>= 0 and a<= 3"
name|checkSimplifyFilter
argument_list|(
name|or
argument_list|(
...
name|Test
name|void
name|testSimplifyOrNotEqualsNull
parameter_list|()
block|{
name|checkSimplify3
argument_list|(
...
name|Test
name|void
name|testSimplifyEqualityAndNotEqualityWithOverlapping
parameter_list|()
block|{
specifier|final
name|RexLiteral
...
argument_list|()
decl_stmt|;
comment|// "AND(<>(?0.int0, 3), =(?0.int0, 5))" => "=(?0.int0, 5)"
name|checkSimplify
argument_list|(
name|and
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// "AND(=(?0.int0, 5),<>(?0.int0, 3))" => "=(?0.int0, 5)"
name|checkSimplify
argument_list|(
name|and
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// "AND(=(CAST(?0.int0):INTEGER NOT NULL, 5),<>(CAST(?0.int0):INTEGER NOT NULL, 3))"
comment|// =>
comment|// "=(CAST(?0.int0):INTEGER NOT NULL, 5)"
name|checkSimplify
argument_list|(
name|and
argument_list|(
...
argument_list|)
argument_list|,
literal|"=(CAST(?0.int0):INTEGER NOT NULL, 5)"
argument_list|)
expr_stmt|;
comment|// "AND(<>(CAST(?0.int0):INTEGER NOT NULL, 3), =(CAST(?0.int0):INTEGER NOT NULL, 5))"
comment|// =>
comment|// "=(CAST(?0.int0):INTEGER NOT NULL, 5)"
name|checkSimplify
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// "AND(<>(CAST(?0.int0):INTEGER NOT NULL, 3), =(?0.int0, 5))"
comment|// =>
comment|// "AND(<>(CAST(?0.int0):INTEGER NOT NULL, 3), =(?0.int0, 5))"
name|checkSimplifyUnchanged
argument_list|(
...
expr_stmt|;
block|}
comment|/**    * Unit test for    *<a href="https://issues.apache.org/jira/browse/CALCITE-4988">[CALCITE-4988]    * ((A IS NOT NULL OR B) AND A IS NOT NULL) can't be simplify to (A IS NOT NULL)    * When A is deterministic</a>. */
annotation|@
name|Test
name|void
name|testSimplifyIsNotNullWithDeterministic
parameter_list|()
block|{
comment|// "(A IS NOT NULL OR B) AND A IS NOT NULL" when A is deterministic
comment|// ==>
comment|// "A IS NOT NULL"
name|SqlOperator
name|dc
init|=
name|getDeterministicOperator
argument_list|()
decl_stmt|;
name|checkSimplify2
argument_list|(
...
argument_list|)
argument_list|,
literal|"AND(OR(IS NOT NULL(DC()),>(?0.int2, 2)), IS NOT NULL(DC()))"
argument_list|,
literal|"IS NOT NULL(DC())"
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
name|void
name|testSimplifyIsNotNullWithDeterministic2
parameter_list|()
block|{
comment|// "(A IS NOT NULL AND B) OR A IS NULL" when A is deterministic
comment|// ==>
comment|// "A IS NULL OR B"
name|SqlOperator
name|dc
init|=
name|getDeterministicOperator
...
argument_list|)
argument_list|,
literal|"OR(IS NULL(DC()),>(?0.int2, 2))"
argument_list|)
expr_stmt|;
block|}
annotation|@
name|Test
name|void
name|testSimplifyIsNotNullWithNoDeterministic
parameter_list|()
block|{
comment|// "(A IS NOT NULL OR B) AND A IS NOT NULL" when A is not deterministic
comment|// ==>
comment|// "(A IS NOT NULL OR B) AND A IS NOT NULL"
name|SqlOperator
name|ndc
init|=
name|getNoDeterministicOperator
argument_list|()
decl_stmt|;
name|checkSimplifyUnchanged
argument_list|(
...
name|Test
name|void
name|testSimplifyIsNotNullWithNoDeterministic2
parameter_list|()
block|{
comment|// "(A IS NOT NULL AND B) OR A IS NOT NULL" when A is not deterministic
comment|// ==>
comment|// "(A IS NOT NULL AND B) OR A IS NOT NULL"
name|SqlOperator
name|ndc
init|=
name|getNoDeterministicOperator
...
expr_stmt|;
block|}
comment|/** Unit test for {@link RexUtil#predicateConstants(Class, RexBuilder, List)}    * applied to a predicate with {@code IS NOT DISTINCT FROM}. */
annotation|@
name|Test
name|void
name|testConstantMapIsNotDistinctFrom
parameter_list|()
block|{
specifier|final
name|RelDataType
...
argument_list|)
argument_list|,
literal|"OR(null, IS NOT NULL($0), LIKE($0, '% %'))"
argument_list|,
literal|"OR(IS NOT NULL($0), LIKE($0, '% %'))"
argument_list|,
literal|"true"
argument_list|)
expr_stmt|;
...
argument_list|)
expr_stmt|;
comment|// As above, but ref is NOT NULL
specifier|final
name|RexNode
name|refMandatory
init|=
...
argument_list|)
expr_stmt|;
comment|// NOT LIKE and NOT SIMILAR TO are not allowed in Rex land
try|try
block|{
name|rexBuilder
operator|.
...
name|is
argument_list|(
literal|"unsupported negated operator NOT LIKE"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
name|is
argument_list|(
literal|"unsupported negated operator NOT SIMILAR TO"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
argument_list|)
argument_list|,
literal|"NOT(OR(null, IS NOT NULL($0)))"
argument_list|,
literal|"false"
argument_list|,
literal|"NOT(IS NOT NULL($0))"
argument_list|)
expr_stmt|;
comment|// SIMILAR TO is not optimized
name|checkSimplifyUnchanged
argument_list|(
name|rexBuilder
operator|.
...
argument_list|)
expr_stmt|;
comment|// NOT(SIMILAR TO) is not optimized
name|checkSimplifyUnchanged
argument_list|(
name|not
argument_list|(
...
name|Test
name|void
name|testSimplifySimpleArithmetic
parameter_list|()
block|{
name|RexNode
name|a
