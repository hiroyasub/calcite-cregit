...
name|INSTANCE
init|=
name|ImmutableRandomSingleTraitRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableRandomSingleTraitRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutableSingleLeafTraitRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableSingleLeafTraitRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
