...
argument_list|)
decl_stmt|;
comment|// RelNode with leaf RelNode as single input
name|NoneSingleRel
name|singleRel
init|=
operator|new
...
argument_list|)
decl_stmt|;
comment|// Binary RelNode with identical input on either side
name|PhysBiRel
name|parent
init|=
operator|new
...
argument_list|()
decl_stmt|;
comment|// Expect inputs to remain identical
name|assertEquals
argument_list|(
name|result
operator|.
...
name|INSTANCE
init|=
name|ImmutableThreeInputsUnionRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableThreeInputsUnionRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
block|}
argument_list|,
literal|"Should throw exception fail since the type mismatches after applying rule."
argument_list|)
decl_stmt|;
name|Throwable
name|exception
...
operator|+
literal|"rel rowtype: RecordType(JavaType(class java.lang.Integer) this) NOT NULL\n"
operator|+
literal|"equiv rowtype: RecordType(JavaType(void) NOT NULL this) NOT NULL\n"
operator|+
literal|"Difference:\n"
operator|+
literal|"this: JavaType(class java.lang.Integer) -> JavaType(void) NOT NULL\n"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-4514">[CALCITE-4514]    * Fine tune the merge order of two RelSets</a>. When the merging RelSets,    * if they are both parents of each other (that is, there is a 1-cycle), we    * should merge the less popular/smaller/younger set into the more    * popular/bigger/older one. */
annotation|@
name|Test
name|void
name|testSetMergeWithCycle
parameter_list|()
block|{
name|VolcanoPlanner
name|planner
...
argument_list|()
decl_stmt|;
comment|// Create the relSet dependency cycle, so that both sets are parent of each
comment|// other.
name|planner
operator|.
name|ensureRegistered
...
argument_list|)
expr_stmt|;
comment|// setA and setB have the same popularity (parentRels.size()).
comment|// Since setB is larger than setA, setA should be merged into setB.
name|assertThat
argument_list|(
name|setA
operator|.
...
block|{
return|return
name|ModifiableSubsetRuleConfig
operator|.
name|create
argument_list|()
operator|.
...
name|typeModifiable
operator|=
literal|"ModifiableSubsetRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
block|{
return|return
name|ModifiablePhysSingleSubsetRuleConfig
operator|.
name|create
argument_list|()
operator|.
...
name|typeModifiable
operator|=
literal|"ModifiablePhysSingleSubsetRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutablePhysSingleInputSetMergeRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutablePhysSingleInputSetMergeRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutableReformedSingleRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableReformedSingleRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutablePhysProjectRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutablePhysProjectRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutableGoodRemoveSingleRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableGoodRemoveSingleRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutableReformedRemoveSingleRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableReformedRemoveSingleRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
