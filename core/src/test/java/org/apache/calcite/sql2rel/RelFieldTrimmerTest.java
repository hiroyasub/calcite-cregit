...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-4783">[CALCITE-4783]    * RelFieldTrimmer incorrectly drops filter condition</a>. */
annotation|@
name|Test
name|void
name|testCalcFieldTrimmer3
parameter_list|()
block|{
specifier|final
name|RelBuilder
...
literal|""
operator|+
literal|"LogicalAggregate(group=[{}], agg#0=[COUNT()])\n"
operator|+
literal|"  LogicalCalc(expr#0=[{inputs}], expr#1=['bob'], expr#2=[=($t0, $t1)], $condition=[$t2])\n"
operator|+
literal|"    LogicalExchange(distribution=[single])\n"
operator|+
...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-4995">[CALCITE-4995]    * AssertionError caused by RelFieldTrimmer on SEMI/ANTI join</a>. */
annotation|@
name|Test
name|void
name|testSemiJoinAntiJoinFieldTrimmer
parameter_list|()
block|{
for|for
control|(
...
literal|""
operator|+
literal|"LogicalJoin(condition=[=($0, $1)], joinType=["
operator|+
name|joinType
operator|.
name|lowerName
...
operator|+
literal|"    LogicalValues(tuples=[[{ 2 }, { 3 }]])\n"
operator|+
literal|"  LogicalValues(tuples=[[{ 0 }, { 2 }]])\n"
decl_stmt|;
name|assertThat
argument_list|(
name|trimmed
...
literal|"  LogicalProject(EMPNO=[$0])\n"
operator|+
literal|"    LogicalJoin(condition=[=($0, $1)], joinType=[inner])\n"
operator|+
literal|"      LogicalProject(EMPNO=[$0])\n"
operator|+
literal|"        LogicalTableScan(table=[[scott, EMP]])\n"
