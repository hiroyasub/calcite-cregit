...
name|g
init|=
literal|"sales_fact_1997 (time_by_day:time_id)"
decl_stmt|;
name|assertThat
argument_list|(
name|t
...
literal|"\n"
operator|+
literal|"select min(\"unit_sales\")\n"
operator|+
literal|"from \"sales_fact_1997\" as \"s\" join \"product\" as \"p\"\n"
operator|+
literal|" using (\"product_id\")\n"
operator|+
literal|"group by \"s\".\"customer_id\""
decl_stmt|;
comment|// Adding a query generates two lattices
specifier|final
name|List
argument_list|<
name|Lattice
...
argument_list|)
expr_stmt|;
comment|// But because of 'evolve' flag, the lattices are merged into a single
comment|// lattice
specifier|final
name|String
name|g
init|=
literal|"sales_fact_1997 (product:product_id time_by_day:time_id)"
decl_stmt|;
specifier|final
name|String
name|measures
init|=
literal|"[MIN(sales_fact_1997.unit_sales)]"
decl_stmt|;
name|assertThat
argument_list|(
name|t
