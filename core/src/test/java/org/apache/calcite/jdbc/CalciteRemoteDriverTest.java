...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-3338">[CALCITE-3338]    * Error with executeBatch and preparedStatement when using RemoteMeta</a>. */
annotation|@
name|Test
specifier|public
name|void
name|testInsertBatchWithPreparedStatement
parameter_list|()
throws|throws
name|Exception
block|{
