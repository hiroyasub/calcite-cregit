...
name|Timestamp
argument_list|(
literal|1261053296000L
argument_list|)
argument_list|)
expr_stmt|;
name|assertEquals
argument_list|(
literal|"TIMESTAMP '2009-12-17 12:34:56'"
argument_list|,
name|buf
operator|.
name|getSqlAndClear
...
name|assertEquals
argument_list|(
literal|"select TIMESTAMP '2009-12-17 12:34:56'"
argument_list|,
name|buf
operator|.
name|getSqlAndClear
...
argument_list|)
expr_stmt|;
comment|// same, using a list of pairs
name|size
operator|.
name|set
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// same, using list of pairs
name|b
operator|.
name|setLength
argument_list|(
...
expr_stmt|;
block|}
comment|/** Test for {@link org.apache.calcite.util.ImmutableNullableSet}. */
annotation|@
name|Test
name|void
name|testImmutableNullableSet
parameter_list|()
block|{
specifier|final
name|List
...
comment|// ok
block|}
comment|// Collections.emptySet() is unchanged
name|assertThat
argument_list|(
name|ImmutableNullableSet
operator|.
...
argument_list|)
expr_stmt|;
comment|// any other empty set becomes ImmutableSet
name|assertThat
argument_list|(
name|ImmutableNullableSet
operator|.
...
argument_list|)
expr_stmt|;
comment|// singleton set is unchanged
specifier|final
name|Set
argument_list|<
name|String
...
argument_list|)
expr_stmt|;
comment|// set with no nulls uses ImmutableSet
specifier|final
name|List
argument_list|<
name|String
...
expr_stmt|;
block|}
comment|/** Tests {@link ReflectUtil#mightBeAssignableFrom(Class, Class)}. */
annotation|@
name|Test
name|void
name|testMightBeAssignableFrom
parameter_list|()
block|{
specifier|final
name|Object
...
decl_stmt|;
comment|// Categories:
comment|//   String - final class
comment|//   int - primitive
comment|//   Map - interface
comment|//   HashMap - non-final class
comment|//   myMapClass - anonymous (therefore final) class that extends HashMap
comment|//   StringBuilder - final class
comment|//   DayOfWeek - enum
comment|// What can be assigned to an Object parameter? Anything except a primitive.
...
argument_list|)
expr_stmt|;
comment|// What can be assigned to an String parameter? String is a final class, so
comment|// only itself, super-classes and super-interfaces.
name|checkAssignable
argument_list|(
name|String
operator|.
...
argument_list|)
expr_stmt|;
comment|// What can be assigned to an int parameter? int is primitive, so only int.
name|checkAssignable
argument_list|(
name|int
operator|.
...
argument_list|)
expr_stmt|;
comment|// What can be assigned to an Integer parameter? Integer is a final class.
name|checkAssignable
argument_list|(
name|Integer
operator|.
...
argument_list|)
expr_stmt|;
comment|// What can be assigned to an HashMap parameter? HashMap is a non-final
comment|// class.
name|checkAssignable
argument_list|(
name|HashMap
...
argument_list|)
expr_stmt|;
comment|// What can be assigned to a Map parameter? Map is an interface, so
comment|// anything except primitives and final classes that do not implement Map.
name|checkAssignable
argument_list|(
name|Map
operator|.
...
argument_list|)
expr_stmt|;
comment|// What can be assigned to an Enum parameter? An Enum is very similar to a
comment|// final class.
name|checkAssignable
argument_list|(
name|DayOfWeek
...
expr_stmt|;
block|}
comment|/** Tests    * {@link org.apache.calcite.util.TryThreadLocal#letIn(Object, Runnable)}    * and    * {@link org.apache.calcite.util.TryThreadLocal#letIn(Object, java.util.function.Supplier)}. */
annotation|@
name|Test
name|void
name|testTryThreadLocalLetIn
parameter_list|()
block|{
specifier|final
name|TryThreadLocal
...
argument_list|)
expr_stmt|;
comment|// even when the Runnable throws, the value is restored
name|local
operator|.
name|set
argument_list|(
...
expr_stmt|;
block|}
comment|/** Test {@link MonotonicSupplier}. */
annotation|@
name|Test
name|void
name|testMonotonicSupplier
parameter_list|()
block|{
specifier|final
...
argument_list|()
decl_stmt|;
comment|// Cannot 'get' before 'accept'
try|try
block|{
specifier|final
name|String
...
argument_list|)
expr_stmt|;
comment|// After 'accept' we can call 'get' multiple times
specifier|final
name|String
name|s
init|=
