...
argument_list|()
decl_stmt|;
comment|// create a set of integers in and not in the lists
specifier|final
name|Set
argument_list|<
name|Integer
...
expr_stmt|;
block|}
comment|/**    * Test case for {@link ImmutableBitSet#allContain(Collection, int)}.    */
annotation|@
name|Test
name|void
name|testAllContain
...
expr_stmt|;
block|}
comment|/** Test case for    * {@link org.apache.calcite.util.ImmutableBitSet#toImmutableBitSet()}. */
annotation|@
name|Test
name|void
name|testCollector
