...
literal|"abc+def.txt"
argument_list|,
literal|"file:abc+def.txt"
argument_list|)
argument_list|,
name|arguments
argument_list|(
literal|"path 1/ subfolder 2/abc.t x t"
argument_list|,
literal|"file:path%201/%20subfolder%202/abc.t%20x%20t"
argument_list|)
argument_list|,
name|arguments
argument_list|(
literal|"Ð¼Ð°Ð»ÐµÐ½ÑÐºÐ¾Ð¹ ÑÐ»Ð¾ÑÐºÐµ ÑÐ¾Ð»Ð¾Ð´Ð½Ð¾ Ð·Ð¸Ð¼Ð¾Ð¹.txt"
argument_list|,
literal|"file:Ð¼Ð°Ð»ÐµÐ½ÑÐºÐ¾Ð¹%20ÑÐ»Ð¾ÑÐºÐµ%20ÑÐ¾Ð»Ð¾Ð´Ð½Ð¾%20Ð·Ð¸Ð¼Ð¾Ð¹.txt"
argument_list|)
argument_list|)
return|;
block|}
...
parameter_list|()
lambda|->
literal|"No URL generated for Sources.of(file "
operator|+
name|path
operator|+
literal|")"
...
parameter_list|()
lambda|->
literal|"Sources.of(Sources.of(file "
operator|+
name|path
operator|+
literal|").url()).file().getPath()"
argument_list|)
expr_stmt|;
block|}
annotation|@
...
name|path
operator|+
literal|").absolutePath).url()).file().getPath()"
argument_list|)
expr_stmt|;
block|}
annotation|@
