...
block|}
decl_stmt|;
comment|/** As an ordering, integers are ordered by division.    * Top is 1, its children are primes, etc. */
specifier|private
specifier|static
name|boolean
name|isDivisor
...
return|;
block|}
comment|/** As an ordering, bottom is 1, parents are primes, etc. */
specifier|private
specifier|static
name|boolean
...
return|;
block|}
comment|/** As an ordering, integers are ordered by bit inclusion.    * E.g. the children of 14 (1110) are 12 (1100), 10 (1010) and 6 (0110). */
specifier|private
specifier|static
name|boolean
name|isBitSubset
...
return|;
block|}
comment|/** As an ordering, integers are ordered by bit inclusion.    * E.g. the parents of 14 (1110) are 12 (1100), 10 (1010) and 6 (0110). */
specifier|private
specifier|static
name|boolean
name|isBitSuperset
...
parameter_list|()
block|{
comment|// It takes 80 seconds, and the computations are exactly the same every time
specifier|final
name|PartiallyOrderedSet
argument_list|<
name|Integer
