...
block|}
block|}
comment|/** Returns whether an operator always returns null if any of its arguments is    * null. */
specifier|private
specifier|static
name|boolean
name|isStrict
...
name|AND
case|:
comment|// not strict: FALSE OR NULL yields FALSE
case|case
name|OR
case|:
comment|// not strict: TRUE OR NULL yields TRUE
return|return
literal|false
return|;
block|}
...
block|}
block|}
comment|/**    * Creates a {@link org.apache.calcite.sql.test.SqlTester} based on a JDBC    * connection.    */
specifier|public
specifier|static
name|SqlTester
name|tester
