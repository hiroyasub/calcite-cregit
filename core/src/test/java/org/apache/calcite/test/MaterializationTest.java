...
operator|+
literal|"from \"emps\" where \"deptno\" = 10 and \"empid\"< 150"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
name|materialize
init|=
literal|"select \"name\", \"deptno\", \"salary\"\n"
operator|+
literal|"from \"emps\"\n"
operator|+
...
literal|"from \"emps\"\n"
operator|+
literal|"where \"deptno\"> 30 and \"salary\"> 3000"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
operator|+
literal|"where ((\"salary\"< 1111.9 and \"deptno\"> 10)\n"
operator|+
...
literal|"from \"emps\"\n"
operator|+
literal|"group by cube(\"empid\",\"deptno\")"
decl_stmt|;
specifier|final
name|String
name|query
...
operator|+
literal|"  count(*) as c, sum(\"salary\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"group by cube(\"empid\",\"deptno\")"
...
literal|"from \"emps\"\n"
operator|+
literal|"group by rollup(\"empid\",\"deptno\")"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
name|materialize
init|=
literal|"select \"empid\", \"deptno\", count(*) as c,\n"
operator|+
literal|"  sum(\"empid\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
...
operator|+
literal|"groups=[[{0, 1}, {0}, {1}, {}]], agg#0=[$SUM0($2)])\n"
operator|+
literal|"    EnumerableTableScan(table=[[hr, m0]])"
decl_stmt|;
name|sql
...
name|materialize
init|=
literal|"select \"deptno\", count(*) as c,\n"
operator|+
literal|"  \"empid\" + 2, sum(\"empid\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"group by \"empid\", \"deptno\""
...
literal|"from \"emps\"\n"
operator|+
literal|"group by cube(\"deptno\", \"empid\")"
decl_stmt|;
specifier|final
name|String
name|expected
...
literal|"from \"emps\"\n"
operator|+
literal|"group by rollup(\"deptno\", \"empid\")"
decl_stmt|;
specifier|final
name|String
name|expected
...
name|materialize
init|=
literal|"select \"salary\", \"empid\", \"deptno\",\n"
operator|+
literal|"  count(*) as c, sum(\"commission\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
...
literal|"from \"emps\"\n"
operator|+
literal|"group by rollup(\"empid\", \"deptno\", \"salary\")"
decl_stmt|;
specifier|final
name|String
name|expected
...
operator|+
literal|"  EnumerableAggregate(group=[{0, 1, 2}], "
operator|+
literal|"groups=[[{0, 1, 2}, {1, 2}, {1}, {}]], agg#0=[$SUM0($3)])\n"
operator|+
literal|"    EnumerableTableScan(table=[[hr, m0]])"
decl_stmt|;
name|sql
...
name|materialize
init|=
literal|"select min(\"salary\"), count(*),\n"
operator|+
literal|"  max(\"salary\"), sum(\"salary\"), \"empid\"\n"
operator|+
literal|"from \"emps\"\n"
operator|+
...
name|mv
init|=
literal|"select \"emps\".\"empid\", \"emps\".\"deptno\",\n"
operator|+
literal|"  \"depts\".\"deptno\"\n"
operator|+
literal|"from \"emps\"\n"
operator|+
...
operator|+
literal|"  floor(cast('1997-01-20 12:34:56' as timestamp) to month),\n"
operator|+
...
literal|"select\n"
operator|+
literal|"  floor(cast('1997-01-20 12:34:56' as timestamp) to year),\n"
operator|+
literal|"  sum(\"empid\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"group by floor(cast('1997-01-20 12:34:56' as timestamp) to year)"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
literal|"select \"empid\",\n"
operator|+
literal|"  floor(cast('1997-01-20 12:34:56' as timestamp) to second),\n"
operator|+
literal|"  count(*) + 1 as c, sum(\"empid\") as s\nfrom \"emps\"\n"
operator|+
literal|"group by \"empid\",\n"
...
literal|"select\n"
operator|+
literal|"  floor(cast('1997-01-20 12:34:56' as timestamp) to minute),\n"
operator|+
literal|"  sum(\"empid\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"group by floor(cast('1997-01-20 12:34:56' as timestamp) to minute)"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
literal|"from \"emps\"\n"
operator|+
literal|"group by floor(cast('1997-01-20 12:34:56' as timestamp) to month)"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
literal|"select \"empid\",\n"
operator|+
literal|"  cast('1997-01-20 12:34:56' as timestamp),\n"
operator|+
literal|"  count(*) + 1 as c, sum(\"empid\") as s\n"
operator|+
literal|"from \"emps\"\n"
...
literal|"select\n"
operator|+
literal|"  floor(cast('1997-01-20 12:34:56' as timestamp) to hour),\n"
operator|+
literal|"  sum(\"empid\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"group by floor(cast('1997-01-20 12:34:56' as timestamp) to hour)"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
name|materialize
init|=
literal|"select \"eventid\",\n"
operator|+
literal|"  floor(cast(\"ts\" as timestamp) to second), count(*) + 1 as c,\n"
operator|+
literal|"  sum(\"eventid\") as s\n"
operator|+
literal|"from \"events\"\n"
operator|+
literal|"group by \"eventid\", floor(cast(\"ts\" as timestamp) to second)"
decl_stmt|;
specifier|final
name|String
name|query
init|=
literal|"select floor(cast(\"ts\" as timestamp) to minute),\n"
operator|+
literal|"  sum(\"eventid\") as s\n"
operator|+
literal|"from \"events\"\n"
operator|+
literal|"group by floor(cast(\"ts\" as timestamp) to minute)"
decl_stmt|;
name|sql
argument_list|(
name|materialize
...
literal|"select \"eventid\",\n"
operator|+
literal|"  floor(cast(\"ts\" as timestamp) to month), count(*) + 1 as c,\n"
operator|+
literal|"  sum(\"eventid\") as s\n"
operator|+
literal|"from \"events\"\n"
operator|+
literal|"group by \"eventid\", floor(cast(\"ts\" as timestamp) to month)"
decl_stmt|;
specifier|final
name|String
name|query
init|=
literal|"select floor(cast(\"ts\" as timestamp) to hour),\n"
operator|+
literal|"  sum(\"eventid\") as s\n"
operator|+
literal|"from \"events\"\n"
operator|+
literal|"group by floor(cast(\"ts\" as timestamp) to hour)"
decl_stmt|;
specifier|final
name|String
name|expected
...
operator|+
literal|"expr#6=[CAST($t1):VARCHAR], expr#7=[CAST($t0):VARCHAR], "
operator|+
literal|"expr#8=[=($t6, $t7)], expr#9=[AND($t5, $t8)], proj#0..4=[{exprs}], "
operator|+
...
name|expected
init|=
literal|"EnumerableCalc(expr#0..3=[{inputs}], "
operator|+
literal|"deptno=[$t1], empid=[$t0], S=[$t3], C=[$t2])\n"
operator|+
literal|"  EnumerableTableScan(table=[[hr, m0]])"
decl_stmt|;
name|sql
...
literal|"EnumerableCalc(expr#0..1=[{inputs}], expr#2=[1], "
operator|+
literal|"expr#3=[+($t1, $t2)], deptno=[$t0], S=[$t3])\n"
operator|+
literal|"  EnumerableAggregate(group=[{1}], agg#0=[$SUM0($3)])\n"
operator|+
literal|"    EnumerableCalc(expr#0..3=[{inputs}], expr#4=[10], expr#5=[<($t4, $t1)], "
...
literal|"select \"dependents\".\"empid\",\n"
operator|+
literal|"  \"emps\".\"deptno\", sum(\"salary\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
...
literal|"select \"dependents\".\"empid\",\n"
operator|+
literal|"  \"emps\".\"deptno\", count(distinct \"salary\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"join \"dependents\" on (\"emps\".\"empid\" = \"dependents\".\"empid\")\n"
...
name|query
init|=
literal|"select \"emps\".\"deptno\",\n"
operator|+
literal|"  count(distinct \"salary\") as s\n"
operator|+
literal|"from \"emps\"\n"
operator|+
literal|"join \"dependents\" on (\"emps\".\"empid\" = \"dependents\".\"empid\")\n"
...
literal|"select \"depts\".\"deptno\",\n"
operator|+
literal|"  \"dependents\".\"empid\", count(\"emps\".\"salary\") as s\n"
operator|+
literal|"from \"depts\"\n"
operator|+
literal|"join \"dependents\" on (\"depts\".\"name\" = \"dependents\".\"name\")\n"
...
literal|"select \"dependents\".\"empid\",\n"
operator|+
literal|"  count(distinct \"emps\".\"salary\") + 1\n"
operator|+
literal|"from \"depts\"\n"
operator|+
literal|"join \"dependents\" on (\"depts\".\"name\" = \"dependents\".\"name\")\n"
