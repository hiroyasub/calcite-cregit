...
return|;
block|}
comment|/**    * Creates a connection with a given query provider. If provider is null,    * uses the connection as its own provider. The connection contains a    * schema called "foodmart" backed by a JDBC connection to MySQL.    *    * @param schemaSpec Schema specification; whether to create a "foodmart2"    *     schema as in-memory clone    * @return Connection    * @throws ClassNotFoundException    * @throws java.sql.SQLException    */
specifier|static
name|CalciteConnection
name|getConnection
parameter_list|(
...
function_decl|;
block|}
comment|/** Abstract implementation of    * {@link org.apache.calcite.test.CalciteAssert.ConnectionFactory}    * whose {@code with} methods throw. */
specifier|public
specifier|abstract
specifier|static
class|class
...
decl_stmt|;
block|}
comment|/** Connection factory that creates connections based on a given    * {@link Config}. */
specifier|private
specifier|static
class|class
name|ConfigConnectionFactory
...
block|}
block|}
comment|/** Connection factory that delegates to an underlying factory. */
specifier|private
specifier|static
class|class
...
block|}
block|}
comment|/** Connection factory that gets a connection from an underlying factory, then    * sets its schema. */
specifier|private
specifier|static
class|class
name|SchemaConnectionFactory
