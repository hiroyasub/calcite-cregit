...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-2041">[CALCITE-2041]    * When simplifying a nullable expression, allow the result to change type to    * NOT NULL</a> and    * {@link org.apache.calcite.rex.RexUtil.ExprSimplifier#matchNullability}. */
annotation|@
name|Test
specifier|public
name|void
...
operator|.
name|ExprSimplifier
name|nonMatchingNullabilitySimplifier
init|=
operator|new
name|RexUtil
operator|.
