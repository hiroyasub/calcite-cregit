...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-5003">[CALCITE-5003]    * MergeUnion on types with different collators produces wrong result</a>. */
annotation|@
name|Test
name|void
name|testMergeUnionOnStringDifferentCollation
parameter_list|()
block|{
name|tester
argument_list|()
...
argument_list|(
literal|""
comment|// It is important that we have MergeUnion in the plan
operator|+
literal|"EnumerableMergeUnion(all=[false])\n"
operator|+
literal|"  EnumerableSort(sort0=[$0], dir0=[ASC])\n"
operator|+
literal|"    EnumerableCalc(expr#0=[{inputs}], expr#1=[CAST($t0):VARCHAR COLLATE \"ISO-8859-1$en_US$tertiary$JAVA_COLLATOR\" NOT NULL], name=[$t1])\n"
operator|+
literal|"      EnumerableValues(tuples=[[{ 'facilities' }, { 'HR' }, { 'administration' }, { 'Marketing' }]])\n"
operator|+
literal|"  EnumerableSort(sort0=[$0], dir0=[ASC])\n"
operator|+
literal|"    EnumerableValues(tuples=[[{ 'Marketing' }, { 'administration' }, { 'presales' }, { 'HR' }]])\n"
argument_list|)
operator|.
name|returnsOrdered
argument_list|(
