...
expr_stmt|;
block|}
comment|/**    * Test if limit and sort are replaced by a limit sort.    * Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-3920">[CALCITE-3920]    * Improve ORDER BY computation in Enumerable convention by exploiting LIMIT</a>.    */
annotation|@
name|Test
name|void
name|testLimitSort
