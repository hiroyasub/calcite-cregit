...
name|Test
name|void
name|testGroupByDateLiteralSimple
parameter_list|()
block|{
specifier|final
name|String
...
literal|"from emp\n"
operator|+
literal|"group by DATE '2022-01-01'"
decl_stmt|;
name|sql
argument_list|(
name|query
...
name|Test
name|void
name|testGroupByBooleanLiteralSimple
parameter_list|()
block|{
specifier|final
name|String
...
name|Test
name|void
name|testGroupByMultipleLiterals
parameter_list|()
block|{
specifier|final
name|String
...
literal|"from emp\n"
operator|+
literal|"group by false, deptno, true, true, empno, false, 'ab', DATE '2022-01-01'"
decl_stmt|;
name|sql
argument_list|(
name|query
...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-3890">[CALCITE-3890]    * Derive IS NOT NULL predicates from a inner join and create filters with those predicates    * as new inputs of the join</a>. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule1
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from emp t1 inner join emp t2 on t1.mgr = t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should create IS NOT NULL filter for the right input of join, but not for    * the left input since its child already has one. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule2
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from (select * from emp where mgr is not null) t1 "
operator|+
literal|"join emp t2 on t1.mgr = t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should create IS NOT NULL filter in both sides. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule3
parameter_list|()
block|{
specifier|final
name|String
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should create IS NOT NULL filter for both join keys. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule4
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from empnullables t1 inner join\n"
operator|+
literal|"empnullables t2 on t1.ename = t2.ename and t1.mgr> t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should create IS NOT NULL filter for the right input of join, but not for    * the left input since its ancestor already has one. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule5
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from (select ename, deptno+1 as deptno from\n"
operator|+
literal|"empnullables where ename is not null) t1 inner join\n"
operator|+
literal|"empnullables t2 on t1.ename = t2.ename"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should not create IS NOT NULL filter in any side since it is full join. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule6
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from emp t1 full join emp t2 on t1.mgr = t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should not create IS NOT NULL filter in any side since it is left join. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule7
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from emp t1 left join emp t2 on t1.mgr = t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should not create IS NOT NULL filter in any side since it is right join. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule8
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from emp t1 right join emp t2 on t1.mgr = t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should not create IS NOT NULL filter in both sides since they already have the filter. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule9
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select t1.deptno from (select * from emp where mgr is not null) t1\n"
operator|+
literal|"join (select * from emp where mgr is not null) t2 on t1.mgr = t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should not create IS NOT NULL filter in any side since the join condition is not strong. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule10
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select t1.deptno from emp t1 inner join emp t2\n"
operator|+
literal|"on t1.mgr is not distinct from t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should not create IS NOT NULL filter since it's cartesian product. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule11
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select t1.deptno from empnullables t1 inner join\n"
operator|+
literal|"empnullables t2 on t1.ename = t2.ename or 1 = 1"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
expr_stmt|;
block|}
comment|/** As {@link #testJoinDeriveIsNotNullFilterRule1()};    * should create IS NOT NULL filter for one of the join keys. */
annotation|@
name|Test
name|void
name|testJoinDeriveIsNotNullFilterRule12
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select t1.deptno from empnullables t1 inner join\n"
operator|+
literal|"empnullables t2 on t1.ename = t2.ename and t1.mgr is not distinct from t2.mgr"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
name|Test
name|void
name|testSemiJoinRuleDoNotMatchAggregate
parameter_list|()
block|{
specifier|final
name|String
...
name|Test
name|void
name|testSemiJoinRuleWithJoinOnUniqueInput
parameter_list|()
block|{
specifier|final
name|String
...
expr_stmt|;
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-4941">[CALCITE-4941]    * SemiJoinRule loses hints</a>. */
annotation|@
name|Test
name|void
name|testSemiJoinRuleWithHint
parameter_list|()
block|{
specifier|final
name|RelHint
...
literal|"    where emp.deptno = dept.deptno\n"
operator|+
literal|"    and emp.sal> 100)) s\n"
operator|+
literal|"join customer.account on s.deptno = account.acctno"
decl_stmt|;
specifier|final
name|HepProgram
name|program
...
begin_comment
comment|/** Similar to {@link #testJoinConditionPushdown1()} but full join    * from which more equality conditions can not be inferred. */
end_comment
...
name|Test
name|void
name|testJoinConditionPushdown3
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select *\n"
operator|+
literal|"from emp e full join dept d\n"
operator|+
literal|"on e.deptno = d.deptno and e.empno = d.deptno"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
begin_comment
comment|/** Similar to {@link #testJoinConditionPushdown1()} but semi join    * from which more equality conditions can be inferred. */
end_comment
...
name|Test
name|void
name|testJoinConditionPushdown4
parameter_list|()
block|{
specifier|final
name|Function
...
begin_comment
comment|/** Similar to {@link #testJoinConditionPushdown1()} but left join    * from which more equality conditions can not be inferred. */
end_comment
...
name|Test
name|void
name|testJoinConditionPushdown5
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select *\n"
operator|+
literal|"from emp e left join dept d\n"
operator|+
literal|"on e.deptno = d.deptno and e.empno = d.deptno"
decl_stmt|;
name|sql
...
begin_comment
comment|/** Similar to {@link #testJoinConditionPushdown1()} but right join    * from which more equality conditions can be inferred. */
end_comment
...
name|Test
name|void
name|testJoinConditionPushdown6
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select *\n"
operator|+
literal|"from emp e right join dept d\n"
operator|+
literal|"on e.deptno = d.deptno and e.empno = d.deptno"
decl_stmt|;
name|sql
...
comment|// Create a new planner instance, so we can remove its executor without
comment|// breaking other tests.
specifier|final
name|RelOptPlanner
name|planner
init|=
...
begin_comment
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-2736">[CALCITE-2736]    * ReduceExpressionsRule never reduces dynamic expressions but this should be    * configurable</a>. Tests that a dynamic function (USER) is reduced if and    * only if {@link ReduceExpressionsRule.Config#treatDynamicCallsAsConstant()}    * is true. */
end_comment
...
name|Test
name|void
name|testReduceDynamic
parameter_list|()
block|{
name|checkDynamicFunctions
argument_list|(
literal|true
argument_list|)
operator|.
...
begin_comment
comment|/** As {@link #testReduceDynamic()}. */
end_comment
...
parameter_list|)
block|{
comment|// Create a customized executor with given context operator that reduces
comment|// "USER" to "happyCalciteUser"
specifier|final
name|RexExecutorImpl
name|executor
init|=
...
parameter_list|()
block|{
comment|// table is transformed to empty values and extra project will be removed.
specifier|final
name|String
name|sql
init|=
literal|"select * from EMPTY_PRODUCTS\n"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
name|Test
name|void
name|testEmptyTableTransformsComplexQueryToSingleTableScan
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select products.PRODUCTID, products.NAME from products left join\n"
operator|+
literal|"(select * from products as e\n"
operator|+
literal|" inner join EMPTY_PRODUCTS as d on e.PRODUCTID = d.PRODUCTID\n"
operator|+
literal|" where e.SUPPLIERID> 10) dt\n"
operator|+
literal|" on products.PRODUCTID = dt.PRODUCTID"
decl_stmt|;
name|Collection
argument_list|<
name|RelOptRule
...
name|Test
name|void
name|testAggregateWithDynamicParam
parameter_list|()
block|{
name|HepProgramBuilder
name|builder
...
name|sql
init|=
literal|"SELECT sal, COUNT(1) AS count_val\n"
operator|+
literal|"FROM emp t WHERE sal = ?\n"
operator|+
literal|"GROUP BY sal HAVING sal< 1000"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
name|Test
name|void
name|testPullConstantThroughUnionSameTypeNullableField
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select deptno, ename from empnullables where deptno = 1\n"
operator|+
literal|"union all\n"
operator|+
literal|"select deptno, ename from empnullables where deptno = 1"
...
argument_list|()
decl_stmt|;
comment|// Create a duplicate rel tree with a CustomCorrelate instead of
...
begin_comment
comment|/** Tests that ProjectAggregateMergeRule does nothing with non-numeric literals    * and does not throw an exception. */
end_comment
...
name|Test
name|void
name|testProjectAggregateMergeNonNumericLiteral
parameter_list|()
block|{
comment|// Requires a NULLABLE column to trigger
specifier|final
name|SqlTestFactory
operator|.
...
name|sql
init|=
literal|"select hiredate, coalesce(hiredate, {ts '1969-12-31 00:00:00'}) as c1\n"
operator|+
literal|"from sales.nullable\n"
operator|+
literal|"group by hiredate"
decl_stmt|;
end_decl_stmt
...
name|Test
name|void
name|testProjectAggregateMergeNoOpForNonSum
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select coalesce(m, 0)\n"
operator|+
literal|"from (\n"
operator|+
literal|"  select max(deptno) as m\n"
operator|+
literal|"  from sales.emp\n"
operator|+
literal|")"
...
name|sql
init|=
literal|"select n.n_regionkey\n"
operator|+
literal|"from (select *\n"
operator|+
literal|"  from (select *\n"
operator|+
literal|"    from sales.customer) t) n\n"
operator|+
literal|"where n.n_nationkey> 1"
decl_stmt|;
name|PushProjector
operator|.
name|ExprCondition
...
literal|"FROM emp A\n"
operator|+
literal|"where sal in (SELECT max(sal)\n"
operator|+
literal|"  FROM emp B\n"
operator|+
literal|"  where A.mgr = B.empno\n"
operator|+
literal|"  group by deptno, 'abc')"
decl_stmt|;
name|sql
argument_list|(
name|sql
...
name|sql
init|=
literal|"(select n_nationkey from SALES.CUSTOMER)\n"
operator|+
literal|"union all\n"
operator|+
...
name|INSTANCE
init|=
name|ImmutableMyFilterRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableMyFilterRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|INSTANCE
init|=
name|ImmutableMyProjectRuleConfig
operator|.
name|builder
argument_list|()
operator|.
...
name|typeImmutable
operator|=
literal|"ImmutableMyProjectRuleConfig"
argument_list|)
specifier|public
interface|interface
name|Config
...
name|sql
init|=
literal|"select FNAME, LNAME\n"
operator|+
literal|"from SALES.CUSTOMER\n"
operator|+
literal|"where CONTACTNO> 10"
decl_stmt|;
name|sql
argument_list|(
name|sql
