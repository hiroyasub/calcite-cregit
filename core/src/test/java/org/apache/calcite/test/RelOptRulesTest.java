...
comment|//  (select deptno from dept d1 where deptno> 100
comment|//  union all
...
begin_comment
comment|/**    * Create a {@link HepProgram} with common transitive rules.    */
end_comment
...
name|sql
init|=
literal|"select e.deptno, count(distinct e.job) from sales.emp e\n"
operator|+
literal|"left outer join sales.dept d on e.deptno = d.deptno\n"
operator|+
literal|"group by e.deptno"
...
name|sql
init|=
literal|"select e.deptno, count(distinct d.name) from sales.emp e\n"
operator|+
literal|"left outer join sales.dept d on e.deptno = d.deptno\n"
operator|+
literal|"group by e.deptno"
...
name|sql
init|=
literal|"select distinct d.deptno from sales.emp e\n"
operator|+
...
name|sql
init|=
literal|"select d.deptno, count(distinct d.name) from sales.emp e\n"
operator|+
literal|"right outer join sales.dept d on e.deptno = d.deptno\n"
operator|+
...
name|sql
init|=
literal|"select d.deptno, count(distinct e.job) from sales.emp e\n"
operator|+
literal|"right outer join sales.dept d on e.deptno = d.deptno\n"
operator|+
literal|"group by d.deptno"
...
name|query
init|=
literal|"select * from sales.customer as t1 where t1.c_nationkey[0] is not null"
decl_stmt|;
name|sql
argument_list|(
name|query
