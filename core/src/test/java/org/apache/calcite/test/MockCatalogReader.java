...
argument_list|)
expr_stmt|;
comment|// TODO Remove this table and use STRUCT.T instead after
comment|// CALCITE-1425 is done.
name|MockTable
name|simpleTable
init|=
operator|new
...
expr_stmt|;
block|}
comment|/**      * Subclass of AbstractModifiableTable that also implements      * CustomExpansionTable.      */
specifier|private
specifier|abstract
class|class
name|AbstractModifiableTableWithCustomExpansion
extends|extends
name|JdbcTest
operator|.
