...
begin_comment
comment|/**  * Unit test for {@link SubstitutionVisitor}.  */
end_comment
...
expr_stmt|;
block|}
comment|/** Fixture for tests for whether expressions are satisfiable,    * specifically {@link SubstitutionVisitor#mayBeSatisfiable(RexNode)}. */
specifier|private
specifier|static
class|class
name|SatisfiabilityFixture
