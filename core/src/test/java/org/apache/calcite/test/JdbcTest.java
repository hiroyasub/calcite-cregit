...
return|;
block|}
comment|/** Runs a task (such as a test) with and without expansion. */
specifier|static
name|void
name|forEachExpand
parameter_list|(
...
argument_list|()
decl_stmt|;
comment|// Raw MockDdlDriver does not implement commit.
name|checkMockDdl
argument_list|(
name|counter
argument_list|,
...
argument_list|)
expr_stmt|;
comment|// MockDdlDriver implements commit if we have supplied a
comment|// prepare-factory to do so.
name|checkMockDdl
argument_list|(
name|counter
argument_list|,
...
argument_list|()
operator|.
name|withPrepareFactory
argument_list|(
parameter_list|()
lambda|->
operator|new
name|CountingPrepare
argument_list|(
name|counter
argument_list|)
argument_list|)
argument_list|)
expr_stmt|;
comment|// Raw MockDdlDriver2 does not implement commit.
specifier|final
name|MockDdlDriver2
name|driver2
init|=
...
argument_list|)
expr_stmt|;
comment|// MockDdlDriver2 implements commit if we have supplied a
comment|// prepare-factory to do so.
name|checkMockDdl
argument_list|(
name|counter
...
argument_list|)
expr_stmt|;
comment|// MockDdlDriver2 implements commit if we override its createPrepareFactory
comment|// method. The method is deprecated but override still needs to work.
name|checkMockDdl
argument_list|(
name|counter
argument_list|,
...
literal|""
operator|+
literal|"EnumerableMergeJoin(condition=[=($0, $38)], joinType=[inner]): rowcount = 7.050660528307499E8, cumulative cost = {7.656040129282498E8 rows, 5.408916992330521E10 cpu, 0.0 io}\n"
operator|+
literal|"  EnumerableSort(sort0=[$0], dir0=[ASC]): rowcount = 2.0087351932499997E7, cumulative cost = {4.044858016499999E7 rows, 5.408911688230521E10 cpu, 0.0 io}\n"
operator|+
literal|"    EnumerableMergeJoin(condition=[=($2, $8)], joinType=[inner]): rowcount = 2.0087351932499997E7, cumulative cost = {2.0361228232499994E7 rows, 4.4173907295063056E7 cpu, 0.0 io}\n"
operator|+
literal|"      EnumerableSort(sort0=[$2], dir0=[ASC]): rowcount = 86837.0, cumulative cost = {173674.0 rows, 4.3536484295063056E7 cpu, 0.0 io}\n"
operator|+
...
name|this
operator|::
name|checkMultisetQueryWithSingleColumn
argument_list|)
expr_stmt|;
block|}
name|void
...
operator|+
literal|"              final org.apache.calcite.test.schemata.hr.Employee current = (org.apache"
operator|+
literal|".calcite.test.schemata.hr.Employee) inputEnumerator.current();\n"
operator|+
...
literal|""
operator|+
literal|"              final org.apache.calcite.test.schemata.hr.Employee current"
operator|+
literal|" = (org.apache.calcite.test.schemata.hr.Employee) inputEnumerator.current();\n"
operator|+
...
literal|"SELECT * FROM (VALUES(\n"
operator|+
literal|" monthname(TIMESTAMP '1969-01-01 00:00:00'),\n"
operator|+
literal|" monthname(DATE '1969-01-01'),\n"
operator|+
literal|" monthname(DATE '2019-02-10'),\n"
operator|+
literal|" monthname(TIMESTAMP '2019-02-10 02:10:12'),\n"
operator|+
literal|" dayname(TIMESTAMP '1969-01-01 00:00:00'),\n"
operator|+
literal|" dayname(DATE '1969-01-01'),\n"
operator|+
...
begin_comment
comment|/** Tests metadata for the BigQuery lexical scheme. */
end_comment
...
name|query
argument_list|(
literal|"select if(1 = 1,1,2) as r"
argument_list|)
operator|.
name|returnsUnordered
argument_list|(
...
name|query
argument_list|(
literal|"select if(TRIM('a ') = 'a','a','b') as r"
argument_list|)
operator|.
name|returnsUnordered
argument_list|(
...
argument_list|)
decl_stmt|;
comment|// add implicit schema "/dummy/abc"
name|dummySubSchemaMap
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// add implicit table "/dummy/xyz"
name|dummyTableMap
operator|.
name|put
argument_list|(
...
argument_list|)
expr_stmt|;
comment|// add implicit table "/dummy/myType"
name|dummyTypeMap
operator|.
name|put
argument_list|(
...
name|query
argument_list|(
literal|"SELECT JSON_TYPE(v) AS c1\n"
operator|+
literal|",JSON_TYPE(JSON_VALUE(v, 'lax $.b' ERROR ON ERROR)) AS c2\n"
operator|+
literal|",JSON_TYPE(JSON_VALUE(v, 'strict $.a[0]' ERROR ON ERROR)) AS c3\n"
operator|+
literal|",JSON_TYPE(JSON_VALUE(v, 'strict $.a[1]' ERROR ON ERROR)) AS c4\n"
operator|+
...
name|returns
argument_list|(
literal|"C1=OBJECT; C2=ARRAY; C3=INTEGER; C4=BOOLEAN\n"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|query
argument_list|(
literal|"SELECT JSON_DEPTH(v) AS c1\n"
operator|+
literal|",JSON_DEPTH(JSON_VALUE(v, 'lax $.b' ERROR ON ERROR)) AS c2\n"
operator|+
literal|",JSON_DEPTH(JSON_VALUE(v, 'strict $.a[0]' ERROR ON ERROR)) AS c3\n"
operator|+
literal|",JSON_DEPTH(JSON_VALUE(v, 'strict $.a[1]' ERROR ON ERROR)) AS c4\n"
operator|+
literal|"FROM (VALUES ('{\"a\": [10, true],\"b\": \"[10, true]\"}')) AS t(v)\n"
operator|+
literal|"limit 10"
...
name|query
argument_list|(
literal|"SELECT JSON_KEYS(v) AS c1\n"
operator|+
literal|",JSON_KEYS(v, 'lax $.a') AS c2\n"
operator|+
literal|",JSON_KEYS(v, 'lax $.b') AS c3\n"
operator|+
literal|",JSON_KEYS(v, 'strict $.a[0]') AS c4\n"
operator|+
literal|",JSON_KEYS(v, 'strict $.a[1]') AS c5\n"
operator|+
literal|"FROM (VALUES ('{\"a\": [10, true],\"b\": {\"c\": 30}}')) AS t(v)\n"
operator|+
literal|"limit 10"
argument_list|)
operator|.
name|returns
argument_list|(
literal|"C1=[\"a\",\"b\"]; C2=null; C3=[\"c\"]; C4=null; C5=null\n"
argument_list|)
expr_stmt|;
block|}
end_function
...
name|query
argument_list|(
literal|"SELECT JSON_REMOVE(v, '$[1]') AS c1\n"
operator|+
literal|"FROM (VALUES ('[\"a\", [\"b\", \"c\"], \"d\"]')) AS t(v)\n"
operator|+
literal|"limit 10"
argument_list|)
operator|.
...
name|query
init|=
literal|"SELECT CAST(CAST(4200000000 AS BIGINT) AS ANY) FROM (VALUES(1))"
decl_stmt|;
name|assertThat
operator|.
name|query
...
begin_comment
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-5414">[CALCITE-5414]</a>    * Convert between standard Gregorian and proleptic Gregorian calendars for    * literal dates in local time zone. */
end_comment
...
name|Test
name|void
name|testLiteralDateToSqlTimestamp
parameter_list|()
block|{
name|CalciteAssert
operator|.
...
name|query
argument_list|(
literal|"select cast('1500-04-30' as date)"
argument_list|)
operator|.
name|returns
argument_list|(
...
begin_comment
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-5414">[CALCITE-5414]</a>    * Convert between standard Gregorian and proleptic Gregorian calendars for    * literal timestamps in local time zone. */
end_comment
...
name|Test
name|void
name|testLiteralTimestampToSqlTimestamp
parameter_list|()
block|{
name|CalciteAssert
operator|.
...
name|query
argument_list|(
literal|"select cast('1500-04-30 12:00:00' as timestamp)"
argument_list|)
operator|.
name|returns
argument_list|(
...
begin_comment
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-5414">[CALCITE-5414]</a>    * Convert between standard Gregorian and proleptic Gregorian calendars for    * dynamic dates in local time zone. */
end_comment
...
name|Test
name|void
name|testDynamicDateToSqlTimestamp
parameter_list|()
block|{
specifier|final
name|Date
...
begin_comment
unit|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-5414">[CALCITE-5414]</a>    * Convert between standard Gregorian and proleptic Gregorian calendars for    * dynamic timestamps in local time zone. */
end_comment
...
name|Test
name|void
name|testDynamicTimestampToSqlTimestamp
parameter_list|()
block|{
specifier|final
name|Timestamp
...
name|query
argument_list|(
literal|"select cast(? as timestamp)"
argument_list|)
operator|.
name|consumesPreparedStatement
argument_list|(
...
begin_comment
comment|/** Implementation of {@link CalcitePrepare} that counts how many DDL    * statements have been executed. */
end_comment
...
begin_comment
unit|}
comment|/** Dummy subclass of CalcitePrepareImpl. */
end_comment
...
begin_comment
comment|/** Locales for which to test DAYNAME and MONTHNAME functions,    * and expected results of those functions. */
end_comment
...
parameter_list|)
block|{
comment|// In root locale, for Java versions 9 and higher, day and month names
comment|// are shortened to 3 letters. This means root locale behaves differently
comment|// to English.
return|return
name|TestUtil
operator|.
