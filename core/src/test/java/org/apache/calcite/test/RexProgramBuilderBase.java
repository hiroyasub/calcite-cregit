...
name|falseLiteral
decl_stmt|;
comment|/**    * Nullable int literal.    * @deprecated since its name does not give a clue on type. Prefer {@code null_(tInt())}    */
annotation|@
name|Deprecated
specifier|protected
name|RexNode
name|nullLiteral
decl_stmt|;
comment|/**    * Nullable boolean literal.    * @deprecated prefer {@code null_(tBoolean())} or {@code nullBool}    */
annotation|@
name|Deprecated
specifier|protected
name|RexNode
