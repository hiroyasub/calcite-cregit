...
expr_stmt|;
block|}
comment|/**    * Checks that a SQL query gives a particular error, or succeeds if {@code    * expected} is null, with specified type coercion flag.    */
specifier|public
specifier|final
name|void
name|checkFails
...
expr_stmt|;
block|}
comment|/**    * Checks that a SQL expression gives a particular error,    * with specified type coercion flag.    */
specifier|public
specifier|final
name|void
name|checkExpFails
...
expr_stmt|;
block|}
comment|/**    * Checks that a SQL expression gives a particular error, and that the    * location of the error is the whole expression, with specified type coercion flag.    */
specifier|public
specifier|final
name|void
name|checkWholeExpFails
