...
block|}
block|}
comment|/**    * Tests correlated subquery with 2 identical params is being processed correctly.    */
annotation|@
name|Test
name|void
...
name|sql
init|=
literal|"select x, (select * from table (\"s\".\""
operator|+
name|callMethodName
operator|+
literal|"\"(x, x))) "
operator|+
literal|"from (values (2), (4)) as t (x)"
decl_stmt|;
name|ResultSet
name|resultSet
init|=
...
literal|"select *\n"
operator|+
literal|"from table(\"s\".\"GenerateStringsOfInputMapSize\"(Map[5,4,3,1])) as t(n, c)\n"
operator|+
literal|"where char_length(c)> 0"
decl_stmt|;
name|ResultSet
name|resultSet
init|=
...
block|}
block|}
comment|/** Test case for    *<a href="https://issues.apache.org/jira/browse/CALCITE-4448">[CALCITE-4448]    * Use TableMacro user-defined table functions with QueryableTable</a>. */
annotation|@
name|Test
name|void
name|testQueryableTableWithTableMacro
parameter_list|()
throws|throws
name|SQLException
block|{
...
name|sql
init|=
literal|"select * from table(\"s\".\"simple\"())"
decl_stmt|;
name|ResultSet
name|resultSet
init|=
