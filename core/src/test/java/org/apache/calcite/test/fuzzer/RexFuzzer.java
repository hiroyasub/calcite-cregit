...
block|}
block|}
comment|/** Generates a pair of values, the first being less than or equal to the    * second. */
specifier|static
parameter_list|<
name|T
extends|extends
...
block|}
block|}
comment|/** Generates an integer between -5 and 10 (inclusive). All values are equally    * likely. */
specifier|static
name|BigDecimal
name|fuzzInt
parameter_list|(
...
return|;
block|}
comment|/** Generates values of a particular type, given a random-number generator.    *    * @param<T> Value type */
interface|interface
name|Generator
parameter_list|<
name|T
