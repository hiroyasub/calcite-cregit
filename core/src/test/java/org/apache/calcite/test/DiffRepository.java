...
block|}
block|}
comment|/** Validates the root element. */
specifier|private
specifier|static
name|void
name|validate
...
throw|;
block|}
comment|// Make sure that there are no duplicate test cases.
specifier|final
name|Set
argument_list|<
name|String
...
return|;
block|}
comment|/**    * Finds the repository instance for a given class and inheriting from    * a given repository.    *    * @param clazz     Test case class    * @param baseRepository Base class of test class    * @return The diff repository shared between test cases in this class.    */
specifier|public
specifier|static
name|DiffRepository
name|lookup
