...
begin_comment
comment|/**  * Unit test for {@link net.hydromatic.optiq.ScannableTable}.  */
end_comment
...
expr_stmt|;
block|}
comment|/** A filter on a {@link net.hydromatic.optiq.ProjectableFilterableTable} with    * two columns. */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/** A filter on a {@link net.hydromatic.optiq.ProjectableFilterableTable} with    * two columns, and a project in the query. */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/** A filter and project on a    * {@link net.hydromatic.optiq.ProjectableFilterableTable}. The table    * refuses to execute the filter, so Calcite should add a pull up and    * transform the filter (projecting the column needed by the filter). */
annotation|@
name|Test
specifier|public
name|void
