...
operator|+
literal|"  LogicalProject(departmentNo=[$0])\n"
operator|+
...
operator|+
literal|"  LogicalProject(DEPTNO=[$0], d3=[$1])\n"
operator|+
literal|"    LogicalProject(DEPTNO=[$0], $f1=[+($0, 3)])\n"
operator|+
literal|"      LogicalProject(DEPTNO=[$7])\n"
operator|+
literal|"        LogicalTableScan(table=[[scott, EMP]])\n"
...
name|Ignore
argument_list|(
literal|"https://issues.apache.org/jira/browse/CALCITE-2441"
argument_list|)
annotation|@
name|Test
specifier|public
