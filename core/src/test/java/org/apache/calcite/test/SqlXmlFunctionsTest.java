...
name|XML
init|=
literal|"<document>string</document>"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|XSLT
init|=
literal|"<xsl:stylesheet xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\"></xsl:stylesheet>"
decl_stmt|;
specifier|private
specifier|static
specifier|final
...
name|xmlExternalEntity
operator|=
literal|"<!DOCTYPE document [<!ENTITY entity SYSTEM \""
operator|+
name|filePath
operator|+
literal|"\"> ]><document>&entity;</document>"
expr_stmt|;
name|xsltExternalEntity
operator|=
literal|"<!DOCTYPE document [<!ENTITY entity SYSTEM \""
...
name|filePath
operator|+
literal|"\"> ]><xsl:stylesheet xmlns:xsl=\"http://www.w3.org/1999/XSL/Transform\">&entity;</xsl:stylesheet>"
expr_stmt|;
block|}
annotation|@
name|Test
...
name|Test
name|void
name|testExtractValueExternalEntity
parameter_list|()
block|{
name|String
name|message
...
name|Test
name|void
name|testExistsNodeExternalEntity
parameter_list|()
block|{
name|String
name|message
...
name|Test
name|void
name|testXmlTransformExternalEntity
parameter_list|()
block|{
name|String
name|message
...
name|Test
name|void
name|testXmlTransformExternalEntityXslt
parameter_list|()
block|{
name|String
name|message
