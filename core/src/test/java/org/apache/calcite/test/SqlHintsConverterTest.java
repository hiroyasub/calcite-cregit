...
name|sql
init|=
literal|"select /*+ fast_snapshot(products_temporal) */ stream * from\n"
operator|+
literal|" orders join products_temporal for system_time as of timestamp '2022-08-11 15:00:00'\n"
operator|+
...
name|Test
name|void
name|testHintsPropagationInVolcanoPlannerRules2
parameter_list|()
block|{
specifier|final
name|String
name|sql
init|=
literal|"select /*+ no_hash_join */ ename, job\n"
operator|+
literal|"from emp where not exists (select 1 from dept where emp.deptno = dept.deptno)"
decl_stmt|;
specifier|final
name|RelHint
name|hint
...
name|Test
name|void
name|testHintsPropagationInVolcanoPlannerRules3
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select /*+ no_hash_join */ ename, job\n"
operator|+
literal|"from emp where not exists (select 1 from dept where emp.deptno = dept.deptno) order by ename"
decl_stmt|;
specifier|final
name|RelHint
name|hint
...
name|sql
init|=
literal|"select empno from (select * from "
operator|+
literal|"(select /*+ preserved_project */ empno, ename, deptno from emp)"
operator|+
