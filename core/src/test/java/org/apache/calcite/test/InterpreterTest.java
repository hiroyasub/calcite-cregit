...
expr_stmt|;
block|}
comment|/** Tests executing a plan on a {@link net.hydromatic.optiq.ScannableTable}    * using an interpreter. */
annotation|@
name|Test
specifier|public
name|void
...
expr_stmt|;
block|}
comment|/** Tests executing a plan on a single-column    * {@link net.hydromatic.optiq.ScannableTable} using an interpreter. */
annotation|@
name|Test
specifier|public
name|void
