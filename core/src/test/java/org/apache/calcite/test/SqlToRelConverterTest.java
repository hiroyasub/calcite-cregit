...
name|sql
init|=
literal|"select arg_min(ename, deptno)\n"
operator|+
literal|"from emp"
decl_stmt|;
name|sql
...
name|Test
name|void
name|testArgMinFunctionWithWinAgg
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select job,\n"
operator|+
literal|"  arg_min(ename, deptno) over (partition by job order by sal)\n"
operator|+
literal|"from emp"
decl_stmt|;
name|sql
...
name|sql
init|=
literal|"select arg_max(ename, deptno)\n"
operator|+
literal|"from emp"
decl_stmt|;
name|sql
...
name|Test
name|void
name|testArgMaxFunctionWithWinAgg
parameter_list|()
block|{
specifier|final
name|String
...
literal|"select job,\n"
operator|+
literal|"  arg_max(ename, deptno) over (partition by job order by sal)\n"
operator|+
literal|"from emp"
decl_stmt|;
name|sql
...
begin_comment
comment|/** Tests a reference to a measure column in an underlying table. The measure    * is treated as a black box: it is not expanded, just wrapped in a call to    * AGGREGATE. */
end_comment
...
name|sql
init|=
literal|"select deptno, aggregate(count_plus_100) as c\n"
operator|+
literal|"from empm\n"
operator|+
literal|"group by deptno"
