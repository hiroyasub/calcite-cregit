...
argument_list|)
expr_stmt|;
comment|// If i1 is null, "i0 and i1 is null" is not necessarily null
name|assertThat
argument_list|(
name|Strong
operator|.
...
argument_list|)
expr_stmt|;
comment|// If i0 and i1 are both null, "i0 and i1 is null" is null
name|assertThat
argument_list|(
name|Strong
operator|.
