...
parameter_list|)
function_decl|;
comment|/** Returns a tester that optionally expands sub-queries.      * If {@code expand} is false, the plan contains a      * {@link org.apache.calcite.rex.RexSubQuery} for each sub-query.      *      * @see Prepare#THREAD_EXPAND */
name|Tester
name|withExpand
parameter_list|(
name|boolean
...
parameter_list|)
function_decl|;
comment|/** Returns a tester that optionally uses a      * {@code SqlToRelConverter.Config}. */
name|Tester
name|withConfig
parameter_list|(
name|SqlToRelConverter
...
name|context
decl_stmt|;
comment|/**      * Creates a TesterImpl.      *      * @param diffRepos Diff repository      * @param enableDecorrelate Whether to decorrelate      * @param enableTrim Whether to trim unused fields      * @param enableExpand Whether to expand sub-queries      * @param catalogReaderFactory Function to create catalog reader, or null      * @param clusterFactory Called after a cluster has been created      */
specifier|protected
name|TesterImpl
parameter_list|(
name|DiffRepository
