...
name|RelDataTypeFactory
argument_list|>
name|DEFAULT_TYPE_FACTORY_SUPPLIER
init|=
name|Suppliers
operator|.
name|memoize
...
parameter_list|)
function_decl|;
comment|/**      * Converts an expression string to  {@link RexNode}.      *      * @param expr The expression      */
name|RexNode
...
parameter_list|)
function_decl|;
comment|/**      * Checks that a SQL statement converts to a given plan, optionally      * trimming columns that are not needed.      *      * @param sql  SQL query or expression      * @param plan Expected plan      * @param trim Whether to trim columns that are not needed      * @param query True if {@code sql} is a query, false if it is an expression      */
name|void
name|assertConvertsTo
parameter_list|(
name|String
...
parameter_list|)
function_decl|;
comment|/** Returns a tester that optionally decorrelates queries after planner      * rules have fired. */
name|Tester
...
parameter_list|)
function_decl|;
comment|/** Returns a tester that applies a transform to its      * {@code SqlToRelConverter.Config} before it uses it. */
name|Tester
name|withConfig
parameter_list|(
name|UnaryOperator
...
parameter_list|)
function_decl|;
comment|/** Returns a tester with a {@link SqlConformance}. */
name|Tester
...
parameter_list|()
function_decl|;
comment|/** Returns a tester that uses a given context. */
name|Tester
name|withContext
parameter_list|(
name|UnaryOperator
...
parameter_list|)
function_decl|;
comment|/** Returns a tester that uses a type factory. */
name|Tester
...
decl_stmt|;
comment|/** Creates a TesterImpl with default options. */
specifier|protected
name|TesterImpl
parameter_list|(
name|DiffRepository
...
expr_stmt|;
block|}
comment|/**      * Creates a TesterImpl.      *      * @param diffRepos Diff repository      * @param enableDecorrelate Whether to decorrelate      * @param enableTrim Whether to trim unused fields      * @param catalogReaderFactory Function to create catalog reader, or null      * @param clusterFactory Called after a cluster has been created      */
specifier|protected
name|TesterImpl
parameter_list|(
name|DiffRepository
...
return|;
block|}
comment|/**      * Creates a RelFieldTrimmer.      *      * @param relBuilder Builder      * @return Field trimmer      */
specifier|public
name|RelFieldTrimmer
name|createFieldTrimmer
parameter_list|(
...
block|}
block|}
comment|/**    * {@link RelOptTable.ViewExpander} implementation for testing usage.    */
specifier|private
specifier|static
class|class
name|MockViewExpander
