...
name|typeFactory
decl_stmt|;
comment|/**      * Creates a TesterImpl.      *      * @param diffRepos Diff repository      * @param enableDecorrelate Whether to decorrelate      * @param enableTrim Whether to trim unused fields      * @param enableExpand Whether to expand sub-queries      * @param catalogReaderFactory Function to create catalog reader, or null      */
specifier|protected
name|TesterImpl
parameter_list|(
name|DiffRepository
