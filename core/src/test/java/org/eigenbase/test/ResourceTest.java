...
name|equalTo
argument_list|(
literal|"resource 'shouldReturnExInst' has ExceptionClass, so return should be ExInst<class java.lang.IllegalArgumentException>"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
specifier|public
name|void
name|testValidateExceptionClassSpecified
parameter_list|()
block|{
try|try
block|{
...
name|equalTo
argument_list|(
literal|"resource 'exceptionClassNotSpecified' returns ExInst so must specify ExceptionClass"
argument_list|)
argument_list|)
expr_stmt|;
block|}
...
comment|//  one method
comment|/** Exception that cannot be thrown by {@link ExInst} because it does not have    * a (String, Throwable) constructor. */
specifier|public
specifier|static
class|class
name|MyException
...
name|BaseMessage
argument_list|(
literal|"has ExceptionClass so should return exinst"
argument_list|)
annotation|@
name|ExceptionClass
argument_list|(
...
name|BaseMessage
argument_list|(
literal|"exception class not specified"
argument_list|)
name|ExInst
argument_list|<
name|MyException
argument_list|>
name|exceptionClassNotSpecified
parameter_list|()
function_decl|;
annotation|@
name|BaseMessage
