...
name|typeFactory
decl_stmt|;
comment|/**      * Creates a TesterImpl.      *      * @param diffRepos Diff repository      * @param enableDecorrelate Whether to decorrelate      * @param catalogReaderFactory Function to create catalog reader, or null      */
specifier|protected
name|TesterImpl
parameter_list|(
name|DiffRepository
